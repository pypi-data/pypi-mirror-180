...
class Nds(WellsBaseModel):
    ...
    hole_start: Optional[Distance] = Field(
        None, alias="holeStart", description="Deprecated field, use `holeTop` instead."
    )
    hole_end: Optional[Distance] = Field(None, alias="holeEnd", description="Deprecated field, use `holeBase` instead.")
...
class NdsFilter(WellsBaseModel):
    ...
    hole_start: Optional[DistanceRange] = Field(
        None, alias="holeStart", description="Deprecated field, use `holeTop` instead."
    )
    hole_end: Optional[DistanceRange] = Field(
        None, alias="holeEnd", description="Deprecated field, use `holeBase` instead."
    )
