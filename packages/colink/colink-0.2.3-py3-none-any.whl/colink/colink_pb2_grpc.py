...
import colink.colink_pb2 as colink__pb2
...
class CoLinkServicer(object):
    ...
    def GenerateToken(self, request, context):
        """Given a valid JWT and a expiration timestamp, generates a new JWT with the expiration time set to the input timestamp.
        Requires user jwt.
