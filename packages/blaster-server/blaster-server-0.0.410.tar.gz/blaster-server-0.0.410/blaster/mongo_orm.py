...
MONGO_DEBUG_LEVEL =  int(environ.get("BLASTER_MONGO_ORM_DEBUG_LEVEL") or 1)
MONGO_RUNNING_IN_TEST_MODE = IS_DEV and int(environ.get("BLASTER_MONGO_RUNNING_IN_TEST_MODE") or 1)
