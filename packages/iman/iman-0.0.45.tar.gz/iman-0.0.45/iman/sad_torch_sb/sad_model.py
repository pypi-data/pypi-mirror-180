...
class SAD_INA_MODEL_21(nn.Module):
    def __init__(self):
...
class SAD_INA_MODEL(nn.Module):   #for 40 dim input
    def __init__(self):
        super(SAD_INA_MODEL, self).__init__()
        
        self.conv2d_12 = nn.Conv2d(1, 64, (7,5) )
        self.conv2d_13 = nn.Conv2d(64, 128, (3,3))
        self.conv2d_14 = nn.Conv2d(128, 128, (3,3))
        self.conv2d_15 = nn.Conv2d(128, 256, (3,3))
    ...
    def forward(self, x):
        ...
        out = (self.conv2d_12(out))
        # print( '21-->' + str (out.size()))
        out = self.batch_normalization_15(out)
        out = F.relu(out)
        out = F.max_pool2d(out, (4,4) , padding=(1,0))
