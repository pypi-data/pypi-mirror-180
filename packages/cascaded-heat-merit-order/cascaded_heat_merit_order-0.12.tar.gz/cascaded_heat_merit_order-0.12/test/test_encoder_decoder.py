...
class TestFactoryEncoderAndDecoder(unittest.TestCase):
    ...
    def test_encoder_decoder_with_chp_with_reference(self):
        ...
        reference = pd.read_csv("../../../iess_dhs/10_set/applications/Unit_Test_IESS_market/merit_order_factories/eta_cmo_factory_reference.csv", sep=";", index_col=0, parse_dates=True)
