...
class WebSocketIamAuthorizer(
    ...
    def bind(
        ...
        *,
        ...
        :stability: experimental
        '''
        _options = aws_cdk.aws_apigatewayv2_alpha.WebSocketRouteAuthorizerBindOptions(
            route=route, scope=scope
        )

        return typing.cast(aws_cdk.aws_apigatewayv2_alpha.WebSocketRouteAuthorizerConfig, jsii.invoke(self, "bind", [_options]))
