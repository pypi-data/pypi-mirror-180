...
def landing_to_bronze(
    ...
    if catalog_name != "hive_metastore":
        set_owner_to(spark, db_table, "data-production")
...
def bronze_to_silver(
    ...
    if catalog_name != "hive_metastore":
        set_owner_to(spark, output_db_table, "data-production")
...
def gold_to_diamond(
    ...
    """
    Perform the ingestion of data into the diamond_layer database
