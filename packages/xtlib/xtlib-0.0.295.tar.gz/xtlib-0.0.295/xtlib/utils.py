...
def send_email(config, to_list, cc_list, subject, body):
    '''
    Pro's:
    ...
    email_cs = config.get("external-services", "xtnotification", "connection-string")
    email_from = config.get("external-services", "xtnotification", "from")
    ...
    cc_addr_list = [EmailAddress(email=cc) for cc in cc_list]
