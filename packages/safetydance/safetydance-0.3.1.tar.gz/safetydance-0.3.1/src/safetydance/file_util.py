# -*- coding: utf-8 -*-
"""
Originally part of the astor library for Python AST manipulation.
...
Copyright (c) 2019-2022 David Charboneau

Functions that interact with the filesystem go here.

This was copied and modified in order to use exactly the code required and
to eliminate the dependency on the astor library.
