d ={"id":23,"mrd":45,"up":[{"id":45}],"mrd1":45,}
class DictManipulate:
    ...
    def findValue(self,d, search_pattern, prev_datapoint_path=''):
        output = []
        ...
        if type(current_datapoint) is dict:
            for dkey in current_datapoint:
                ...
                c = current_datapoint_path
                c+="['"+dkey+"']"
                for i in self.findValue(current_datapoint[dkey], search_pattern, c):
                    output.append(i)
            ...
            for i in range(0, len(current_datapoint)):
                ...
                c = current_datapoint_path
                c+="["+ str(i) +"]"
                for i in self.findValue(current_datapoint[i], search_pattern, c):
                    output.append(i)
...
res = DictManipulate().findkeys(d,"id")
print(list(res),"res")
res1 = DictManipulate().findValue(d,"23")
print(list(res1),"res1")
res2 = DictManipulate().flatten(d)
print(res2,"res2")
res3 = DictManipulate().splitDict(d,2)
print(res3,"res3")
