...
def apply_pose_asset_for_keymap():
    ''' Apply the given Pose Action to the rig :file: addons/pose_library/operators.py\:435 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$435> _
...
def convert_old_object_poselib():
    ''' Create a pose asset for each pose marker in this legacy pose library data-block :file: addons/pose_library/operators.py\:491 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$491> _
...
def convert_old_poselib():
    ''' Create a pose asset for each pose marker in the current action :file: addons/pose_library/operators.py\:457 <https://developer.blender.org/diffusion/BA/addons/pose_library/operators.py$457> _
