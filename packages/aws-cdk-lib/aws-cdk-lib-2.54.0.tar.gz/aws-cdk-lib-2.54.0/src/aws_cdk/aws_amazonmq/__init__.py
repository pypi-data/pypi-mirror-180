...
class CfnBroker(
    ...
    def __init__(
        ...
        *,
        ...
        users: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnBroker.UserProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]],
        authentication_strategy: typing.Optional[builtins.str] = None,
        configuration: typing.Optional[typing.Union[typing.Union["CfnBroker.ConfigurationIdProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        encryption_options: typing.Optional[typing.Union[typing.Union["CfnBroker.EncryptionOptionsProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        ldap_server_metadata: typing.Optional[typing.Union[typing.Union["CfnBroker.LdapServerMetadataProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        logs: typing.Optional[typing.Union[typing.Union["CfnBroker.LogListProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        maintenance_window_start_time: typing.Optional[typing.Union[typing.Union["CfnBroker.MaintenanceWindowProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
    ...
    class ConfigurationIdProperty:
        def __init__(self, *, id: builtins.str, revision: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                def stub(*, id: builtins.str, revision: jsii.Number) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
                check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class CfnConfigurationAssociation(
    ...
    def __init__(
        ...
        *,
        broker: builtins.str,
        configuration: typing.Union[typing.Union["CfnConfigurationAssociation.ConfigurationIdProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
    ) -> None:
