...
class CfnAccountAliasProps:
    def __init__(self, *, account_alias: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, account_alias: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class CfnSlackWorkspaceConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param team_id: ``AWS::SupportApp::SlackWorkspaceConfiguration.TeamId``.
        :param version_id: ``AWS::SupportApp::SlackWorkspaceConfiguration.VersionId``.
        '''
        if __debug__:
            def stub(
                scope: constructs.Construct,
