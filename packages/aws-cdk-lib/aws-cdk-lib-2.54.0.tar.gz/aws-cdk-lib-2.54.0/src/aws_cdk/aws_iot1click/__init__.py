...
class CfnProject(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        placement_template: typing.Union[typing.Union["CfnProject.PlacementTemplateProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
    ...
    class PlacementTemplateProperty:
        def __init__(
            ...
            *,
            ...
            device_templates: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Mapping[builtins.str, typing.Union[typing.Union["CfnProject.DeviceTemplateProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
        ) -> None:
