...
class Annotations(
    ...
    def from_stack(cls, stack: _Stack_2866e57f) -> "Annotations":
        ...
        '''
        if __debug__:
            def stub(stack: _Stack_2866e57f) -> None:
                ...
    ...
    def find_error(
        ...
        '''
        if __debug__:
            def stub(construct_path: builtins.str, message: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Match(metaclass=jsii.JSIIAbstractClass, jsii_type="aws-cdk-lib.assertions.Match"):
    ...
    def exact(cls, pattern: typing.Any) -> "Matcher":
        ...
        '''
        if __debug__:
            def stub(pattern: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument pattern", value=pattern, expected_type=type_hints["pattern"])
...
class MatchCapture:
    def __init__(self, *, capture: "Capture", value: typing.Any) -> None:
        ...
        '''
        if __debug__:
            def stub(*, capture: Capture, value: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class MatchResult(
    ...
    def __init__(self, target: typing.Any) -> None:
        ...
        '''
        if __debug__:
            def stub(target: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def compose(self, id: builtins.str, inner: "MatchResult") -> "MatchResult":
        ...
        '''
        if __debug__:
            def stub(id: builtins.str, inner: MatchResult) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class _MatcherProxy(Matcher):
    ...
    def test(self, actual: typing.Any) -> MatchResult:
        ...
        '''
        if __debug__:
            def stub(actual: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Template(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.assertions.Template"):
    ...
    def all_resources(self, type: builtins.str, props: typing.Any) -> None:
        ...
        '''
        if __debug__:
            def stub(type: builtins.str, props: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def find_conditions(
        ...
        '''
        if __debug__:
            def stub(logical_id: builtins.str, props: typing.Any = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def find_resources(
        ...
        '''
        if __debug__:
            def stub(type: builtins.str, props: typing.Any = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def has_condition(self, logical_id: builtins.str, props: typing.Any) -> None:
        ...
        '''
        if __debug__:
            def stub(logical_id: builtins.str, props: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument logical_id", value=logical_id, expected_type=type_hints["logical_id"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
    ...
    def resource_count_is(self, type: builtins.str, count: jsii.Number) -> None:
        ...
        '''
        if __debug__:
            def stub(type: builtins.str, count: jsii.Number) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
    ...
    def resource_properties_count_is(
        ...
        '''
        if __debug__:
            def stub(type: builtins.str, props: typing.Any, count: jsii.Number) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument type", value=type, expected_type=type_hints["type"])
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
...
class Capture(
    ...
    def __init__(self, pattern: typing.Any = None) -> None:
        ...
        '''
        if __debug__:
            def stub(pattern: typing.Any = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument pattern", value=pattern, expected_type=type_hints["pattern"])
