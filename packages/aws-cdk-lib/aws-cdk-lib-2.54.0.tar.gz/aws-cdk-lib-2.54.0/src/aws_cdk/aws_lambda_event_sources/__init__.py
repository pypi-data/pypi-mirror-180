...
class ApiEventSource(
    ...
    def __init__(
        ...
        *,
        ...
        method_responses: typing.Optional[typing.Sequence[typing.Union[_MethodResponse_2d9c5559, typing.Dict[str, typing.Any]]]] = None,
        ...
        request_validator_options: typing.Optional[typing.Union[_RequestValidatorOptions_a587c765, typing.Dict[str, typing.Any]]] = None,
    ) -> None:
        '''
        :param method: -
        :param path: -
    ...
    def bind(self, target: _IFunction_6adb0ab8) -> None:
        ...
        '''
        if __debug__:
            def stub(target: _IFunction_6adb0ab8) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class S3EventSource(
    ...
    def __init__(
        ...
        *,
        ...
        filters: typing.Optional[typing.Sequence[typing.Union[_NotificationKeyFilter_eba42084, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        '''
        :param bucket: -
...
class SnsDlq(
    ...
    def __init__(self, topic: _ITopic_9eca4852) -> None:
        ...
        '''
        if __debug__:
            def stub(topic: _ITopic_9eca4852) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument topic", value=topic, expected_type=type_hints["topic"])
...
class SqsDlq(
    ...
    def __init__(self, queue: _IQueue_7ed6f679) -> None:
        ...
        '''
        if __debug__:
            def stub(queue: _IQueue_7ed6f679) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class _StreamEventSourceProxy(StreamEventSource):
    ...
    def bind(self, _target: _IFunction_6adb0ab8) -> None:
        ...
        '''
        if __debug__:
            def stub(_target: _IFunction_6adb0ab8) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument _target", value=_target, expected_type=type_hints["_target"])
