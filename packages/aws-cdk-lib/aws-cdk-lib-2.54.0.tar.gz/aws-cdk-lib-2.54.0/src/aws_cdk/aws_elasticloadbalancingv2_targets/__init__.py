...
class AlbArnTarget(
    ...
    def attach_to_network_target_group(
        ...
        '''
        if __debug__:
            def stub(target_group: _INetworkTargetGroup_abca2df7) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class AlbTarget(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            def stub(alb: _ApplicationLoadBalancer_341e4ec1, port: jsii.Number) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class InstanceIdTarget(
    ...
    def attach_to_application_target_group(
        ...
        '''
        if __debug__:
            def stub(target_group: _IApplicationTargetGroup_57799827) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument target_group", value=target_group, expected_type=type_hints["target_group"])
...
class LambdaTarget(
    ...
    def __init__(self, fn: _IFunction_6adb0ab8) -> None:
        ...
        '''
        if __debug__:
            def stub(fn: _IFunction_6adb0ab8) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
