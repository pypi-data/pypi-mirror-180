...
class CfnLicense(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        consumption_configuration: typing.Union[typing.Union["CfnLicense.ConsumptionConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        entitlements: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnLicense.EntitlementProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]],
        home_region: builtins.str,
        issuer: typing.Union[typing.Union["CfnLicense.IssuerDataProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        license_name: builtins.str,
        product_name: builtins.str,
        validity: typing.Union[typing.Union["CfnLicense.ValidityDateFormatProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        beneficiary: typing.Optional[builtins.str] = None,
        license_metadata: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnLicense.MetadataProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]]] = None,
    ...
    class ConsumptionConfigurationProperty:
        def __init__(
            self,
            *,
            borrow_configuration: typing.Optional[typing.Union[typing.Union["CfnLicense.BorrowConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            provisional_configuration: typing.Optional[typing.Union[typing.Union["CfnLicense.ProvisionalConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
    ...
    class ProvisionalConfigurationProperty:
        def __init__(self, *, max_time_to_live_in_minutes: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                def stub(*, max_time_to_live_in_minutes: jsii.Number) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
                check_type(argname="argument max_time_to_live_in_minutes", value=max_time_to_live_in_minutes, expected_type=type_hints["max_time_to_live_in_minutes"])
            self._values: typing.Dict[str, typing.Any] = {
    ...
    class ValidityDateFormatProperty:
        def __init__(self, *, begin: builtins.str, end: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, begin: builtins.str, end: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
