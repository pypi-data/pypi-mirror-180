...
class CfnSkill(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        authentication_configuration: typing.Union[typing.Union["CfnSkill.AuthenticationConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        skill_package: typing.Union[typing.Union["CfnSkill.SkillPackageProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
    ...
    class OverridesProperty:
        def __init__(self, *, manifest: typing.Any = None) -> None:
            ...
            '''
            if __debug__:
                def stub(*, manifest: typing.Any = None) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class SkillPackageProperty:
        def __init__(
            ...
            *,
            ...
            s3_key: builtins.str,
            overrides: typing.Optional[typing.Union[typing.Union["CfnSkill.OverridesProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
