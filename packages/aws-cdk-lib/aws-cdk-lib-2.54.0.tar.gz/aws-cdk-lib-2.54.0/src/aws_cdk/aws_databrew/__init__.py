...
class CfnDataset(
    ...
    class FilterValueProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                def stub(*, value: builtins.str, value_reference: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class MetadataProperty:
        def __init__(self, *, source_arn: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                def stub(*, source_arn: typing.Optional[builtins.str] = None) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
...
class CfnJob(
    ...
    class AllowedStatisticsProperty:
        def __init__(self, *, statistics: typing.Sequence[builtins.str]) -> None:
            ...
            '''
            if __debug__:
                def stub(*, statistics: typing.Sequence[builtins.str]) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class CsvOutputOptionsProperty:
        def __init__(self, *, delimiter: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                def stub(*, delimiter: typing.Optional[builtins.str] = None) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
                check_type(argname="argument delimiter", value=delimiter, expected_type=type_hints["delimiter"])
            self._values: typing.Dict[str, typing.Any] = {}
    ...
    class StatisticOverrideProperty:
        def __init__(self, *, parameters: typing.Any, statistic: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, parameters: typing.Any, statistic: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
                check_type(argname="argument parameters", value=parameters, expected_type=type_hints["parameters"])
