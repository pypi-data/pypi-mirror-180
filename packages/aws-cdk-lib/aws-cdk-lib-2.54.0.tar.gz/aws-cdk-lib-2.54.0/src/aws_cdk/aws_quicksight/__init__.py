...
class CfnDataSet(
    ...
    class ColumnDescriptionProperty:
        def __init__(self, *, text: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                def stub(*, text: typing.Optional[builtins.str] = None) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class FilterOperationProperty:
        def __init__(self, *, condition_expression: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, condition_expression: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class ProjectOperationProperty:
        def __init__(self, *, projected_columns: typing.Sequence[builtins.str]) -> None:
            ...
            '''
            if __debug__:
                def stub(*, projected_columns: typing.Sequence[builtins.str]) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class FontProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                def stub(*, font_family: typing.Optional[builtins.str] = None) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
