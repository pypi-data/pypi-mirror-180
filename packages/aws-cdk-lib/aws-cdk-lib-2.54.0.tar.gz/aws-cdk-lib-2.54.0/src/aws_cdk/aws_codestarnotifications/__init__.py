...
class CfnNotificationRule(
    ...
    def __init__(
        ...
        *,
        ...
        targets: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[typing.Union["CfnNotificationRule.TargetProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]]],
...
class _INotificationRuleProxy(
    ...
    def add_target(self, target: "INotificationRuleTarget") -> builtins.bool:
        ...
        '''
        if __debug__:
            def stub(target: INotificationRuleTarget) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class NotificationRuleSourceConfig:
    def __init__(self, *, source_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, source_arn: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
