...
class CfnNotificationChannel(
    ...
    class NotificationChannelConfigProperty:
        def __init__(
            self,
            *,
            filters: typing.Optional[typing.Union[typing.Union["CfnNotificationChannel.NotificationFilterConfigProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            ...
            :param filters: ``CfnNotificationChannel.NotificationChannelConfigProperty.Filters``.
    ...
    class NotificationFilterConfigProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param message_types: ``CfnNotificationChannel.NotificationFilterConfigProperty.MessageTypes``.
            :param severities: ``CfnNotificationChannel.NotificationFilterConfigProperty.Severities``.
    ...
    class SnsChannelConfigProperty:
        def __init__(self, *, topic_arn: typing.Optional[builtins.str] = None) -> None:
            ...
            '''
            if __debug__:
                def stub(*, topic_arn: typing.Optional[builtins.str] = None) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
