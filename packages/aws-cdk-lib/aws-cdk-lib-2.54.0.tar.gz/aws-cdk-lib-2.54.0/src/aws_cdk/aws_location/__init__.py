...
class CfnMap(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        configuration: typing.Union[typing.Union["CfnMap.MapConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
    ...
    class MapConfigurationProperty:
        def __init__(self, *, style: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, style: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
...
class CfnPlaceIndex(
    ...
    def __init__(
        ...
        *,
        ...
        data_source_configuration: typing.Optional[typing.Union[typing.Union["CfnPlaceIndex.DataSourceConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        description: typing.Optional[builtins.str] = None,
        pricing_plan: typing.Optional[builtins.str] = None,
    ) -> None:
    ...
    class DataSourceConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                def stub(*, intended_use: typing.Optional[builtins.str] = None) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
...
class CfnTrackerConsumerProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            def stub(*, consumer_arn: builtins.str, tracker_name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
