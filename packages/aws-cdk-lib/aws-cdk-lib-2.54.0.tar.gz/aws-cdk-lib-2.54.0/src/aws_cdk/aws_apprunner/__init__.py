...
class CfnObservabilityConfiguration(
    ...
    class TraceConfigurationProperty:
        def __init__(self, *, vendor: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, vendor: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
...
class CfnService(
    ...
    class IngressConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param is_publicly_accessible: ``CfnService.IngressConfigurationProperty.IsPubliclyAccessible``.
    ...
    class NetworkConfigurationProperty:
        def __init__(
            self,
            *,
            egress_configuration: typing.Optional[typing.Union[typing.Union["CfnService.EgressConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            ingress_configuration: typing.Optional[typing.Union[typing.Union["CfnService.IngressConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        ) -> None:
            ...
            :param ingress_configuration: ``CfnService.NetworkConfigurationProperty.IngressConfiguration``.
        ...
        def egress_configuration(
            self,
        ) -> typing.Optional[typing.Union["CfnService.EgressConfigurationProperty", _IResolvable_da3f097b]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnService.EgressConfigurationProperty", _IResolvable_da3f097b]], result)

        @builtins.property
        def ingress_configuration(
            self,
        ) -> typing.Optional[typing.Union["CfnService.IngressConfigurationProperty", _IResolvable_da3f097b]]:
            ...
            return typing.cast(typing.Optional[typing.Union["CfnService.IngressConfigurationProperty", _IResolvable_da3f097b]], result)
...
class CfnVpcIngressConnection(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        ingress_vpc_configuration: typing.Union[typing.Union["CfnVpcIngressConnection.IngressVpcConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param ingress_vpc_configuration: ``AWS::AppRunner::VpcIngressConnection.IngressVpcConfiguration``.
        :param service_arn: ``AWS::AppRunner::VpcIngressConnection.ServiceArn``.
        :param tags: ``AWS::AppRunner::VpcIngressConnection.Tags``.
        :param vpc_ingress_connection_name: ``AWS::AppRunner::VpcIngressConnection.VpcIngressConnectionName``.
        '''
        if __debug__:
            def stub(
                scope: constructs.Construct,
    ...
    def ingress_vpc_configuration(
        self,
    ) -> typing.Union["CfnVpcIngressConnection.IngressVpcConfigurationProperty", _IResolvable_da3f097b]:
        ...
        '''
        return typing.cast(typing.Union["CfnVpcIngressConnection.IngressVpcConfigurationProperty", _IResolvable_da3f097b], jsii.get(self, "ingressVpcConfiguration"))

    @ingress_vpc_configuration.setter
    def ingress_vpc_configuration(
        self,
        value: typing.Union["CfnVpcIngressConnection.IngressVpcConfigurationProperty", _IResolvable_da3f097b],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Union[CfnVpcIngressConnection.IngressVpcConfigurationProperty, _IResolvable_da3f097b],
    ...
    class IngressVpcConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param vpc_endpoint_id: ``CfnVpcIngressConnection.IngressVpcConfigurationProperty.VpcEndpointId``.
            :param vpc_id: ``CfnVpcIngressConnection.IngressVpcConfigurationProperty.VpcId``.
...
class CfnVpcIngressConnectionProps:
    ...
    def ingress_vpc_configuration(
        ...
        return typing.cast(typing.Union[CfnVpcIngressConnection.IngressVpcConfigurationProperty, _IResolvable_da3f097b], result)
