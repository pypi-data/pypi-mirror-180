...
class CloudArtifact(
    ...
    def __init__(
        ...
        *,
        ...
        metadata: typing.Optional[typing.Mapping[builtins.str, typing.Sequence[typing.Union[_MetadataEntry_13e1bf79, typing.Dict[str, typing.Any]]]]] = None,
        properties: typing.Optional[typing.Union[typing.Union[_AwsCloudFormationStackProperties_50fb16af, typing.Dict[str, typing.Any]], typing.Union[_AssetManifestProperties_9084879a, typing.Dict[str, typing.Any]], typing.Union[_TreeArtifactProperties_4092757e, typing.Dict[str, typing.Any]], typing.Union[_NestedCloudAssemblyProperties_c2fa342d, typing.Dict[str, typing.Any]]]] = None,
    ) -> None:
        '''
        :param assembly: -
        :param id: -
...
class CloudAssemblyBuilder(
    ...
    def add_missing(
        ...
        *,
        key: builtins.str,
        props: typing.Union[typing.Union[_AmiContextQuery_74bf4b1b, typing.Dict[str, typing.Any]], typing.Union[_AvailabilityZonesContextQuery_715a9fea, typing.Dict[str, typing.Any]], typing.Union[_HostedZoneContextQuery_8e6ca28f, typing.Dict[str, typing.Any]], typing.Union[_SSMParameterContextQuery_675de122, typing.Dict[str, typing.Any]], typing.Union[_VpcContextQuery_a193c650, typing.Dict[str, typing.Any]], typing.Union[_EndpointServiceAvailabilityZonesContextQuery_ea3ca0d1, typing.Dict[str, typing.Any]], typing.Union[_LoadBalancerContextQuery_cb08d67c, typing.Dict[str, typing.Any]], typing.Union[_LoadBalancerListenerContextQuery_0eaf3c16, typing.Dict[str, typing.Any]], typing.Union[_SecurityGroupContextQuery_e772f3e6, typing.Dict[str, typing.Any]], typing.Union[_KeyContextQuery_3ac6128d, typing.Dict[str, typing.Any]], typing.Union[_PluginContextQuery_31a9d073, typing.Dict[str, typing.Any]]],
...
class EnvironmentUtils(
    ...
    def format(cls, account: builtins.str, region: builtins.str) -> builtins.str:
        ...
        '''
        if __debug__:
            def stub(account: builtins.str, region: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument account", value=account, expected_type=type_hints["account"])
            check_type(argname="argument region", value=region, expected_type=type_hints["region"])
    ...
    def parse(cls, environment: builtins.str) -> Environment:
        ...
        '''
        if __debug__:
            def stub(environment: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class MetadataEntryResult(_MetadataEntry_13e1bf79):
    def __init__(
        ...
        *,
        type: builtins.str,
        data: typing.Optional[typing.Union[builtins.str, typing.Union[_FileAssetMetadataEntry_50173f8f, typing.Dict[str, typing.Any]], typing.Union[_ContainerImageAssetMetadataEntry_0a212d1d, typing.Dict[str, typing.Any]], typing.Sequence[typing.Union[_Tag_554dd7f9, typing.Dict[str, typing.Any]]]]] = None,
...
class SynthesisMessage:
    def __init__(
        self,
        *,
        entry: typing.Union[_MetadataEntry_13e1bf79, typing.Dict[str, typing.Any]],
        id: builtins.str,
