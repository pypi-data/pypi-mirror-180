...
class CfnAssessmentTemplate(
    ...
    def __init__(
        ...
        *,
        ...
        user_attributes_for_findings: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[_IResolvable_da3f097b, typing.Union[_CfnTag_f6864754, typing.Dict[str, typing.Any]]]]]] = None,
    ) -> None:
...
class CfnResourceGroup(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        resource_group_tags: typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[_IResolvable_da3f097b, typing.Union[_CfnTag_f6864754, typing.Dict[str, typing.Any]]]]],
    ) -> None:
