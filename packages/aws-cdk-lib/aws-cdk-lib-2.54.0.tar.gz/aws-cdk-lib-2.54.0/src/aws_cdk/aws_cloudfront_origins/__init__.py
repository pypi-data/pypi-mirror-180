...
from ..aws_cloudfront import (
    ...
    OriginOptions as _OriginOptions_86a1a89d,
...
class OriginGroup(
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            def stub(scope: constructs.Construct, *, origin_id: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[_OriginOptions_86a1a89d],
    name_mapping={
        "connection_attempts": "connectionAttempts",
        "connection_timeout": "connectionTimeout",
        "custom_headers": "customHeaders",
...
class RestApiOriginProps(_OriginOptions_86a1a89d):
    def __init__(
        self,
        *,
        connection_attempts: typing.Optional[jsii.Number] = None,
