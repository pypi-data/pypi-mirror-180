...
class _IDomainProxy(
    ...
    def grant_index_read(
        ...
        '''
        if __debug__:
            def stub(index: builtins.str, identity: _IGrantable_71c4f5de) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def grant_path_read(
        ...
        '''
        if __debug__:
            def stub(path: builtins.str, identity: _IGrantable_71c4f5de) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Domain(
    ...
    def add_access_policies(
        ...
        *access_policy_statements: _PolicyStatement_0fe33853,
        ...
        '''
        if __debug__:
            def stub(*access_policy_statements: _PolicyStatement_0fe33853) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
