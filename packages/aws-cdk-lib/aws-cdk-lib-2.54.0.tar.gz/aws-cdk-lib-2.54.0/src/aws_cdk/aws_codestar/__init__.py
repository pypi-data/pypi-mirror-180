...
class CfnGitHubRepository(
    ...
    def __init__(
        ...
        *,
        ...
        code: typing.Optional[typing.Union[typing.Union["CfnGitHubRepository.CodeProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
    ...
    class CodeProperty:
        def __init__(
            self,
            *,
            s3: typing.Union[typing.Union["CfnGitHubRepository.S3Property", typing.Dict[str, typing.Any]], _IResolvable_da3f097b],
        ) -> None:
