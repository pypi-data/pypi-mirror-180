...
class CfnEnvironment(
    ...
    def __init__(
        ...
        *,
        ...
        federation_parameters: typing.Optional[typing.Union[typing.Union["CfnEnvironment.FederationParametersProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
        kms_key_id: typing.Optional[builtins.str] = None,
        superuser_parameters: typing.Optional[typing.Union[typing.Union["CfnEnvironment.SuperuserParametersProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
    ) -> None:
