...
class BackupPlanRule(
    ...
    def daily(
        ...
        '''
        if __debug__:
            def stub(backup_vault: typing.Optional[IBackupVault] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument backup_vault", value=backup_vault, expected_type=type_hints["backup_vault"])
...
class BackupResource(
    ...
    def from_dynamo_db_table(cls, table: _ITable_504fd401) -> "BackupResource":
        ...
        '''
        if __debug__:
            def stub(table: _ITable_504fd401) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_ec2_instance(cls, instance: _IInstance_ab239e7c) -> "BackupResource":
        ...
        '''
        if __debug__:
            def stub(instance: _IInstance_ab239e7c) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_efs_file_system(
        ...
        '''
        if __debug__:
            def stub(file_system: _IFileSystem_b2d3a7cb) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_rds_database_cluster(
        ...
        '''
        if __debug__:
            def stub(cluster: _IDatabaseCluster_6554c32b) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_rds_database_instance(
        ...
        '''
        if __debug__:
            def stub(instance: _IDatabaseInstance_e4cb03a8) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument instance", value=instance, expected_type=type_hints["instance"])
    ...
    def from_rds_serverless_cluster(
        ...
        '''
        if __debug__:
            def stub(cluster: _IServerlessCluster_adbbb720) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument cluster", value=cluster, expected_type=type_hints["cluster"])
...
class BackupPlan(
    ...
    def add_rule(self, rule: BackupPlanRule) -> None:
        ...
        '''
        if __debug__:
            def stub(rule: BackupPlanRule) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
