...
class Authorization(
    ...
    def basic(
        ...
        '''
        if __debug__:
            def stub(username: builtins.str, password: _SecretValue_3dd0ddae) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    class EcsParametersProperty:
        def __init__(
            ...
            *,
            ...
            tag_list: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[_IResolvable_da3f097b, typing.Union[_CfnTag_f6864754, typing.Dict[str, typing.Any]]]]]] = None,
...
class EventField(
    ...
    def resolve(self, _ctx: _IResolveContext_b2df1921) -> typing.Any:
        ...
        '''
        if __debug__:
            def stub(_ctx: _IResolveContext_b2df1921) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class HttpParameter(
    ...
    def from_secret(cls, value: _SecretValue_3dd0ddae) -> "HttpParameter":
        ...
        '''
        if __debug__:
            def stub(value: _SecretValue_3dd0ddae) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class Match(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.aws_events.Match"):
    ...
    def all_of(cls, *matchers: typing.Any) -> typing.List[builtins.str]:
        ...
        '''
        if __debug__:
            def stub(*matchers: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def cidr(cls, range: builtins.str) -> typing.List[builtins.str]:
        ...
        '''
        if __debug__:
            def stub(range: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def interval(
        ...
        '''
        if __debug__:
            def stub(lower: jsii.Number, upper: jsii.Number) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
