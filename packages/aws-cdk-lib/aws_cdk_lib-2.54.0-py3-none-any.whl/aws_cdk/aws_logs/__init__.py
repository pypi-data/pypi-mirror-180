...
class CfnLogGroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: - scope in which this resource is defined.
        :param id: - scoped id of the resource.
        :param data_protection_policy: ``AWS::Logs::LogGroup.DataProtectionPolicy``.
...
class FilterPattern(
    ...
    def all(cls, *patterns: "JsonPattern") -> "JsonPattern":
        ...
        '''
        if __debug__:
            def stub(*patterns: JsonPattern) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def all_terms(cls, *terms: builtins.str) -> "IFilterPattern":
        ...
        '''
        if __debug__:
            def stub(*terms: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def any_term_group(
        ...
        *term_groups: typing.List[builtins.str],
        ...
        '''
        if __debug__:
            def stub(*term_groups: typing.List[builtins.str]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def boolean_value(
        ...
        '''
        if __debug__:
            def stub(json_field: builtins.str, value: builtins.bool) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def literal(cls, log_pattern_string: builtins.str) -> "IFilterPattern":
        ...
        '''
        if __debug__:
            def stub(log_pattern_string: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def space_delimited(cls, *columns: builtins.str) -> "SpaceDelimitedTextPattern":
        ...
        '''
        if __debug__:
            def stub(*columns: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class _ILogSubscriptionDestinationProxy:
    ...
    def bind(
        ...
        '''
        if __debug__:
            def stub(scope: constructs.Construct, source_log_group: ILogGroup) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class JsonPattern(
    ...
    def __init__(self, json_pattern_string: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(json_pattern_string: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class SpaceDelimitedTextPattern(
    ...
    def construct(
        ...
        '''
        if __debug__:
            def stub(columns: typing.Sequence[builtins.str]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument columns", value=columns, expected_type=type_hints["columns"])
...
class StreamOptions:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            def stub(*, log_stream_name: typing.Optional[builtins.str] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument log_stream_name", value=log_stream_name, expected_type=type_hints["log_stream_name"])
        self._values: typing.Dict[str, typing.Any] = {}
