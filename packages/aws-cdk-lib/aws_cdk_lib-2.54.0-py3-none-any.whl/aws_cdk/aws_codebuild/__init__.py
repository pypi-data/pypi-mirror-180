...
class ArtifactsProps:
    def __init__(self, *, identifier: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            def stub(*, identifier: typing.Optional[builtins.str] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class BindToCodePipelineOptions:
    def __init__(self, *, artifact_bucket: _IBucket_42e086fd) -> None:
        ...
        '''
        if __debug__:
            def stub(*, artifact_bucket: _IBucket_42e086fd) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class BuildEnvironmentCertificate:
    def __init__(self, *, bucket: _IBucket_42e086fd, object_key: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, bucket: _IBucket_42e086fd, object_key: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Cache(
    ...
    def local(cls, *modes: "LocalCacheMode") -> "Cache":
        ...
        '''
        if __debug__:
            def stub(*modes: LocalCacheMode) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class FilterGroup(
    ...
    def in_event_of(cls, *actions: EventAction) -> "FilterGroup":
        ...
        '''
        if __debug__:
            def stub(*actions: EventAction) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def and_base_branch_is(self, branch_name: builtins.str) -> "FilterGroup":
        ...
        '''
        if __debug__:
            def stub(branch_name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def and_commit_message_is(self, commit_message: builtins.str) -> "FilterGroup":
        ...
        '''
        if __debug__:
            def stub(commit_message: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def and_tag_is(self, tag_name: builtins.str) -> "FilterGroup":
        ...
        '''
        if __debug__:
            def stub(tag_name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class GitHubEnterpriseSourceCredentialsProps:
    def __init__(self, *, access_token: _SecretValue_3dd0ddae) -> None:
        ...
        '''
        if __debug__:
            def stub(*, access_token: _SecretValue_3dd0ddae) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class _IArtifactsProxy:
    ...
    def bind(self, scope: constructs.Construct, project: "IProject") -> ArtifactsConfig:
        ...
        '''
        if __debug__:
            def stub(scope: constructs.Construct, project: IProject) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class _IBuildImageProxy:
    ...
    def run_script_buildspec(self, entrypoint: builtins.str) -> BuildSpec:
        ...
        '''
        if __debug__:
            def stub(entrypoint: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class _IProjectProxy(
    ...
    def add_to_role_policy(self, policy_statement: _PolicyStatement_0fe33853) -> None:
        ...
        '''
        if __debug__:
            def stub(policy_statement: _PolicyStatement_0fe33853) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class LinuxBuildImage(
    ...
    def from_asset(
        ...
        *,
        ...
        invalidation: typing.Optional[typing.Union[_DockerImageAssetInvalidationOptions_4deb8d45, typing.Dict[str, typing.Any]]] = None,
...
class Project(
    ...
    def add_file_system_location(
        ...
        '''
        if __debug__:
            def stub(file_system_location: IFileSystemLocation) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def add_secondary_artifact(self, secondary_artifact: IArtifacts) -> None:
        ...
        '''
        if __debug__:
            def stub(secondary_artifact: IArtifacts) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def add_secondary_source(self, secondary_source: ISource) -> None:
        ...
        '''
        if __debug__:
            def stub(secondary_source: ISource) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Source(
    ...
    def bind(self, _scope: constructs.Construct, _project: IProject) -> "SourceConfig":
        ...
        '''
        if __debug__:
            def stub(_scope: constructs.Construct, _project: IProject) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
...
class WindowsBuildImage(
    ...
    def from_asset(
        ...
        scope: constructs.Construct,
        id: builtins.str,
        props: typing.Union[_DockerImageAssetProps_6897287d, typing.Dict[str, typing.Any]],
