...
class SlackChannelConfiguration(
    ...
    def __init__(
        ...
        *,
        ...
        log_retention_retry_options: typing.Optional[typing.Union[_LogRetentionRetryOptions_62d80a14, typing.Dict[str, typing.Any]]] = None,
    ...
    def add_notification_topic(self, notification_topic: _ITopic_9eca4852) -> None:
        ...
        '''
        if __debug__:
            def stub(notification_topic: _ITopic_9eca4852) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
