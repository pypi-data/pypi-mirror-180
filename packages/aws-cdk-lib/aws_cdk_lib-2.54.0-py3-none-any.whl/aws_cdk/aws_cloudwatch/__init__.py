...
class AlarmActionConfig:
    def __init__(self, *, alarm_action_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, alarm_action_arn: builtins.str) -> None:
                ...
...
class AlarmRule(
    ...
    def all_of(cls, *operands: "IAlarmRule") -> "IAlarmRule":
        ...
        '''
        if __debug__:
            def stub(*operands: IAlarmRule) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_alarm(cls, alarm: "IAlarm", alarm_state: "AlarmState") -> "IAlarmRule":
        ...
        '''
        if __debug__:
            def stub(alarm: IAlarm, alarm_state: AlarmState) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_string(cls, alarm_rule: builtins.str) -> "IAlarmRule":
        ...
        '''
        if __debug__:
            def stub(alarm_rule: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def not_(cls, operand: "IAlarmRule") -> "IAlarmRule":
        ...
        '''
        if __debug__:
            def stub(operand: IAlarmRule) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class CfnInsightRule(
    ...
    def __init__(
        ...
        *,
        ...
        tags: typing.Optional[typing.Union[_IResolvable_da3f097b, typing.Sequence[typing.Union[_IResolvable_da3f097b, typing.Union[_CfnTag_f6864754, typing.Dict[str, typing.Any]]]]]] = None,
    ) -> None:
...
class _IAlarmActionProxy:
    ...
    def bind(self, scope: constructs.Construct, alarm: "IAlarm") -> AlarmActionConfig:
        ...
        '''
        if __debug__:
            def stub(scope: constructs.Construct, alarm: IAlarm) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument alarm", value=alarm, expected_type=type_hints["alarm"])
...
class Spacer(metaclass=jsii.JSIIMeta, jsii_type="aws-cdk-lib.aws_cloudwatch.Spacer"):
    ...
    def position(self, _x: jsii.Number, _y: jsii.Number) -> None:
        ...
        '''
        if __debug__:
            def stub(_x: jsii.Number, _y: jsii.Number) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Stats(
    ...
    def p(cls, percentile: jsii.Number) -> builtins.str:
        ...
        '''
        if __debug__:
            def stub(percentile: jsii.Number) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def percentile_rank(
        ...
        '''
        if __debug__:
            def stub(v1: jsii.Number, v2: typing.Optional[jsii.Number] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def tc(
        ...
        '''
        if __debug__:
            def stub(p1: jsii.Number, p2: typing.Optional[jsii.Number] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class ConcreteWidget(
    ...
    def __init__(self, width: jsii.Number, height: jsii.Number) -> None:
        ...
        '''
        if __debug__:
            def stub(width: jsii.Number, height: jsii.Number) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument width", value=width, expected_type=type_hints["width"])
            check_type(argname="argument height", value=height, expected_type=type_hints["height"])
...
class GaugeWidget(
    ...
    def __init__(
        self,
        *,
        annotations: typing.Optional[typing.Sequence[typing.Union[HorizontalAnnotation, typing.Dict[str, typing.Any]]]] = None,
        left_y_axis: typing.Optional[typing.Union[YAxisProps, typing.Dict[str, typing.Any]]] = None,
...
class AlarmBase(
    ...
    def add_alarm_action(self, *actions: IAlarmAction) -> None:
        ...
        '''
        if __debug__:
            def stub(*actions: IAlarmAction) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
