...
class CfnCacheCluster(
    ...
    def __init__(
        ...
        *,
        ...
        :param ip_discovery: ``AWS::ElastiCache::CacheCluster.IpDiscovery``.
        :param log_delivery_configurations: Specifies the destination, format and type of the logs.
        :param network_type: ``AWS::ElastiCache::CacheCluster.NetworkType``.
    ...
    class CloudWatchLogsDestinationDetailsProperty:
        def __init__(self, *, log_group: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, log_group: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class KinesisFirehoseDestinationDetailsProperty:
        def __init__(self, *, delivery_stream: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, delivery_stream: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
...
class CfnReplicationGroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param ip_discovery: ``AWS::ElastiCache::ReplicationGroup.IpDiscovery``.
        ...
        :param network_type: ``AWS::ElastiCache::ReplicationGroup.NetworkType``.
...
class CfnUser(
    ...
    def __init__(
        ...
        *,
        ...
        :param authentication_mode: ``AWS::ElastiCache::User.AuthenticationMode``.
