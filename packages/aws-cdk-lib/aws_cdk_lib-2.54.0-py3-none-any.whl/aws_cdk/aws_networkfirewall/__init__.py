...
class CfnFirewallPolicy(
    ...
    class StatefulRuleGroupOverrideProperty:
        def __init__(self, *, action: typing.Optional[builtins.str] = None) -> None:
            '''
            :param action: ``CfnFirewallPolicy.StatefulRuleGroupOverrideProperty.Action``.
    ...
    class StatefulRuleGroupReferenceProperty:
        def __init__(
            ...
            *,
            ...
            override: typing.Optional[typing.Union[typing.Union["CfnFirewallPolicy.StatefulRuleGroupOverrideProperty", typing.Dict[str, typing.Any]], _IResolvable_da3f097b]] = None,
            priority: typing.Optional[jsii.Number] = None,
        ) -> None:
            '''Identifier for a single stateful rule group, used in a firewall policy to refer to a rule group.

            :param resource_arn: The Amazon Resource Name (ARN) of the stateful rule group.
            :param override: ``CfnFirewallPolicy.StatefulRuleGroupReferenceProperty.Override``.
