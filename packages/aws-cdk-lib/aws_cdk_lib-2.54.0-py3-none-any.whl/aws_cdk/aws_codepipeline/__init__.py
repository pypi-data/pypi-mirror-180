...
class ActionBindOptions:
    def __init__(self, *, bucket: _IBucket_42e086fd, role: _IRole_235f5d8e) -> None:
        ...
        '''
        if __debug__:
            def stub(*, bucket: _IBucket_42e086fd, role: _IRole_235f5d8e) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class ActionConfig:
    def __init__(self, *, configuration: typing.Any = None) -> None:
        ...
        '''
        if __debug__:
            def stub(*, configuration: typing.Any = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Artifact(
    ...
    def __init__(self, artifact_name: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            def stub(artifact_name: typing.Optional[builtins.str] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def get_param(
        ...
        '''
        if __debug__:
            def stub(json_file: builtins.str, key_name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class ArtifactPath(
    ...
    def __init__(self, artifact: Artifact, file_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(artifact: Artifact, file_name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def artifact_path(
        ...
        '''
        if __debug__:
            def stub(artifact_name: builtins.str, file_name: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument artifact_name", value=artifact_name, expected_type=type_hints["artifact_name"])
            check_type(argname="argument file_name", value=file_name, expected_type=type_hints["file_name"])
...
class CfnPipeline(
    ...
    class StageTransitionProperty:
        def __init__(self, *, reason: builtins.str, stage_name: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, reason: builtins.str, stage_name: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
