...
['datagen',
 'datagen.api',
 'datagen.api.assets',
 'datagen.api.assets.accessories',
 'datagen.api.assets.environment',
 'datagen.api.assets.human',
 'datagen.api.catalog',
...
package_data = \
{'': ['*'],
 'datagen.api.assets': ['explanations/*'],
 'datagen.api.catalog': ['cache/*', 'cache/humans/*']}
