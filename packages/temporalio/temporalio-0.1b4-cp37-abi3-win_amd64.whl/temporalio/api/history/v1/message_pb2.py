...
_WORKFLOWUPDATEREQUESTEDEVENTATTRIBUTES = DESCRIPTOR.message_types_by_name[
...
WorkflowUpdateRequestedEventAttributes = _reflection.GeneratedProtocolMessageType(
    "WorkflowUpdateRequestedEventAttributes",
    (_message.Message,),
    {
        "DESCRIPTOR": _WORKFLOWUPDATEREQUESTEDEVENTATTRIBUTES,
        "__module__": "temporal.api.history.v1.message_pb2"
        # @@protoc_insertion_point(class_scope:temporal.api.history.v1.WorkflowUpdateRequestedEventAttributes)
    },
)
_sym_db.RegisterMessage(WorkflowUpdateRequestedEventAttributes)
