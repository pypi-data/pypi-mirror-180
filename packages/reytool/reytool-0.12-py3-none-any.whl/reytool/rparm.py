...
from .rbasic import check_parm, if_iterable
...
class RParm(object):
    ...
    def __init__(self, *args: "dict", default: "object"="error") -> "None":
        """
        Set parameters directory attribute.
        """

        for element in args: check_parm(element, dict)
    ...
    def __call__(self, *args: "object") -> "object":
        ...
        if args == ():
            ...
            ret = {key: self.parms[key] for key in args}
        return ret
    ...
    def __add__(self, parms: "dict") -> "dict":
        ...
        if if_iterable(parms, [str, bytes, dict]):
