...
class Sharepoint:
    def __init__(self, salureconnect_connection: SalureConnect, site: str, site_id: str, json_subset: int, debug: bool = False):
        """
        ...
        credentials = self.salureconnect_connection.get_system_credential(system='sharepoint')
        if debug:
