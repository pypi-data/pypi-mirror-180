...
class SetTimerAction(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            def stub(timer_name: builtins.str, timer_duration: TimerDuration) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument timer_name", value=timer_name, expected_type=type_hints["timer_name"])
...
class TimerDuration(
    ...
    def from_duration(cls, duration: aws_cdk.Duration) -> "TimerDuration":
        ...
        '''
        if __debug__:
            def stub(duration: aws_cdk.Duration) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_expression(
        ...
        '''
        if __debug__:
            def stub(expression: aws_cdk.aws_iotevents_alpha.Expression) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
