...
class TestSlackDeleteHook:
    ...
    @patch("sym.flow.cli.commands.services.hooks.slack_delete.click.echo")
    def test_click_calls_uninstall_method_and_echoes(self, mock_click_echo, mock_slack_uninstall):
