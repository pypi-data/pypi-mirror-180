...
class TestSlackNewCreateHook:
    ...
    def test_slack_install_open_browser(self, mock_get_magic_url, mock_click_confirm, mock_webbrowser_open):
    ...
    def test_get_magic_url(self, mock_api_get, sandbox, global_options):
        with sandbox.push_xdg_config_home():
            assert get_magic_url(global_options.sym_api, str(uuid.uuid4())) == "http://test.symops.io"
