...
class ServiceType(ServiceTypeMeta, Enum):
    ...
    ONELOGIN = ServiceTypeMeta(
        "onelogin", matcher="user_id", external_id_name="OneLogin Domain"
    )
    ...
    TAILSCALE = ServiceTypeMeta(
        "tailscale", matcher="email", external_id_name="Tailnet Name"
    )
