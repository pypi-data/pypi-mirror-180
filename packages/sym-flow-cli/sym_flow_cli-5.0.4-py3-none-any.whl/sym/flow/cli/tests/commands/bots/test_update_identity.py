...
class TestUsersUpdateIdentity:
    ...
    def test_update_bot_identity_prompt_both(
        self, mock_apply, click_setup, bots, services
    ):
        with click_setup() as runner:
    ...
    def test_update_bot_identity_prompt_external_id(
        self, mock_apply, click_setup, bots, services
    ):
        with click_setup() as runner:
            # Prompts external ID
    ...
    def test_update_bot_identity_prompt_service_type(
        self, mock_apply, click_setup, bots, services
    ):
        with click_setup() as runner:
    ...
    def test_update_bot_identity_does_not_prompt_external_id(
        self, mock_apply, click_setup, bots, services
    ):
        with click_setup() as runner:
    ...
    def test_update_bot_identity_prompt_new_value(
        self, mock_apply, click_setup, bots, services
    ):
        with click_setup() as runner:
    ...
    def test_update_bot_identity_blank_value(
        self, mock_apply, click_setup, bots, services
    ):
        with click_setup() as runner:
