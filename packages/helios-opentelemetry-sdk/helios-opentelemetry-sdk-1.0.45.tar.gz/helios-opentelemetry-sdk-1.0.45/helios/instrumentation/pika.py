...
class RabbitMqMessageContext:
    ...
    def __enter__(self):
        ...
        self._span = tracer.start_span(PikaSpanAttributes.RECEIVE_NAME, context=context, kind=SpanKind.CONSUMER)
        self._token = attach(set_span_in_context(self._span))
        HeliosPikaInstrumentor.set_common_attributes(self._span, self._payload, headers)
