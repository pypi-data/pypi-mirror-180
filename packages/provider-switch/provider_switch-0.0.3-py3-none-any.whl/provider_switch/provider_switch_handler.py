...
from .exceptions import BadProviderException, BadRequestException, \
    ExitException
...
class ProviderSwitchHandler(object):
    ...
    def _prepare(self) -> None:
        providers = ProviderCollection(
            driver_type='json', social_type=self.social_type, service_name=self.service_name).get_providers()
