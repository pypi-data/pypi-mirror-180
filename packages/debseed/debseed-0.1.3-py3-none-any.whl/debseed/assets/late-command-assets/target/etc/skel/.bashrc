...
# Check window size after each command and adjust values of LINES and COLUMNS
shopt -s checkwinsize

# Pattern "**" matches all files and zero or more subdirectories
shopt -s globstar
