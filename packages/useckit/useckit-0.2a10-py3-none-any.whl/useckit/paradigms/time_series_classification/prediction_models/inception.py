...
class Classifier_INCEPTION(TSCBasePredictionModel):

    def __init__(self, verbose=False, batch_size=64, lr=0.001, nb_filters=32, use_residual=True, use_bottleneck=True,
                 depth=6, kernel_size=41, nb_epochs=1500, class_weights=None):
        super().__init__()
    ...
    def fit(self, x_train, y_train, x_val, y_val, y_true, input_shape, nb_classes):
        ...
        hist = model.fit(x_train, y_train, batch_size=mini_batch_size, epochs=self.nb_epochs,
    ...
    def predict(self, x_test, y_true, x_train, y_train, y_test, return_df_metrics=True):
        ...
        if return_df_metrics:
            ...
            try:
                ...
                print(
                    'PermissionError: Could not save test_duration.csv in Classifier_INCEPTION due to lack of permission.')
