...
setup(
  name = 'devicetracking',         # How you named your package folder (MyLib)
  packages = ['tracking'],   # Chose the same as "name"
  ...
  keywords = ['position', 'tracking', 'cli'],   # Keywords that define your package best
