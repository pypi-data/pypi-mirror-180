...
def plotData(dataVals, cbarTitle, color, plotTitle, cluster=None, quiver=None, colorbarMax=None, savefig=False):
    '''
    ...
    if colorbarMax != None:
        divnorm = TwoSlopeNorm(vmin=dataVals.min(), vcenter=colorbarMax/2, vmax=colorbarMax)
    else:
