...
def bevel(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge', offset: float,
...
def bisect_plane(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge',
                 dist: float, plane_co: 'mathutils.Vector',
                 plane_no: 'mathutils.Vector', use_snap_center: bool,
                 clear_outer: bool, clear_inner: bool) -> typing.Dict:
...
def contextual_create(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge',
...
def convex_hull(bm: 'bmesh.types.BMesh', input: 'bmesh.types.BMEdge',
...
def delete(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge',
...
def duplicate(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge',
...
def extrude_face_region(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge',
                        edges_exclude: typing.Set, use_keep_orig: bool,
                        use_normal_flip: bool, use_normal_from_adjacent: bool,
...
def mirror(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge',
...
def region_extend(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge',
...
def solidify(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge',
...
def spin(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge',
...
def split(bm: 'bmesh.types.BMesh', geom: 'bmesh.types.BMEdge',
...
def symmetrize(bm: 'bmesh.types.BMesh', input: 'bmesh.types.BMEdge',
