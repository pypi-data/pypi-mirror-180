...
import os
from chinillaclvm import KEYWORD_TO_ATOM
...
binary_recurse('programs/recursive-cat.chinillaclvm', 'concat', '"ABCDEF"', 29)
binary_recurse('programs/recursive-mul.chinillaclvm', '*', '0x7ffffffffffffffffffffffffffffffffffffffffffff', 100)
binary_recurse('programs/recursive-add.chinillaclvm', '+', '0x7ffffffffffffffffffffffffffffffffffffffffffffffff', 5000000)
binary_recurse('programs/recursive-sub.chinillaclvm', '-', '0x7ffffffffffffffffffffffffffffffffffffffffffffffff', 5000000)
unary_recurse('programs/recursive-div.chinillaclvm', '/', 13, 1000000)
unary_recurse('programs/recursive-lsh.chinillaclvm', 'lsh', 65535, 10000)
unary_recurse('programs/recursive-ash.chinillaclvm', 'ash', 65535, 10000)
unary_recurse('programs/recursive-pubkey.chinillaclvm', 'pubkey_for_exp', '', 10000)
unary_recurse('programs/recursive-not.chinillaclvm', 'lognot', '', 10000000)
many_args('programs/args-mul.chinillaclvm', '*', 10000)
many_args('programs/args-add.chinillaclvm', '+', 10000)
many_args('programs/args-sub.chinillaclvm', '-', 10000)
many_args('programs/args-sha.chinillaclvm', 'sha256', 10000)
many_args('programs/args-cat.chinillaclvm', 'concat', 10000)
many_args('programs/args-any.chinillaclvm', 'any', 300000)
many_args('programs/args-all.chinillaclvm', 'all', 300000)
many_args('programs/args-and.chinillaclvm', 'logand', 10000)
many_args('programs/args-or.chinillaclvm', 'logior', 10000)
many_args('programs/args-xor.chinillaclvm', 'logxor', 10000)
many_args_point('programs/args-point_add.chinillaclvm', 'point_add', 12000)
many_args('programs/args-unknown-1.chinillaclvm', '0x7fffffff00', 5000)
many_args('programs/args-unknown-2.chinillaclvm', '0x7ff40', 3000)
many_args('programs/args-unknown-3.chinillaclvm', '0x7ff80', 3000)
many_args('programs/args-unknown-4.chinillaclvm', '0x7ffc0', 3000)
unary_recurse('programs/args-unknown-5.chinillaclvm', '0x7ff00', '0xffffffffffffff', 3000000)
unary_recurse('programs/args-unknown-6.chinillaclvm', '0x001', '0xfffffffffffff', 30000000)
unary_recurse('programs/args-unknown-7.chinillaclvm', '0x041', '0xfffffffffffff', 30000000)
unary_recurse('programs/args-unknown-8.chinillaclvm', '0x081', '0xfffffffffffff', 30000000)
unary_recurse('programs/args-unknown-9.chinillaclvm', '0x0c1', '0xfffffffffffff', 30000000)
recursive_cons('programs/recursive-cons.chinillaclvm', 10000000)

# this program attempts to wrap around a 64 bit cost counter
softfork_wrap('programs/softfork-1.chinillaclvm', '0x00ffffffffffffff45')
# this program attempts to wrap around a 32 bit cost counter
softfork_wrap('programs/softfork-2.chinillaclvm', '0x00ffffff45')
