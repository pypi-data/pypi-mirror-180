...
The fuzzing infrastructure for `chinillaclvm_rs` uses [cargo-fuzz](https://github.com/rust-fuzz/cargo-fuzz).
...
If you find issues in `chinillaclvm_rs` please see the [Bug Bounty program](https://www.chinilla.net/2021/10/21/bugcrowd-bounty-launch.en.html).
