...
def run_workflow(workflow_id: str, api_key: str, args: List[str], kwargs: Dict[str, Any]) -> WorkflowResponse:
    ...
    workflow_response = WorkflowResponse(outputs=response_dict["outputs"], namedOutputs=response_dict.get("namedOutputs", None), executionTrace=response_dict["executionTrace"])
