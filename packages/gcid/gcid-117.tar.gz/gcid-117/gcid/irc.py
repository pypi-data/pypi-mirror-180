...
from gcid.object import Class, Default, Object
from gcid.object import keys, last, printable
from gcid.object import edit, fntime, find, save, update
from gcid.object import locked, register
from gcid.handler import Command, Event, Handler
from gcid.thread import launch
from gcid.util import elapsed
...
NAME = "gcid"
REALNAME = '@KarimKhanQC reconsider OTP-CR-117/19 - http://pypi.org/project/gcid'
