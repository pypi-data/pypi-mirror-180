...
class AcceleratorAttributes:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            def stub(*, accelerator_arn: builtins.str, dns_name: builtins.str) -> None:
                ...
...
class CfnEndpointGroup(
    ...
    def __init__(
        ...
        *,
        ...
        endpoint_configurations: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnEndpointGroup.EndpointConfigurationProperty", typing.Dict[str, typing.Any]]]]]] = None,
        ...
        port_overrides: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnEndpointGroup.PortOverrideProperty", typing.Dict[str, typing.Any]]]]]] = None,
...
class CfnListener(
    ...
    def __init__(
        ...
        *,
        accelerator_arn: builtins.str,
        port_ranges: typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnListener.PortRangeProperty", typing.Dict[str, typing.Any]]]]],
    ...
    class PortRangeProperty:
        def __init__(self, *, from_port: jsii.Number, to_port: jsii.Number) -> None:
            ...
            '''
            if __debug__:
                def stub(*, from_port: jsii.Number, to_port: jsii.Number) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
...
class EndpointGroup(
    ...
    def add_endpoint(self, endpoint: IEndpoint) -> None:
        ...
        '''
        if __debug__:
            def stub(endpoint: IEndpoint) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def connections_peer(
        ...
        '''
        if __debug__:
            def stub(id: builtins.str, vpc: aws_cdk.aws_ec2.IVpc) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
