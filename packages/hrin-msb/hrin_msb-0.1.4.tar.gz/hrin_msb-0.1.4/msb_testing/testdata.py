...
from msb_datetime import (DEFAULT_DATE, DEFAULT_TIME, current_date, current_timestamp)
...
def random_date(start: str = "", end: str = '', fmt=DEFAULT_DATE):
	return current_date()


def random_time(start: str = "", end: str = '', fmt=DEFAULT_TIME):
