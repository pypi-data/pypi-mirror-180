...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"central_vpc": "centralVpc", "zone": "zone"},
)
class AddR53ZoneProps:
    def __init__(self, *, central_vpc: aws_cdk.aws_ec2.Vpc, zone: builtins.str) -> None:
        '''
        :param central_vpc: 
        :param zone: 
        ...
        self._values: typing.Dict[str, typing.Any] = {
            "central_vpc": central_vpc,
            "zone": zone,
        }

    @builtins.property
    def central_vpc(self) -> aws_cdk.aws_ec2.Vpc:
        '''
        :stability: experimental
        '''
        result = self._values.get("central_vpc")
        assert result is not None, "Required property 'central_vpc' is missing"
...
class EnterpriseVpc(
    ...
    def __init__(
        ...
        *,
        ...
        if __debug__:
            ...
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = EnterpriseVpcProps(vpc=vpc, central_vpc=central_vpc)
    ...
    def add_r53_zone(
        self,
        *,
        central_vpc: aws_cdk.aws_ec2.Vpc,
        zone: builtins.str,
    ) -> None:
        '''
        :param central_vpc: 
        ...
        :stability: experimental
        '''
        props = AddR53ZoneProps(central_vpc=central_vpc, zone=zone)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"vpc": "vpc", "central_vpc": "centralVpc"},
)
