...
class R53Resolverendpoints(
    ...
    def __init__(
        ...
        *,
        subnet_group: builtins.str,
        vpc: aws_cdk.aws_ec2.Vpc,
        resolve_domains: typing.Optional[typing.Sequence[builtins.str]] = None,
...
class R53ResolverendpointsProps:
    def __init__(
        ...
        *,
        ...
        if resolve_domains is not None:
            self._values["resolve_domains"] = resolve_domains
    ...
    @builtins.property
    def resolve_domains(self) -> typing.Optional[typing.List[builtins.str]]:
