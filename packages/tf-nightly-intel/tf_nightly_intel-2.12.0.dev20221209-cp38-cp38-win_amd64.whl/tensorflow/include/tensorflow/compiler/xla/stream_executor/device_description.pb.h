...
inline bool GpuTargetConfigProto::has_cuda_compute_capability() const {
  return this != internal_default_instance() && cuda_compute_capability_ != nullptr;
}
inline void GpuTargetConfigProto::clear_cuda_compute_capability() {
  if (GetArenaNoVirtual() == nullptr && cuda_compute_capability_ != nullptr) {
    delete cuda_compute_capability_;
  }
  cuda_compute_capability_ = nullptr;
}
inline const ::stream_executor::CudaComputeCapabilityProto& GpuTargetConfigProto::cuda_compute_capability() const {
  const ::stream_executor::CudaComputeCapabilityProto* p = cuda_compute_capability_;
  // @@protoc_insertion_point(field_get:stream_executor.GpuTargetConfigProto.cuda_compute_capability)
  return p != nullptr ? *p : *reinterpret_cast<const ::stream_executor::CudaComputeCapabilityProto*>(
      &::stream_executor::_CudaComputeCapabilityProto_default_instance_);
}
inline ::stream_executor::CudaComputeCapabilityProto* GpuTargetConfigProto::release_cuda_compute_capability() {
  ...
  ::stream_executor::CudaComputeCapabilityProto* temp = cuda_compute_capability_;
  cuda_compute_capability_ = nullptr;
  return temp;
}
inline ::stream_executor::CudaComputeCapabilityProto* GpuTargetConfigProto::mutable_cuda_compute_capability() {
  
  if (cuda_compute_capability_ == nullptr) {
    auto* p = CreateMaybeMessage<::stream_executor::CudaComputeCapabilityProto>(GetArenaNoVirtual());
    cuda_compute_capability_ = p;
  }
...
inline void GpuTargetConfigProto::set_allocated_cuda_compute_capability(::stream_executor::CudaComputeCapabilityProto* cuda_compute_capability) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete cuda_compute_capability_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:stream_executor.GpuTargetConfigProto.cuda_compute_capability)
}

// .stream_executor.RocmComputeCapabilityProto rocm_compute_capability = 3;
inline bool GpuTargetConfigProto::has_rocm_compute_capability() const {
  return this != internal_default_instance() && rocm_compute_capability_ != nullptr;
}
inline void GpuTargetConfigProto::clear_rocm_compute_capability() {
  if (GetArenaNoVirtual() == nullptr && rocm_compute_capability_ != nullptr) {
    delete rocm_compute_capability_;
  }
  rocm_compute_capability_ = nullptr;
}
inline const ::stream_executor::RocmComputeCapabilityProto& GpuTargetConfigProto::rocm_compute_capability() const {
  const ::stream_executor::RocmComputeCapabilityProto* p = rocm_compute_capability_;
  // @@protoc_insertion_point(field_get:stream_executor.GpuTargetConfigProto.rocm_compute_capability)
  return p != nullptr ? *p : *reinterpret_cast<const ::stream_executor::RocmComputeCapabilityProto*>(
      &::stream_executor::_RocmComputeCapabilityProto_default_instance_);
}
inline ::stream_executor::RocmComputeCapabilityProto* GpuTargetConfigProto::release_rocm_compute_capability() {
  ...
  ::stream_executor::RocmComputeCapabilityProto* temp = rocm_compute_capability_;
  rocm_compute_capability_ = nullptr;
  return temp;
}
inline ::stream_executor::RocmComputeCapabilityProto* GpuTargetConfigProto::mutable_rocm_compute_capability() {
  
  if (rocm_compute_capability_ == nullptr) {
    auto* p = CreateMaybeMessage<::stream_executor::RocmComputeCapabilityProto>(GetArenaNoVirtual());
    rocm_compute_capability_ = p;
  }
...
inline void GpuTargetConfigProto::set_allocated_rocm_compute_capability(::stream_executor::RocmComputeCapabilityProto* rocm_compute_capability) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete rocm_compute_capability_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:stream_executor.GpuTargetConfigProto.rocm_compute_capability)
}
