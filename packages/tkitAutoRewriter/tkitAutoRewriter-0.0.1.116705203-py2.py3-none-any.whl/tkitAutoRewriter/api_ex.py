...
def auto_rewriter_by_paraphrase( text,
                                is_html=False,
                                simlimit=0.8,
                                num_beams=5,
                                ...
                                pre_text="",api='http://192.168.1.18:3008',api_sbert_host="http://192.168.1.18:3016",
    ...
    pre=auto_cut_markdown(text,is_html=is_html,tilling=False,return_sents=True)
    for item in pre:
        sents=[]
...
if __name__ == "__main__":
    ...
    res=auto_rewriter_by_paraphrase( text,is_html=False, simlimit=0.8, num_beams=5, num_return_sequences=5, max_length=128, simlimitmax=1.0,auto_sample=False,temperature=1.2197635693677316, pre_text="",api='http://192.168.1.18:3011',api_sbert_host="http://192.168.1.18:3016")
