...
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.4.0/include/hiprand/hiprand_mtgp32_host.h by using #include <hiprand/hiprand_mtgp32_host.h>")
