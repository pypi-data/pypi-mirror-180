...
/* give warning */
#if defined(_MSC_VER)
#pragma message(": warning:This file is deprecated. Use the header file from /opt/rocm-5.4.0/include/hipsolver/internal/hipsolver-version.h by using #include <hipsolver/internal/hipsolver-version.h>")
...
#define hipsolverVersionMinor 6
#define hipsolverVersionPatch 0
#define hipsolverVersionTweak 9d85697-dirty
// clang-format on
