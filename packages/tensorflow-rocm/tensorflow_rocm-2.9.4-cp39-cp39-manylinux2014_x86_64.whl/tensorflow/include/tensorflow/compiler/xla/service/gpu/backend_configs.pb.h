...
class CudnnConvBackendConfig :
 ...
 public:
  ...
  const std::string& call_context() const;
  void set_call_context(const std::string& value);
  void set_call_context(std::string&& value);
  void set_call_context(const char* value);
  void set_call_context(const char* value, size_t size);
  std::string* mutable_call_context();
  std::string* release_call_context();
  void set_allocated_call_context(std::string* call_context);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr call_context_;
...
class GemmBackendConfig :
 ...
 public:
  ...
  enum : int {
    ...
    kGradXFieldNumber = 12,
    kGradYFieldNumber = 13,
...
// string call_context = 7;
inline void CudnnConvBackendConfig::clear_call_context() {
  call_context_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& CudnnConvBackendConfig::call_context() const {
  // @@protoc_insertion_point(field_get:xla.gpu.CudnnConvBackendConfig.call_context)
  return call_context_.GetNoArena();
}
inline void CudnnConvBackendConfig::set_call_context(const std::string& value) {
  
  call_context_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:xla.gpu.CudnnConvBackendConfig.call_context)
}
inline void CudnnConvBackendConfig::set_call_context(std::string&& value) {
  
  call_context_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:xla.gpu.CudnnConvBackendConfig.call_context)
}
inline void CudnnConvBackendConfig::set_call_context(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  call_context_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:xla.gpu.CudnnConvBackendConfig.call_context)
}
inline void CudnnConvBackendConfig::set_call_context(const char* value, size_t size) {
  
  call_context_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:xla.gpu.CudnnConvBackendConfig.call_context)
}
inline std::string* CudnnConvBackendConfig::mutable_call_context() {
  
  // @@protoc_insertion_point(field_mutable:xla.gpu.CudnnConvBackendConfig.call_context)
  return call_context_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* CudnnConvBackendConfig::release_call_context() {
  // @@protoc_insertion_point(field_release:xla.gpu.CudnnConvBackendConfig.call_context)
  
  return call_context_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void CudnnConvBackendConfig::set_allocated_call_context(std::string* call_context) {
  if (call_context != nullptr) {
    
  } else {
    
  }
  call_context_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), call_context);
  // @@protoc_insertion_point(field_set_allocated:xla.gpu.CudnnConvBackendConfig.call_context)
}
