...
/// Regularizing tensor input by reset random elements to zero.
///
/// Args:
/// * scope: A Scope object
///
...
class Dropout {
 public:
  Dropout(const ::tensorflow::Scope& scope, ::tensorflow::Input input,
        ::tensorflow::Input rate, ::tensorflow::Input noise_shape,
        ::tensorflow::Input seed1, ::tensorflow::Input seed2);

  Operation operation;
  ::tensorflow::Output output;
  ::tensorflow::Output mask;
};
...
class DropoutGrad {
 public:
  DropoutGrad(const ::tensorflow::Scope& scope, ::tensorflow::Input gradients,
            ::tensorflow::Input rate, ::tensorflow::Input mask);
