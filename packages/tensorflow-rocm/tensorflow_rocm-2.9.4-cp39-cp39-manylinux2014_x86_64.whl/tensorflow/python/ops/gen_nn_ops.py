...
_DropoutOutput = collections.namedtuple(
    "Dropout",
    ["output", "mask"])
...
@_dispatch.add_type_based_api_dispatcher
@tf_export('dropout')
def dropout(input, rate, noise_shape, seed1, seed2, name=None):
  r"""Regularizing tensor input by reset random elements to zero.

  Args:
    input: A `Tensor`. Must be one of the following types: `float32`, `half`, `float64`.
    rate: A `Tensor`. Must have the same type as `input`.
    noise_shape: A `Tensor` of type `int32`.
    seed1: A `Tensor`. Must be one of the following types: `int32`, `int64`.
    seed2: A `Tensor`. Must have the same type as `seed1`.
    name: A name for the operation (optional).

  Returns:
    A tuple of `Tensor` objects (output, mask).
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "Dropout", name, input, rate, noise_shape, seed1, seed2)
      ...
      pass
    try:
      _result = _dispatcher_for_dropout(
          (input, rate, noise_shape, seed1, seed2, name,), None)
      if _result is not NotImplemented:
        return _result
      return dropout_eager_fallback(
          input, rate, noise_shape, seed1, seed2, name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
    except (TypeError, ValueError):
      _result = _dispatch.dispatch(
            dropout, (), dict(input=input, rate=rate, noise_shape=noise_shape,
                              seed1=seed1, seed2=seed2, name=name)
          )
      if _result is not _dispatch.OpDispatcher.NOT_SUPPORTED:
        return _result
      raise
  ...
  try:
    _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "Dropout", input=input, rate=rate, noise_shape=noise_shape,
                   seed1=seed1, seed2=seed2, name=name)
  except (TypeError, ValueError):
    _result = _dispatch.dispatch(
          dropout, (), dict(input=input, rate=rate, noise_shape=noise_shape,
  ...
  if _execute.must_record_gradient():
    ...
    _inputs_flat = _op.inputs
    _execute.record_gradient(
        "Dropout", _inputs_flat, _attrs, _result)
  _result = _DropoutOutput._make(_result)
  return _result

Dropout = tf_export("raw_ops.Dropout")(_ops.to_raw_op(dropout))
_dispatcher_for_dropout = dropout._tf_type_based_dispatcher.Dispatch


def dropout_eager_fallback(input, rate, noise_shape, seed1, seed2, name, ctx):
  ...
  _result = _execute.execute(b"Dropout", 2, inputs=_inputs_flat, attrs=_attrs,
                             ctx=ctx, name=name)
  if _execute.must_record_gradient():
    _execute.record_gradient(
        "Dropout", _inputs_flat, _attrs, _result)
...
def dropout_grad(gradients, rate, mask, name=None):
  r"""Computes gradients of the dropout function.
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "DropoutGrad", name, gradients, rate, mask)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
      pass
    try:
      _result = _dispatcher_for_dropout_grad(
          (gradients, rate, mask, name,), None)
      if _result is not NotImplemented:
        return _result
      return dropout_grad_eager_fallback(
          gradients, rate, mask, name=name, ctx=_ctx)
    except _core._SymbolicException:
      pass  # Add nodes to the TensorFlow graph.
    except (TypeError, ValueError):
      _result = _dispatch.dispatch(
            dropout_grad, (), dict(gradients=gradients, rate=rate, mask=mask,
                                   name=name)
          )
      if _result is not _dispatch.OpDispatcher.NOT_SUPPORTED:
        return _result
  ...
  try:
    _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "DropoutGrad", gradients=gradients, rate=rate, mask=mask, name=name)
  except (TypeError, ValueError):
    _result = _dispatch.dispatch(
          dropout_grad, (), dict(gradients=gradients, rate=rate, mask=mask,
                                 name=name)
  ...
  if _execute.must_record_gradient():
    ...
    _inputs_flat = _op.inputs
    _execute.record_gradient(
        "DropoutGrad", _inputs_flat, _attrs, _result)
  _result, = _result
  return _result

DropoutGrad = tf_export("raw_ops.DropoutGrad")(_ops.to_raw_op(dropout_grad))
_dispatcher_for_dropout_grad = dropout_grad._tf_type_based_dispatcher.Dispatch


def dropout_grad_eager_fallback(gradients, rate, mask, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, rate], ctx, [_dtypes.float32, _dtypes.half, _dtypes.float64, ])
  (gradients, rate) = _inputs_T
  mask = _ops.convert_to_tensor(mask, _dtypes.uint8)
  _inputs_flat = [gradients, rate, mask]
  _attrs = ("T", _attr_T)
  _result = _execute.execute(b"DropoutGrad", 1, inputs=_inputs_flat,
                             attrs=_attrs, ctx=ctx, name=name)
  if _execute.must_record_gradient():
    _execute.record_gradient(
        "DropoutGrad", _inputs_flat, _attrs, _result)
...
def gelu(features, name=None):
  ...
  if tld.is_eager:
    ...
    try:
      ...
      _result = _dispatch.dispatch(
            gelu, (), dict(features=features, name=name)
          )
      if _result is not _dispatch.OpDispatcher.NOT_SUPPORTED:
        return _result
      raise
  ...
  try:
    _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "Gelu", features=features, name=name)
  except (TypeError, ValueError):
    _result = _dispatch.dispatch(
          gelu, (), dict(features=features, name=name)
        )
...
def gelu_eager_fallback(features, name, ctx):
  _attr_T, (features,) = _execute.args_to_matching_eager([features], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, ])
  _inputs_flat = [features]
  _attrs = ("T", _attr_T)
...
@_dispatch.add_type_based_api_dispatcher
@tf_export('gelu_grad')
def gelu_grad(gradients, outputs, name=None):
  r"""TODO: add doc.
  ...
  if tld.is_eager:
    try:
      _result = pywrap_tfe.TFE_Py_FastPathExecute(
        _ctx, "GeluGrad", name, gradients, outputs)
      return _result
    except _core._NotOkStatusException as e:
      _ops.raise_from_not_ok_status(e, name)
    except _core._FallbackException:
    ...
    try:
      ...
      _result = _dispatch.dispatch(
            gelu_grad, (), dict(gradients=gradients, outputs=outputs,
                                name=name)
          )
      if _result is not _dispatch.OpDispatcher.NOT_SUPPORTED:
        return _result
  ...
  try:
    _, _, _op, _outputs = _op_def_library._apply_op_helper(
        "GeluGrad", gradients=gradients, outputs=outputs, name=name)
  except (TypeError, ValueError):
    _result = _dispatch.dispatch(
          gelu_grad, (), dict(gradients=gradients, outputs=outputs, name=name)
        )
    if _result is not _dispatch.OpDispatcher.NOT_SUPPORTED:
      return _result
    raise
...
def gelu_grad_eager_fallback(gradients, outputs, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, outputs], ctx, [_dtypes.half, _dtypes.bfloat16, _dtypes.float32, _dtypes.float64, ])
  (gradients, outputs) = _inputs_T
  _inputs_flat = [gradients, outputs]
  _attrs = ("T", _attr_T)
