# perllib module for pythonizer, generated by makelib.py on Fri Dec  9 23:59:42 2022
#
...
import sys,os,re,fileinput,subprocess,collections.abc,warnings,inspect,itertools,signal,traceback,io,tempfile,calendar,types,random,dataclasses,builtins,codecs,struct,pprint,functools,argparse,keyword
...
_PYTHONIZER_KEYWORDS = {'setattr','eval','open','tempfile','codecs','global','bytearray','and','finally','assert','bytes','fileinput','warnings','types','Hash','try','vars','staticmethod','slice','class','collections.abc','pow','True','def','range','dataclasses','itertools','as','await','argparse','math','property','enumerate','io','print','lambda','sum','struct','from','raise','traceback','atexit','dir','sys','builtins','iter','stat','functools','yield','signal','help','del','type','pdb','next','calendar','re','bool','callable','aiter','all','filter','break','compile','min','tm_py','map','tuple','glob','oct','return','close','import','object','bin','getattr','anext','ascii','sorted','None','float','set','super','False','subprocess','max','divmod','hasattr','hex','format','in','len','round','zip','perllib','with','elif','breakpoint','id','isinstance','continue','while','memoryview','if','not','Array','pass','complex','random','globals','ord','else','frozenset','int','getopt','classmethod','chr','os','exec','inspect','str','list','repr','input','async','wantarray','or','nonlocal','dict','fcntl','copy','hash','is','$PERLLIB','delattr','locals','for','abs','reversed','ArrayHash','any','issubclass','except'}
