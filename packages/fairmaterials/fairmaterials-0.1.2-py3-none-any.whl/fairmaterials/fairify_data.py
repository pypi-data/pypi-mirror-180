...
class fairify_data:
    ...
    def __init__(self,domain):
        ...
        if domain == "XRD":
            self.fairify_csv('./csv/XRD_demo.csv')
        if domain == "CapillaryElectrophoresis":
            self.fairify_csv('./csv/CE_demo.csv')
        if domain == "PolymerAM":
            self.fairify_csv('./csv/polymer_AM_demo.csv')
        if domain == "PVModule":
            self.fairify_csv('./csv/pv-module.csv')
        if domain == "PolymerBacksheets":
            self.fairify_csv('./csv/RWB_YI.csv')
        if domain == "OpticalSpectroscopy":
            self.fairify_csv('./csv/OpticalSpc.csv')
        if domain == "Buildings":
            self.fairify_csv('./csv/buildings_example.csv')
