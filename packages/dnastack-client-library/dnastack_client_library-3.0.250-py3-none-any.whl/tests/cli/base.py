...
class CliTestCase(BaseTestCase):
    ...
    # def prepare_for_device_code_flow(self,
    ...
    #
    #     self._email = env(email_env_var_name or 'E2E_AUTH_DEVICE_CODE_TEST_EMAIL')
    #     self._token = env(token_env_var_name or 'E2E_AUTH_DEVICE_CODE_TEST_TOKEN')
    #
