...
This package contains a pure-Python MySQL/PostgreSQL `Object Relational Mapping` client library.
...
config = dict(source='mysql', host='127.0.0.1', port=3306, user='root', password='password', database='test')
