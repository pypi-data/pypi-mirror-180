...
def rotate_colors(bm: bmesh.types.BMesh, faces: typing.List[typing.Any], use_ccw: bool, color_index: int) -> None:
...
def reverse_colors(bm: bmesh.types.BMesh, faces: typing.List[typing.Any], color_index: int) -> None:
