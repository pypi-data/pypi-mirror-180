...
class EditSettingTopLevel(tk.Toplevel):
    def __init__(self,xPos,yPos):
        ...
        R1.grid(column=0,row=2,sticky='nsew',padx=5,pady=5)
        ...
        R2.grid(column=1,row=2,sticky='nsew',padx=5,pady=5)
        ...
        returnButton.grid(column=0,row=3, sticky='nsew',padx=5, pady=5)
