...
from mldesigner._generate._generators._pipelines_generator import \
    PipelinesGenerator
...
class PipelineCodeGenerator:
    # TODO: create data folder and subgraph folder
    # DATA_FOLDER_NAME = "data"
    # SUBGRAPH_FOLDER_NAME = "subgraphs"
    ...
    def __init__(
        ...
        target_dir: Path,
        pattern_to_components: Dict[str, Dict[str, Component]],
        force_regenerate=False,
    ):
        self.target_dir = target_dir
        self._components = pattern_to_components
        self._component_generator = ModuleGenerator(
            assets=[asset],
            working_dir=Path("."),
            target_dir=Path("."),
        ...
        self._pipelines_generator = PipelinesGenerator(
    ...
    def generate(self, target_dir: Path):
        ...
        self._component_generator.generate(target_dir=target_dir)
        self._pipelines_generator.generate(target_dir=target_dir)
        ...
        generate_pkg_logger.info(msg=f"Pipeline export results were saved in {Path.absolute(target_dir)}")
