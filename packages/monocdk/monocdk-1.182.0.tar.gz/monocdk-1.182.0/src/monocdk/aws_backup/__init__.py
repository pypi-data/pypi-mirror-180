...
class BackupResource(
    ...
    def from_dynamo_db_table(cls, table: _ITable_24826f7e) -> "BackupResource":
        ...
        '''
        if __debug__:
            def stub(table: _ITable_24826f7e) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_ec2_instance(cls, instance: _IInstance_3a12995c) -> "BackupResource":
        ...
        '''
        if __debug__:
            def stub(instance: _IInstance_3a12995c) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_efs_file_system(
        ...
        '''
        if __debug__:
            def stub(file_system: _IFileSystem_f9c61b15) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_rds_database_instance(
        ...
        '''
        if __debug__:
            def stub(instance: _IDatabaseInstance_2f266f28) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument instance", value=instance, expected_type=type_hints["instance"])
