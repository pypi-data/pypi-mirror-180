...
class Authorization(
    ...
    def basic(
        ...
        '''
        if __debug__:
            def stub(username: builtins.str, password: _SecretValue_c18506ef) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class CfnEndpoint(
    ...
    class EndpointEventBusProperty:
        def __init__(self, *, event_bus_arn: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, event_bus_arn: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class PrimaryProperty:
        def __init__(self, *, health_check: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, health_check: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class SecondaryProperty:
        def __init__(self, *, route: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, route: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
...
class CfnRule(
    ...
    class BatchArrayPropertiesProperty:
        def __init__(self, *, size: typing.Optional[jsii.Number] = None) -> None:
            ...
            '''
            if __debug__:
                def stub(*, size: typing.Optional[jsii.Number] = None) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class BatchRetryStrategyProperty:
        def __init__(self, *, attempts: typing.Optional[jsii.Number] = None) -> None:
            ...
            '''
            if __debug__:
                def stub(*, attempts: typing.Optional[jsii.Number] = None) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class KinesisParametersProperty:
        def __init__(self, *, partition_key_path: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, partition_key_path: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class SqsParametersProperty:
        def __init__(self, *, message_group_id: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, message_group_id: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class TargetProperty:
        def __init__(
            ...
            *,
            ...
            :param input_path: The value of the JSONPath that is used for extracting part of the matched event when passing it to the target. You may use JSON dot notation or bracke notation. For more information about JSON paths, see `JSONPath <https://docs.aws.amazon.com/http://goessner.net/articles/JsonPath/>`_ .
        ...
        def input_path(self) -> typing.Optional[builtins.str]:
            ...
            You may use JSON dot notation or bracke notation. For more information about JSON paths, see `JSONPath <https://docs.aws.amazon.com/http://goessner.net/articles/JsonPath/>`_ .
...
class EventField(metaclass=jsii.JSIIMeta, jsii_type="monocdk.aws_events.EventField"):
    ...
    def resolve(self, _ctx: _IResolveContext_e363e2cb) -> typing.Any:
        ...
        '''
        if __debug__:
            def stub(_ctx: _IResolveContext_e363e2cb) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class HttpParameter(
    ...
    def from_secret(cls, value: _SecretValue_c18506ef) -> "HttpParameter":
        ...
        '''
        if __debug__:
            def stub(value: _SecretValue_c18506ef) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class _IEventBusProxy(
    ...
    def grant_put_events_to(self, grantee: _IGrantable_4c5a91d1) -> _Grant_bcb5eae7:
        ...
        '''
        if __debug__:
            def stub(grantee: _IGrantable_4c5a91d1) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class _IRuleTargetProxy:
    ...
    def bind(
        ...
        '''
        if __debug__:
            def stub(rule: IRule, id: typing.Optional[builtins.str] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Rule(
    ...
    def add_target(self, target: typing.Optional[IRuleTarget] = None) -> None:
        ...
        '''
        if __debug__:
            def stub(target: typing.Optional[IRuleTarget] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument target", value=target, expected_type=type_hints["target"])
