...
class CfnTrail(
    ...
    def is_logging(
        ...
        if __debug__:
            def stub(value: typing.Union[builtins.bool, _IResolvable_a771d0ef]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    class InsightSelectorProperty:
        def __init__(
            ...
            *,
            ...
            '''
            if __debug__:
                def stub(*, insight_type: typing.Optional[builtins.str] = None) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
