...
class CfnUser(
    ...
    def __init__(
        ...
        *,
        ...
        :param authentication_mode: Specifies the authentication mode to use. Below is an example of the possible JSON values:. Example:: { AuthenticationType: <iam | no-password-required | password> Passwords: ["*****", "******"] // If authentication-type is password. }
