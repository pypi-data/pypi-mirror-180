    ...
    class StatefulRuleGroupReferenceProperty:
        def __init__(
            ...
            *,
            ...
            override: typing.Optional[typing.Union[typing.Union["CfnFirewallPolicy.StatefulRuleGroupOverrideProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
