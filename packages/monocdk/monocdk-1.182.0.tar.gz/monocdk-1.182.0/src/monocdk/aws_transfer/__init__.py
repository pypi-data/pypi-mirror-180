...
class CfnServer(
    ...
    class WorkflowDetailsProperty:
        def __init__(
            self,
            *,
            on_partial_upload: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnServer.WorkflowDetailProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
            on_upload: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnServer.WorkflowDetailProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        ) -> None:
