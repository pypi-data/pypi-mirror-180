...
class LambdaDeploymentGroup(
    ...
    def add_alarm(self, alarm: _IAlarm_bf66c8d0) -> None:
        ...
        '''
        if __debug__:
            def stub(alarm: _IAlarm_bf66c8d0) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def add_post_hook(self, post_hook: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            def stub(post_hook: _IFunction_6e14f09e) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def add_pre_hook(self, pre_hook: _IFunction_6e14f09e) -> None:
        ...
        '''
        if __debug__:
            def stub(pre_hook: _IFunction_6e14f09e) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class LoadBalancer(
    ...
    def application(
        ...
        '''
        if __debug__:
            def stub(alb_target_group: _IApplicationTargetGroup_5a474b2b) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def network(cls, nlb_target_group: _INetworkTargetGroup_6938b578) -> "LoadBalancer":
        ...
        '''
        if __debug__:
            def stub(nlb_target_group: _INetworkTargetGroup_6938b578) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class ServerDeploymentGroup(
    ...
    def add_auto_scaling_group(self, asg: _AutoScalingGroup_604a934f) -> None:
        ...
        '''
        if __debug__:
            def stub(asg: _AutoScalingGroup_604a934f) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
