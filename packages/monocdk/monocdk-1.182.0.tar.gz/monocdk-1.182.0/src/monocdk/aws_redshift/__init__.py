...
class CfnEndpointAccess(
    ...
    def __init__(
        ...
        *,
        ...
        vpc_security_groups: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnEndpointAccess.VpcSecurityGroupProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
    ) -> None:
...
class Table(
    ...
    def apply_removal_policy(self, policy: _RemovalPolicy_c97e7a20) -> None:
        ...
        '''
        if __debug__:
            def stub(policy: _RemovalPolicy_c97e7a20) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
