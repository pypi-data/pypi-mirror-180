    ...
    class SpekeKeyProviderProperty:
        def __init__(
            ...
            *,
            ...
            system_ids: typing.Sequence[builtins.str],
            url: builtins.str,
            encryption_contract_configuration: typing.Optional[typing.Union[typing.Union["CfnPackagingConfiguration.EncryptionContractConfigurationProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        ) -> None:
