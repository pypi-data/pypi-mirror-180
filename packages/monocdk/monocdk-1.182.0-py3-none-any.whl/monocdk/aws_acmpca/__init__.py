...
class CfnCertificate(
    ...
    class OtherNameProperty:
        def __init__(self, *, type_id: builtins.str, value: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, type_id: builtins.str, value: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class QualifierProperty:
        def __init__(self, *, cps_uri: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, cps_uri: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
    ...
    class RevocationConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            Your private certificate authority (CA) can configure Online Certificate Status Protocol (OCSP) support and/or maintain a certificate revocation list (CRL). OCSP returns validation information about certificates as requested by clients, and a CRL contains an updated list of certificates revoked by your CA. For more information, see `RevokeCertificate <https://docs.aws.amazon.com/privateca/latest/APIReference/API_RevokeCertificate.html>`_ .
