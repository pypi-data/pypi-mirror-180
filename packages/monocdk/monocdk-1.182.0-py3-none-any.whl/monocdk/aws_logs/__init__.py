...
class _ILogGroupProxy(
    ...
    def grant(
        ...
        *actions: builtins.str,
        ...
        '''
        if __debug__:
            def stub(grantee: _IGrantable_4c5a91d1, *actions: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class _ILogSubscriptionDestinationProxy:
    ...
    def bind(
        ...
        '''
        if __debug__:
            def stub(scope: _Construct_e78e779f, source_log_group: ILogGroup) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class CrossAccountDestination(
    ...
    def bind(
        ...
        '''
        if __debug__:
            def stub(_scope: _Construct_e78e779f, _source_log_group: ILogGroup) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
