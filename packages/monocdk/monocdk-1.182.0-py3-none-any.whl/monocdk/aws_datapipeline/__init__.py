...
class CfnPipeline(
    ...
    def __init__(
        ...
        *,
        ...
        parameter_objects: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnPipeline.ParameterObjectProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
