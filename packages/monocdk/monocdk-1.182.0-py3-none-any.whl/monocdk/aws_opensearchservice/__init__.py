    ...
    class DomainEndpointOptionsProperty:
        def __init__(
            ...
            *,
            ...
            :param enforce_https: True to require that all traffic to the domain arrive over HTTPS. Required you enable fine-grained access control in `AdvancedSecurityOptions <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html>`_ .
        ...
        def enforce_https(
            ...
            Required you enable fine-grained access control in `AdvancedSecurityOptions <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html>`_ .
    ...
    class MasterUserOptionsProperty:
        def __init__(
            ...
            *,
            ...
            :param master_user_arn: ARN for the master user. Only specify if ``InternalUserDatabaseEnabled`` is false in `AdvancedSecurityOptionsInput <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html>`_ .
        ...
        def master_user_arn(self) -> typing.Optional[builtins.str]:
            ...
            Only specify if ``InternalUserDatabaseEnabled`` is false in `AdvancedSecurityOptionsInput <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-opensearchservice-domain-advancedsecurityoptionsinput.html>`_ .
...
class _IDomainProxy(
    ...
    def grant_index_read(
        ...
        '''
        if __debug__:
            def stub(index: builtins.str, identity: _IGrantable_4c5a91d1) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def grant_path_read(
        ...
        '''
        if __debug__:
            def stub(path: builtins.str, identity: _IGrantable_4c5a91d1) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Domain(
    ...
    def add_access_policies(
        ...
        *access_policy_statements: _PolicyStatement_296fe8a3,
        ...
        '''
        if __debug__:
            def stub(*access_policy_statements: _PolicyStatement_296fe8a3) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
