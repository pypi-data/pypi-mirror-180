...
class CfnView(
    ...
    def __init__(
        ...
        *,
        ...
        filters: typing.Optional[typing.Union[typing.Union["CfnView.FiltersProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
        included_properties: typing.Optional[typing.Union[_IResolvable_a771d0ef, typing.Sequence[typing.Union[typing.Union["CfnView.IncludedPropertyProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]]]] = None,
        tags: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
    ) -> None:
