...
class CfnDetectorModel(
    ...
    class SetVariableProperty:
        def __init__(self, *, value: builtins.str, variable_name: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, value: builtins.str, variable_name: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
                check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CfnInput(
    ...
    class AttributeProperty:
        def __init__(self, *, json_path: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, json_path: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
...
class _IActionProxy:
    ...
    def bind(
        ...
        *,
        ...
        '''
        if __debug__:
            def stub(scope: constructs.Construct, *, role: _IRole_59af6f50) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
