...
class AlbArnTarget(
    ...
    def attach_to_network_target_group(
        ...
        '''
        if __debug__:
            def stub(target_group: _INetworkTargetGroup_6938b578) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class AlbTarget(
    ...
    def __init__(
        ...
        '''
        if __debug__:
            def stub(alb: _ApplicationLoadBalancer_16524503, port: jsii.Number) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class InstanceIdTarget(
    ...
    def attach_to_application_target_group(
        ...
        '''
        if __debug__:
            def stub(target_group: _IApplicationTargetGroup_5a474b2b) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument target_group", value=target_group, expected_type=type_hints["target_group"])
