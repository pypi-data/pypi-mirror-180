...
class CfnDirectoryConfig(
    ...
    def __init__(
        ...
        *,
        ...
        certificate_based_auth_properties: typing.Optional[typing.Union[typing.Union["CfnDirectoryConfig.CertificateBasedAuthPropertiesProperty", typing.Dict[str, typing.Any]], _IResolvable_a771d0ef]] = None,
    ) -> None:
