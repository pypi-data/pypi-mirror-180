...
class CacheControl(
    ...
    def max_age(cls, t: _Duration_070aa057) -> "CacheControl":
        ...
        '''
        if __debug__:
            def stub(t: _Duration_070aa057) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class ManualApprovalAction(
    ...
    def grant_manual_approval(self, grantable: _IGrantable_4c5a91d1) -> None:
        ...
        '''
        if __debug__:
            def stub(grantable: _IGrantable_4c5a91d1) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class StackSetParameters(
    ...
    def from_artifact_path(
        ...
        '''
        if __debug__:
            def stub(artifact_path: _ArtifactPath_a5b79113) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument artifact_path", value=artifact_path, expected_type=type_hints["artifact_path"])
...
class StateMachineInput(
    ...
    def file_path(cls, input_file: _ArtifactPath_a5b79113) -> "StateMachineInput":
        ...
        '''
        if __debug__:
            def stub(input_file: _ArtifactPath_a5b79113) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
