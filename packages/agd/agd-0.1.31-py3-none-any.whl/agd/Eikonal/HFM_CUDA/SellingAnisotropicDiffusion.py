...
def anisotropic_diffusion_scheme(D,dx=1.,ced=None,periodic=False,block_size=256):
	"""
	...
	assert ndim in (2,3) and D.shape[-1]==symdim
	int_t = np.int32
	float_t = np.float32
