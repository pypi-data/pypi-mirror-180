...
class BillingService:
    ...
    def ListPaymentIntents(self, request):
        check()
        return make_call(billing_pb2_grpc.BillingServiceStub(channel).ListPaymentIntents, request)
    ...
    def ListPaymentIntentsRequest(self, **kwargs):
        return billing_pb2.ListPaymentIntentsRequest(**kwargs)

    def ListPaymentIntentsResponse(self, **kwargs):
        return billing_pb2.ListPaymentIntentsResponse(**kwargs)

    def PaymentIntent(self, **kwargs):
        return billing_pb2.PaymentIntent(**kwargs)
