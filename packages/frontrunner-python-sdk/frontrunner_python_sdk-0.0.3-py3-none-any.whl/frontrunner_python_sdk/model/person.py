...
class Person(
        ...
        class properties:
            ...
            class tags(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PersonTag']:
                        return PersonTag
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PersonTag'], typing.List['PersonTag']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'tags':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'PersonTag':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["pk", "first_name", "last_name", "dob", "date_added", "date_updated", "email", "phone", "primary_addr", "tags", "bookmarked", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["pk", "first_name", "last_name", "dob", "date_added", "date_updated", "email", "phone", "primary_addr", "tags", "bookmarked", ], str]):
