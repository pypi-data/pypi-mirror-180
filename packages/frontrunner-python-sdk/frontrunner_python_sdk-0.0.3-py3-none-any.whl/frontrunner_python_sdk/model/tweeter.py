...
class Tweeter(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "handle", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "handle", ], str]):
