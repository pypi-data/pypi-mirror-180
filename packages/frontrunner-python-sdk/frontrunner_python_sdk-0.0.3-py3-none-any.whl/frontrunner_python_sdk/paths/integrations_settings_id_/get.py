...
SchemaFor200ResponseBodyApplicationJson = Integration
...
class BaseApi(api_client.Api):
    ...
    def _integrations_settings_retrieve_oapg(
        self: api_client.Api,
...
class IntegrationsSettingsRetrieve(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def integrations_settings_retrieve(
        self: BaseApi,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._integrations_settings_retrieve_oapg(
