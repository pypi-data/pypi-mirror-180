...
from testops_api import rest
from testops_api.configuration import Configuration
from testops_api.exceptions import ApiTypeError, ApiValueError, ApiException
from testops_api.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create10  # this is an instance of the class Endpoint
        api_instance.create10()  # this invokes api_instance.create10.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create10.callable or self.callable in this class
