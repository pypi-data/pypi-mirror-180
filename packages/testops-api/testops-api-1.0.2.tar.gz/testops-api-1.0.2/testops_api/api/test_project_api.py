    ...
    def __init__(self, api_client=None):
        ...
        def __create1(
            ...
            **kwargs
            ...
            >>> thread = api.create1(id, scheduler_resource, async_req=True)
            >>> result = thread.get()
        ...
        def __create_sample_git_test_project(
            self,
            project_id,
            **kwargs
        ):
            """Creates a new sample Git Test Project when setting up a Git Repository. Returns the created Sample Git Test Project.  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.create_sample_git_test_project(project_id, async_req=True)
            >>> result = thread.get()
        ...
        self.create_sample_git_test_project = Endpoint(
            settings={
                'response_type': (TestProjectResource,),
                'auth': [
                    'basicScheme'
                ],
                'endpoint_path': '/api/v1/test-projects/sample-git-test-project',
                'operation_id': 'create_sample_git_test_project',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__create_sample_git_test_project
        )
        ...
        def __get_default_test_project(
            self,
            project_id,
            **kwargs
        ):
            """Get default Test Project of a Project. Returns Test Project resource if exist.  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_default_test_project(project_id, async_req=True)
            >>> result = thread.get()
        ...
        self.get_default_test_project = Endpoint(
            settings={
                'response_type': (TestProjectResource,),
                'auth': [
                    'basicScheme'
                ],
                'endpoint_path': '/api/v1/test-projects/default',
                'operation_id': 'get_default_test_project',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__get_default_test_project
        )
        ...
        def __update(
            ...
            **kwargs
            ...
            >>> thread = api.update(id, test_project_resource, async_req=True)
            >>> result = thread.get()
        ...
        def __update1(
            ...
            **kwargs
            ...
            >>> thread = api.update1(id, scheduler_id, scheduler_resource, async_req=True)
            >>> result = thread.get()
        ...
        def __update_script_repo(
            ...
            **kwargs
            ...
            """Update a Test Project package. Returns the updated Test Project detail. Use to update script repository  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.update_script_repo(id, batch, folder_path, file_name, uploaded_path, async_req=True)
            >>> result = thread.get()
        ...
        self.update_script_repo = Endpoint(
            settings={
                'response_type': (TestProjectResource,),
                'auth': [
                    'basicScheme'
                ],
                'endpoint_path': '/api/v1/test-projects/{id}/update-script-repo',
                'operation_id': 'update_script_repo',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__update_script_repo
        )

        def __upload_script_repo(
            self,
            name,
            project_id,
            batch,
            ...
            **kwargs
            ...
            """Creates a new Test Project. Returns the created Test Project. Use to create script repository  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.upload_script_repo(name, project_id, batch, folder_path, file_name, uploaded_path, async_req=True)
            >>> result = thread.get()
        ...
        self.upload_script_repo = Endpoint(
            settings={
                'response_type': (TestProjectResource,),
                'auth': [
                    'basicScheme'
                ],
                'endpoint_path': '/api/v1/test-projects/upload-script-repo',
                'operation_id': 'upload_script_repo',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'default_test_project': 'defaultTestProject',
                },
                'location_map': {
                    'name': 'query',
                    'project_id': 'query',
