...
class TestPlanApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __create_or_update_configuration1(
            self,
            run_configuration_resource,
            **kwargs
        ):
            ...
            >>> thread = api.create_or_update_configuration1(run_configuration_resource, async_req=True)
            >>> result = thread.get()
        ...
        self.create_or_update_configuration1 = Endpoint(
            settings={
                'response_type': (RunConfigurationResource,),
                'auth': [
                    'basicScheme'
                ...
                'operation_id': 'create_or_update_configuration1',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__create_or_update_configuration1
        )
