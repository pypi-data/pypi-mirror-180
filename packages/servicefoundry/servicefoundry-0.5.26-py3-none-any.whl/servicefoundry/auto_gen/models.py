...
#   timestamp: 2022-11-30T14:32:15+00:00
...
class HuggingfaceModelHub(BaseModel):
    ...
    pipeline: Optional[constr(regex=r"[a-b-]+")] = Field(
        None,
...
class Resources(BaseModel):
    ...
    cpu_request: confloat(ge=0.1, le=16.0) = Field(
        0.2,
    ...
    cpu_limit: confloat(ge=0.1, le=16.0) = Field(
        0.5,
    ...
    memory_request: confloat(ge=100.0, le=32000.0) = Field(
        200,
    ...
    memory_limit: confloat(ge=100.0, le=32000.0) = Field(
        500,
