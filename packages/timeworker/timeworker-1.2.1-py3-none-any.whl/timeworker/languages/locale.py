...
from timeworker.timezone_parser import pop_tz_offset_from_string, word_is_tz
from timeworker.utils import normalize_unicode, combine_dicts
...
class Locale:
    ...
    :param language_info:
        Language info (translation timeworker_data) of the language the locale belongs to.
