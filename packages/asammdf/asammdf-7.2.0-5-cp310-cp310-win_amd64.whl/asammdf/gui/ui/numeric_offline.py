...
class Ui_NumericDisplay(object):
    def setupUi(self, NumericDisplay):
        ...
        self.timestamp = QDoubleSpinBox(NumericDisplay)
        ...
        self.min_t = QLabel(NumericDisplay)
        self.min_t.setObjectName(u"min_t")

        self.horizontalLayout.addWidget(self.min_t)

        self.timestamp_slider = QSlider(NumericDisplay)
        ...
        self.max_t = QLabel(NumericDisplay)
        ...
        self.target = QLineEdit(self.groupBox)
        ...
        self.backward = QPushButton(self.groupBox)
        self.backward.setObjectName(u"backward")
        icon = QIcon()
        icon.addFile(u":/right.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.forward = QPushButton(self.groupBox)
        ...
        self.match_mode = QComboBox(self.groupBox)
        ...
        self.match = QLabel(self.groupBox)
    ...
    def retranslateUi(self, NumericDisplay):
        ...
        self.min_t.setText("")
        self.max_t.setText("")
        self.groupBox.setTitle(QCoreApplication.translate("NumericDisplay", u"Search for values", None))
