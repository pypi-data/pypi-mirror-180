...
install_requires = \
['PyYAML>=6.0,<7.0', 'Rx>=3.2.0,<4.0.0']

extras_require = \
{':extra == "influxdb-client" or extra == "all"': ['influxdb-client>=1.26.0,<2.0.0'],
 ':extra == "redis-client" or extra == "all"': ['redis-purse>=0.25.0,<0.26.0'],
 ':extra == "rest-client" or extra == "rest" or extra == "all"': ['aiohttp>=3.8.1,<4.0.0'],
 ':extra == "rest-server" or extra == "rest" or extra == "all"': ['fastapi>=0.73,<0.74',
