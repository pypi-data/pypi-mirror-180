...
from tensorfn.config import TypedConfig, override, Config, Instance
...
class Checker2(Config):
    storage: Union[Storage, List[Storage]] = Local(type="local", path="checkpoints")
    reporter: Union[Reporter, List[Reporter]] = Logger(type="logger")
    ...
    def make(self, storage=None, reporter=None):
        ...
        return checker.Checker2(storages, reporters)
