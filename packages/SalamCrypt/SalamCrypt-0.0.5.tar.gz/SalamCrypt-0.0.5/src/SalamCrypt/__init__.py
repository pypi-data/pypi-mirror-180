...
class SalamCrypt:
    def enc(salamhunter5):
        namaste22=pad(salamhunter5.encode(),salamhunter4)
        salamhunter=os.urandom(16)
        salamhunter1=AES.new(salamhunter,salamhunter3,salamhunter)
        salamhunter2=salamhunter1.encrypt(namaste22)
    ...
    def ex(namaste99):
        ...
        namaste8= pad(namaste7.encode(),salamhunter4)
        namaste10 = AES.new(b64decode(namaste6),salamhunter3,b64decode(namaste6))
        exec(unpad(namaste10.decrypt(b64decode(namaste8)),salamhunter4).decode('utf-8'))
