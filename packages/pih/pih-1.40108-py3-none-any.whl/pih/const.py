...
class CONST:
    ...
    class AD:
        ...
        WORKSTATION_PREFIX_LIST: List[str] = [
            "ws-", "nb-", "ws-call-", "ws-call-", "fmvulianna"]
...
class FIELD_COLLECTION:
    ...
    class AD:
        ...
        USER: FieldItemList = FieldItemList(CONTAINER,
                                            ...
                                            FieldItem("userAccountControl", "Свойства аккаунта")).position(FIELD_NAME_COLLECTION.DESCRIPTION, 4).caption(FIELD_NAME_COLLECTION.NAME, USER_NAME.get_item_by_name(FIELD_NAME_COLLECTION.NAME).caption)
...
class Settings(Enum):
    ...
    POLIBASE_PERSON_VISIT_LAST_ADDED_ID: SettingsValue = SettingsValue(None, None, None, False)
