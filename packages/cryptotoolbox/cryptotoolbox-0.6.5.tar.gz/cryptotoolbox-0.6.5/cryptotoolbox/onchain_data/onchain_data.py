...
#    plt.show()
    ...
    traderjoe_usdc_df = final_df[['USDC_liquidity', 'USDC', 'USDC_apy']].copy()
    traderjoe_usdt_df = final_df[['USDT_liquidity', 'USDT', 'USDT_apy']].copy()
    ...
    return traderjoe_usdc_df, traderjoe_usdt_df
