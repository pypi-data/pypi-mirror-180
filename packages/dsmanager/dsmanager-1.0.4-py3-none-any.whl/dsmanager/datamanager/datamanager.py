...
class DataManager:
    ...
    def __init__(self,
        ...
        self.sources = DataStorage()
        self.utils = Utils(self, logger_path)

        self.sources["local"] = LocalSource
        self.sources["http"] = HttpSource
        self.sources["sql"] = SqlSource
        self.sources["ftp"] = FtpSource

    def add_source_class(self, name: str, source: DataSource):
