...
from clothes_sdk_ashuk203 import rest
from clothes_sdk_ashuk203.configuration import Configuration
from clothes_sdk_ashuk203.exceptions import ApiTypeError, ApiValueError
from clothes_sdk_ashuk203.schemas import (
    NoneClass,
    BoolClass,
    Schema,
    FileIO,
...
class OpenApiResponse(JSONDetector):
    ...
    def deserialize(self, response: urllib3.HTTPResponse, configuration: Configuration) -> ApiResponse:
        ...
        content_end_idx = content_type.find(';')
        if content_end_idx > -1:
            content_type = content_type[:content_end_idx]
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'ClothesPython/1.0.6'
