...
class HWComponentVariableBuilder(BaseVariableBuilder):
    ...
    for all devices and all interfaces. If you need to add, remove or
    ...
    def make_vars_using_var_hint(self, device, component):
        ...
        Many devices respond to the OID ENTITY-STATE-MIB::entStateOper for their
        ...
        on big devices this adds lots of monitoring variables. Since we can not
