...
class FwCounterVariableBuilder(BaseVariableBuilder):
    ...
    for all devices and all AclComponent components. If you need to add, remove or
    ...
    def make_variables(self, device, component):
        ...
        # this is only supported for Juniper devices at the moment
    ...
    def make_variables_jnpr(self, device, component):
        ...
        if 'jnxFWCounter' in component.getComponent().getMonitoringVariableHint():
            return {
        ...
        elif 'jnxJsPolicyStats' in component.getComponent().getMonitoringVariableHint():
            return {
    ...
    def make_variables_cisco(self, device, component):
        ...
        if 'globalFwStatsConnSetupRate' == component.getComponent().getMonitoringVariableHint():
            return {
