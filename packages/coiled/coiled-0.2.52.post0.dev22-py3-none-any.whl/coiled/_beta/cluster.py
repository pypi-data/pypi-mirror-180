...
class ClusterBeta(Cluster, Generic[IsAsynchronous]):
    ...
    async def _determine_senv(self):
        ...
        if self.package_sync:
            ...
            packages_with_notes = [pkg for pkg in env if pkg["note"]]
        ...
        return warn_for_unspecified_senv, env

    def _check_halting_issues(
        self,
        packageLevels: List[magic.PackageLevel],
        packages_by_name: Dict[str, magic.ResolvedPackageInfo],
    ):
        critical_packages = [
