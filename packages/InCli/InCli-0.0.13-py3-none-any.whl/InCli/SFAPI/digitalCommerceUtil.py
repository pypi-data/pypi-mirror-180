        ...
        for relationship in catOffers['relationships']:
          #  if relationship['vlocity_cmt__ItemType__c'] == 'Promotion':
                ...
                obj = {
                    ...
                    "isActive":relationship['vlocity_cmt__IsActive__c'],
            ...
            #        obj[field] = relationship[field]
                ...
                if len(offer)>0:
                    ...
                    obj['P_isActive'] = ""
                    obj['isOrderable'] = ""     
                    obj['__color__'] = utils.CRED if obj['isActive'] == True else utils.CYELLOW

                objs.append(obj)
        utils.printFormated(objs)
