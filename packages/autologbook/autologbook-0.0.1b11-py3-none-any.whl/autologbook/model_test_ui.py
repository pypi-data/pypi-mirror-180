...
# Form implementation generated from reading ui file 'C:\Users\Antonio\Documents\pyenv\devenv\autologbook\autologbook\ui\model_test.ui'
#
...
class Ui_main_model_test(object):
    def setupUi(self, main_model_test):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/resources/icons8-update-left-rotation-48.png"),
        ...
        self.sampleSelector.currentTextChanged['QString'].connect(main_model_test.changeListRoot)  # type: ignore
