...
def run_program(
    program: CHINILLACLVMObject,
    args: CHINILLACLVMObject,
    operator_lookup: Callable[[bytes, CHINILLACLVMObject], Tuple[int, CHINILLACLVMObject]],
    max_cost=None,
    pre_eval_f=None,
) -> Tuple[int, CHINILLACLVMObject]:
