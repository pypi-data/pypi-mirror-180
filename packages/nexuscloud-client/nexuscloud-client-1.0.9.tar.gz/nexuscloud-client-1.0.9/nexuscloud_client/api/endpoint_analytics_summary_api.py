...
class EndpointAnalyticsSummaryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.nexus_insights_api_v1_endpoints_summary_get_endpoint = _Endpoint(
            settings={
                'response_type': (NexusInsightsApiV1EndpointsSummaryGet200Response,),
                'auth': [],
                'endpoint_path': '/nexus/insights/api/v1/endpoints/summary',
                'operation_id': 'nexus_insights_api_v1_endpoints_summary_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def nexus_insights_api_v1_endpoints_summary_get(
        self,
        **kwargs
    ):
        """Get the Endpoint Summary of entire fabric or given a condition  # noqa: E501

        Get the Endpoint Summary of entire fabric or given a condition  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.nexus_insights_api_v1_endpoints_summary_get(async_req=True)
        >>> result = thread.get()
        ...
        return self.nexus_insights_api_v1_endpoints_summary_get_endpoint.call_with_http_info(**kwargs)
