...
class TopologyApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.nexus_insights_api_v1_topologies_get_endpoint = _Endpoint(
            settings={
                'response_type': (NexusInsightsApiV1TopologiesGet200Response,),
                'auth': [],
                'endpoint_path': '/nexus/insights/api/v1/topologies',
                'operation_id': 'nexus_insights_api_v1_topologies_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def nexus_insights_api_v1_topologies_get(
        self,
        site_name,
        **kwargs
    ):
        """Get topology of the fabric  # noqa: E501

        Get topology of fabric based on nodeName, fabricName, end time stamp and start time stamp  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.nexus_insights_api_v1_topologies_get(site_name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['site_name'] = \
            site_name
        return self.nexus_insights_api_v1_topologies_get_endpoint.call_with_http_info(**kwargs)
