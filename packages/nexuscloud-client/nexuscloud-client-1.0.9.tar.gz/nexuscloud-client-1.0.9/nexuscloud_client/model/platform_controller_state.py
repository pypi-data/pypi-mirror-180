...
class PlatformControllerState(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PlatformControllerState - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Controller state., must be one of ["Up", "Down", ]  # noqa: E501

        Keyword Args:
            value (str): Controller state., must be one of ["Up", "Down", ]  # noqa: E501
