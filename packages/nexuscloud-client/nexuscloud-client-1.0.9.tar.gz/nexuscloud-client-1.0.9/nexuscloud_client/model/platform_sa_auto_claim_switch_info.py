...
class PlatformSaAutoClaimSwitchInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, serial, *args, **kwargs):  # noqa: E501
        """PlatformSaAutoClaimSwitchInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, serial, *args, **kwargs):  # noqa: E501
        """PlatformSaAutoClaimSwitchInfo - a model defined in OpenAPI
