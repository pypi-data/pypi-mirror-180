...
class PlatformClaimInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, security_token, serial_number, *args, **kwargs):  # noqa: E501
        """PlatformClaimInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, security_token, serial_number, *args, **kwargs):  # noqa: E501
        """PlatformClaimInfo - a model defined in OpenAPI
