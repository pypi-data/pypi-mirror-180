...
class PlatformSiteLicStates(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PlatformSiteLicStates - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): site license states., must be one of ["NotLicensed", "GraceExpired", "TrialPeriod", "OutOfCompliance", "Compliance", "TrialExpired", "UnrecognizedValue", ]  # noqa: E501

        Keyword Args:
            value (str): site license states., must be one of ["NotLicensed", "GraceExpired", "TrialPeriod", "OutOfCompliance", "Compliance", "TrialExpired", "UnrecognizedValue", ]  # noqa: E501
