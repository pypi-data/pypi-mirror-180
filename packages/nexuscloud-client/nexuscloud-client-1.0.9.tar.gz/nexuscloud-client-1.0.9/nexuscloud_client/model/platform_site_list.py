...
def lazy_import():
    ...
    globals()['PlatformSiteInfo'] = PlatformSiteInfo


class PlatformSiteList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PlatformSiteList - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([PlatformSiteInfo]): List of Sites.  # noqa: E501

        Keyword Args:
            value ([PlatformSiteInfo]): List of Sites.  # noqa: E501
