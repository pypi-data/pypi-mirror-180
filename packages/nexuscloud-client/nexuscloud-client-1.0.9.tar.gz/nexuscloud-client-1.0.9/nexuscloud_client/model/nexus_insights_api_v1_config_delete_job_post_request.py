...
class NexusInsightsApiV1ConfigDeleteJobPostRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, config_id, fabric_name, *args, **kwargs):  # noqa: E501
        """NexusInsightsApiV1ConfigDeleteJobPostRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, config_id, fabric_name, *args, **kwargs):  # noqa: E501
        """NexusInsightsApiV1ConfigDeleteJobPostRequest - a model defined in OpenAPI
