...
class NexusInsightsApiV1JobTechSupportUploadAllPostRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, jobid, site_name, user_name, *args, **kwargs):  # noqa: E501
        """NexusInsightsApiV1JobTechSupportUploadAllPostRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, jobid, site_name, user_name, *args, **kwargs):  # noqa: E501
        """NexusInsightsApiV1JobTechSupportUploadAllPostRequest - a model defined in OpenAPI
