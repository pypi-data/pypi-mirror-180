...
class PlatformSiteMode(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PlatformSiteMode - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): site mode type., must be one of ["legacy", "non-legacy", ]  # noqa: E501

        Keyword Args:
            value (str): site mode type., must be one of ["legacy", "non-legacy", ]  # noqa: E501
