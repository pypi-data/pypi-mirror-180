...
class PlatformSiteType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PlatformSiteType - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Site Type., must be one of ["Aci", "CloudAci", "Dcnm", "Device", "Offline", "NexusSwitch", "Unknown", ]  # noqa: E501

        Keyword Args:
            value (str): Site Type., must be one of ["Aci", "CloudAci", "Dcnm", "Device", "Offline", "NexusSwitch", "Unknown", ]  # noqa: E501
