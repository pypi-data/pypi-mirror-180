...
class PlatformVersionCompatibility(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PlatformVersionCompatibility - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Version Compatibility Type., must be one of ["Ok", "NotOk", "Unknown", ]  # noqa: E501

        Keyword Args:
            value (str): Version Compatibility Type., must be one of ["Ok", "NotOk", "Unknown", ]  # noqa: E501
