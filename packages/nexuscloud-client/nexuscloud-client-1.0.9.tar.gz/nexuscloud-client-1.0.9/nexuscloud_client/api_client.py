...
from nexuscloud_client import rest
from nexuscloud_client.configuration import Configuration
from nexuscloud_client.exceptions import ApiTypeError, ApiValueError, ApiException
from nexuscloud_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AdvisoriesApi()
        api_instance.nexus_insights_api_v1_advisories_details_get  # this is an instance of the class Endpoint
        api_instance.nexus_insights_api_v1_advisories_details_get()  # this invokes api_instance.nexus_insights_api_v1_advisories_details_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.nexus_insights_api_v1_advisories_details_get.callable or self.callable in this class
