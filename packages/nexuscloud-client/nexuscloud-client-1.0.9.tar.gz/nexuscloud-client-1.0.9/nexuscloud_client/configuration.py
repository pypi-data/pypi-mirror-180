...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for the HTTP signature security scheme.
        Must be an instance of nexuscloud_client.signing.HttpSigningConfiguration
...
conf = nexuscloud_client.Configuration(
    ...
    Note you can use the constants defined in the nexuscloud_client.signing module, and you can
...
conf = nexuscloud_client.Configuration(
    signing_info = nexuscloud_client.signing.HttpSigningConfiguration(
        ...
        signing_algorithm =      nexuscloud_client.signing.ALGORITHM_RSASSA_PSS,
        signed_headers =         [nexuscloud_client.signing.HEADER_REQUEST_TARGET,
    ...
    def __init__(self, host=None,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("nexuscloud_client")
