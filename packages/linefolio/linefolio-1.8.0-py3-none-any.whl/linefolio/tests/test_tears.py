...
class PositionsTestCase(TestCase):
    ...
    def test_create_simple_tear_sheet_breakdown(self, kwargs):
        create_simple_tear_sheet(self.test_returns, positions=self.test_pos, transactions=self.test_txn, **kwargs)
    ...
    def test_create_returns_tear_sheet_breakdown(self, kwargs):
        create_returns_tear_sheet(self.test_returns, benchmark_rets=self.test_returns, **kwargs)
    ...
    def test_create_round_trip_tear_sheet_breakdown(self, kwargs):
        create_round_trip_tear_sheet(self.test_returns, self.test_pos, self.test_txn, **kwargs)
    ...
    def test_create_interesting_times_tear_sheet_breakdown(self, kwargs):
        create_interesting_times_tear_sheet(self.test_returns, self.test_returns, **kwargs)
