...
class ListScheduledRunActivationsResponse(google.protobuf.message.Message):
    ...
    @property
    def activation_ids(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
    ...
    def ClearField(self, field_name: typing_extensions.Literal["activation_ids", b"activation_ids"]) -> None: ...
...
class ListScheduledRunsResponse(google.protobuf.message.Message):
    ...
    @property
    def scheduled_runs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ScheduleInfo]: ...
    def __init__(
        self,
        *,
        scheduled_runs: collections.abc.Iterable[global___ScheduleInfo] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["scheduled_runs", b"scheduled_runs"]) -> None: ...
...
class GetScheduledActivationLogsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["activation_id", b"activation_id", "run_id", b"run_id"]) -> None: ...
...
class GetScheduledActivationLogsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["raw_logs", b"raw_logs"]) -> None: ...
...
class ScheduleInfo(google.protobuf.message.Message):
    ...
    class _StateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[ScheduleInfo._State.ValueType], builtins.type):  # noqa: F821
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cron", b"cron", "run_id", b"run_id", "state", b"state"]) -> None: ...
