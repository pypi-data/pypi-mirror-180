...
class CfnDefaultViewAssociationProps:
    def __init__(self, *, view_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(*, view_arn: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class CfnView(
    ...
    def __init__(
        ...
        *,
        ...
        filters: typing.Optional[typing.Union[typing.Union["CfnView.FiltersProperty", typing.Dict[str, typing.Any]], aws_cdk.core.IResolvable]] = None,
        included_properties: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Sequence[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnView.IncludedPropertyProperty", typing.Dict[str, typing.Any]]]]]] = None,
        tags: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None,
    ) -> None:
    ...
    def filters(
        self,
    ) -> typing.Optional[typing.Union["CfnView.FiltersProperty", aws_cdk.core.IResolvable]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union["CfnView.FiltersProperty", aws_cdk.core.IResolvable]], jsii.get(self, "filters"))

    @filters.setter
    def filters(
        self,
        value: typing.Optional[typing.Union["CfnView.FiltersProperty", aws_cdk.core.IResolvable]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[CfnView.FiltersProperty, aws_cdk.core.IResolvable]],
    ...
    def included_properties(
        self,
    ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnView.IncludedPropertyProperty"]]]]:
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnView.IncludedPropertyProperty"]]]], jsii.get(self, "includedProperties"))

    @included_properties.setter
    def included_properties(
        self,
        value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, "CfnView.IncludedPropertyProperty"]]]],
    ) -> None:
        if __debug__:
            def stub(
                value: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, CfnView.IncludedPropertyProperty]]]],
    ...
    class FiltersProperty:
        def __init__(self, *, filter_string: builtins.str) -> None:
            ...
            '''
            if __debug__:
                def stub(*, filter_string: builtins.str) -> None:
                    ...
                type_hints = typing.get_type_hints(stub)
...
class CfnViewProps:
    ...
    def filters(
        ...
        return typing.cast(typing.Optional[typing.Union[CfnView.FiltersProperty, aws_cdk.core.IResolvable]], result)
    ...
    def included_properties(
        ...
        return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.List[typing.Union[aws_cdk.core.IResolvable, CfnView.IncludedPropertyProperty]]]], result)
