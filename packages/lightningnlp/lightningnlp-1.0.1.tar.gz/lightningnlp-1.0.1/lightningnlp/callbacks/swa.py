...
class SWA:
    ...
    sort_mode：如果monitor=metrics，则需要制定排序，最大还是最小
    ...
    def __init__(self, checkpoint_dir,
        ...
        self.weights = self.init_checkpoint_weight(checkpoint_weights)
    ...
    def init_checkpoint_weight(self, weights):
