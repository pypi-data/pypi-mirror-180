...
def prepare_train_features(
    ...
    context_column_name: str, answer_column_name: str, max_length: int, doc_stride: int, padding: bool
):
...
def postprocess_qa_predictions(
    ...
    logits.
    Args:
        examples: The non-preprocessed datasets (see the main script for more information).
        features: The processed datasets (see the main script for more information).
        predictions (:obj:`Tuple[np.ndarray, np.ndarray]`):
            The predictions of the model: two arrays containing the start logits and the end logits respectively. Its
            first dimension must match the number of elements of :obj:`features`.
        version_2_with_negative (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether or not the underlying datasets contains examples with no answers.
