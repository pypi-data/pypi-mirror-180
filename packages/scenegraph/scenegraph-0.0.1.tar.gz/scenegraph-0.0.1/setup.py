...
short_descr = "Simple organisation of shapes in space"
...
pkg_data = {'scenegraph': data_files}
...
setup_kwds = dict(
    ...
    url='https://gitlab.com/revesansparole/scenegraph',
    license='cc_by_nc',
    zip_safe=False,
