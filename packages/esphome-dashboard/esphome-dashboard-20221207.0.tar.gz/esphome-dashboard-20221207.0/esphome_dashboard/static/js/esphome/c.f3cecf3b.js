import{E as t,r as e,b as i,d as s,p as o,i as a,n as r,s as d,y as n,X as l,h as c}from"./index-b2b66d7f.js";import"./c.493fa92b.js";import{c as h,s as u}from"./c.a6fda5b7.js";import{c as p,s as m}from"./c.19b39e1f.js";import{o as v}from"./c.14efc067.js";import{o as _}from"./c.b2354a5a.js";let f=class extends d{constructor(){super(...arguments),this._state="ask",this._busy=!1,this._cleanNameInput=t=>{this._error=void 0;const e=t.target;e.value=h(e.value)},this._cleanNameBlur=t=>{const e=t.target;e.value=u(e.value)},this._cleanSSIDBlur=t=>{const e=t.target;e.value=e.value.trim()}}render(){let t,e;return"ask"===this._state?(t="Adopt device",e=n`
        <div>
