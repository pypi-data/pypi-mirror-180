...
class CanvasInteractionWebhook:
    ...
    def __repr__(self):
        ...
        fields.append("canvas={}".format(repr(self._canvas)))
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if canvas is not UNSET:
            field_dict["canvas"] = canvas
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_canvas() -> Canvas:
            canvas = Canvas.from_dict(d.pop("canvas"), strict=False)
    ...
    def canvas(self) -> Canvas:
        if isinstance(self._canvas, Unset):
            raise NotPresentError(self, "canvas")
        return self._canvas
