...
T = TypeVar("T", bound="LifecycleDeactivateWebhook")


@attr.s(auto_attribs=True, repr=False)
class LifecycleDeactivateWebhook:
    ...
    def __repr__(self):
        ...
        return "LifecycleDeactivateWebhook({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        lifecycle_deactivate_webhook = cls(
            deprecated=deprecated,
            excluded_properties=excluded_properties,
            type=type,
        )

        return lifecycle_deactivate_webhook
