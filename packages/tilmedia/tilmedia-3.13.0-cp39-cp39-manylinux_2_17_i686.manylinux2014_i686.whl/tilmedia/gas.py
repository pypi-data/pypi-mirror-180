...
class Gas(DataContainer):
    ...
    The following combinations of inputs can be used to calculate properties by calling a setState function:
        ...
        1. T : temperature
        2. T, xi: temperature and mass fraction
        3. p, h, xi: pressure, specific enthalpy and mass fraction
        4. p, T, xi: pressure, temperature and mass fraction
        5. p, s, xi: pressure, specific entropy and mass fraction
        6. p, T, phi, xi_dryGas: pressure, temperature, relative humidity and mass fraction of dry gas
        7. p, T, humRatio, xi_dryGas: pressure, temperature, humidity ratio (humRatio) and mass fraction of dry gas (xi_dryGas)
        8. p, humRatio, phi, xi_dryGas: pressure, humidity ratio, relative humidity and mass fraction of dry gas
