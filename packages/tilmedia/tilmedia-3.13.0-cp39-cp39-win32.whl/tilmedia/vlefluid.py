...
class VLEFluid(DataContainer):
    ...
    This VLEFluid class can calculate the thermopyhsical properties of a pure real fluid or real fluid mixture.
        ...
        1. xi: mass fraction
        2. p, xi: pressure and mass fraction
        3. T, xi: temperature and mass fraction
        4. p, h, xi: pressure, specific enthalpy and mass fraction
        5. p, s, xi: pressure, specific entropy and mass fraction
        6. p, T, xi: pressure, temperature and mass fraction
        7. d, T, xi: density, temperature and mass fraction

    Additional experimental implementations are available for:

        1. p, d, xi: pressure, density and mass fraction
        2. T, h, xi: temperature, specific enthalpy and mass fraction
        3. T, s, xi: temperature, specific entropy and mass fraction
    ...
    Args:
        ...
        deactivate_density_derivatives (bool, optional): if true, derivatives of the denstiy are not calculated. Defaults to False.
        deactivate_two_phase_region (bool, optional): if true, derivatives of the denstiy are not calculated. Defaults to False.
    ...
    class _Info:
        ...
        def __init__(self):
            self.MediumName = None
            self.LibraryName = None
            self.LibraryLiteratureReference = None
            self.EOS_type = None
            self.EOS_models = None
            self.EOS_selected_model = None
            self.CASnumber = None
            self.Fullname = None
            self.ChemicalFormula = None
            self.Synonym = None
            self.MolarMass = None
            self.TripleTemperature = None
            self.NormalBoilingPoint = None
            self.criticalTemperature = None
            self.criticalPressure = None
            self.criticalDensity = None
            self.AcentricFactor = None
            self.DipoleMoment = None
            self.DefaultReferenceState = None
            self.UNNumber = None
            self.Family = None
            self.HeatingValue = None
            self.GWP = None
            self.ODP = None
            self.RCL = None
            self.SafetyGroup = None
            self.IdealPart_name = None
            self.IdealPart_literatureReference = None
            self.IdealPart_precisionComment = None
            self.IdealPart_Tmin = None
            self.IdealPart_Tmax = None
            self.RealPart_name = None
            self.RealPart_literatureReference = None
            self.RealPart_precisionComment = None
            self.RealPart_Tmin = None
            self.RealPart_Tmax = None
            self.RealPart_pmax = None
            self.RealPart_rhomax = None
            self.ThermalConductivity_models = None
            self.ThermalConductivity_name = None
            self.ThermalConductivity_literatureReference = None
            self.ThermalConductivity_precisionComment = None
            self.ThermalConductivity_Tmin = None
            self.ThermalConductivity_Tmax = None
            self.ThermalConductivity_pmax = None
            self.ThermalConductivity_rhomax = None
            self.Viscosity_models = None
            self.Viscosity_name = None
            self.Viscosity_literatureReference = None
