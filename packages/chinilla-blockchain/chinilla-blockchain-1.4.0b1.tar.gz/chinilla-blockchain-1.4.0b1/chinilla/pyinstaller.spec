...
if os.path.exists(f"{ROOT}/madmax/chinilla_plot"):
    binaries.extend([
        (
            f"{ROOT}/madmax/chinilla_plot",
            "madmax"
        )
    ])

if os.path.exists(f"{ROOT}/madmax/chinilla_plot_k34",):
    binaries.extend([
        (
            f"{ROOT}/madmax/chinilla_plot_k34",
            "madmax"
        )
    ])
