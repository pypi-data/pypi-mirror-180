...
from chinilla.util.keychain import KeyData, DEFAULT_USER, DEFAULT_SERVICE, Keychain, generate_mnemonic
...
class TestKeysCommands:
    ...
    def test_show_labels(self, empty_keyring, tmp_path):
        ...
        result = runner.invoke(cli, [*base_params, *cmd_params])
        assert result.output == "No keys are present in the keychain. Generate them with 'chinilla keys generate'\n"
