...
from chinilla.daemon.keychain_server import DeleteLabelRequest, SetLabelRequest
from chinilla.daemon.server import WebSocketServer, service_plotter
...
from chinilla.util.keychain import KeyData
from chinilla.daemon.keychain_server import GetKeyRequest, GetKeyResponse, GetKeysResponse
...
def mock_daemon_with_services():
    ...
    return Daemon(
        services={
            ...
            "chinilla_plotter": [Service(True), Service(True)],
        },
        connections={},
    )
