...
from chinilla.server.server import NodeType, ssl_context_for_client
...
class RpcClient:
    """
    Client to Chinilla RPC, connects to a local service. Uses HTTP/JSON, and converts back from
