...
sh install.sh -d
. ./activate
black . && isort benchmarks build_scripts chinilla tests tools *.py && mypy && flake8 benchmarks build_scripts chinilla tests tools *.py && pylint benchmarks build_scripts chinilla tests tools *.py
