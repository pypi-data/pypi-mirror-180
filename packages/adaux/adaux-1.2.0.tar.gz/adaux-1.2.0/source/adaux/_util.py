...
class ApiRequestCommunicator:
    ...
    def get_request(self, url: str, **kwgs: tp.Any) -> tp.Dict[str, tp.Any]:
        req = requests.get(url, headers=self.headers, timeout=1, **kwgs)
