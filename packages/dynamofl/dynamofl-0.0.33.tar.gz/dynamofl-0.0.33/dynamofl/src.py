...
class DynamoFL(_Base):
    ...
    def _on_message(self, ws, res):
        ...
        if j['event'] == 'project-complete':
            ...
            filepath = f'dynamic_trainers/{project_key}_{datasource_key}_{filename}'
    ...
    def train_and_test_callback(self, datasource_key, project_info):
        ...
        yes_stats = len(self._check_stats(project_key, datasource_key, prev_round))
        yes_submission = len(self._check_submissions(project_key, datasource_key, current_round))
