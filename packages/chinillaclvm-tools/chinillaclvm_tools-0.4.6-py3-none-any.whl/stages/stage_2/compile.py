...
from chinillaclvm_tools.binutils import disassemble
from chinillaclvm_tools.NodePath import LEFT, TOP
...
def do_com_prog(prog, macro_lookup, symbol_table, run_program):
    """
    Turn the given program `prog` into a chinillaclvm program using
