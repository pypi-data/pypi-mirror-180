...
def patch_build_ext(build_ext):
    # allow to use 'chinillaclvm_extensions' parameter for setup() call
    ...
    def has_ext_modules(self):
        return (
            ...
            or self.chinillaclvm_extensions
            and len(self.chinillaclvm_extensions) > 0
        )
    ...
    def finalize_options(self):
        ...
        if self.distribution.chinillaclvm_extensions:
            mods.extend(self.distribution.chinillaclvm_extensions)
