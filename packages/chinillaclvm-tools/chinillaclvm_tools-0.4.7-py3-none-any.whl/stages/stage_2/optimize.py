...
from chinillaclvm_tools.pattern_match import match
from chinillaclvm_tools.binutils import assemble

from chinillaclvm_tools.NodePath import NodePath, LEFT, RIGHT
...
def optimize_sexp(r, eval):
    """
    Optimize an s-expression R written for chinillaclvm to R_opt where
