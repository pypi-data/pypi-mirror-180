...
class BindToCodePipelineOptions:
    def __init__(self, *, artifact_bucket: aws_cdk.aws_s3.IBucket) -> None:
        ...
        '''
        if __debug__:
            def stub(*, artifact_bucket: aws_cdk.aws_s3.IBucket) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class GitHubEnterpriseSourceCredentialsProps:
    def __init__(self, *, access_token: aws_cdk.core.SecretValue) -> None:
        ...
        '''
        if __debug__:
            def stub(*, access_token: aws_cdk.core.SecretValue) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class _IArtifactsProxy:
    ...
    def bind(
        ...
        '''
        if __debug__:
            def stub(scope: aws_cdk.core.Construct, project: IProject) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
class _IProjectProxy(
    ...
    def add_to_role_policy(
        ...
        '''
        if __debug__:
            def stub(policy_statement: aws_cdk.aws_iam.PolicyStatement) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Source(
    ...
    def bind(
        ...
        '''
        if __debug__:
            def stub(_scope: aws_cdk.core.Construct, _project: IProject) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument _scope", value=_scope, expected_type=type_hints["_scope"])
