...
KEYMAPS = collections.defaultdict(
    lambda: {
        "BTN_LEFT": "🖱️ MOUSE-LEFT",
        "BTN_MIDDLE": "🖱️ MOUSE-MIDDLE",
        "BTN_RIGHT": "🖱️ MOUSE-RIGHT",
        "BTN_EXTRA": "🖱️ MOUSE-EXTRA",
        "BTN_SIDE": "🖱️ MOUSE-SIDE",
        "REL_WHEEL_UP": "🖱️ SCROLL-UP",
        "REL_WHEEL_DOWN": "🖱️ SCROLL-DOWN",
    }
)
...
def keymapargtype(value):
    try:
        if keymap := (KEYMAPS.get(value, KEYMAPS["default"])):
            return keymap
...
|  _|/ -_)| '_| '  \| / / -_)| || | '  \ / _ \| ' \| ||  _|/ _ \| '_|
 \__|\___||_| |_|_|_|_\_\___| \_, |_|_|_|\___/|_||_|_| \__|\___/|_|
                 ...
                 ⌨️  Show pressed keys in the terminal 📟
