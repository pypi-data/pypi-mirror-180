...
from tempgit.utils import get_git_parameters
...
class GitMonitor(object):
    ...
    def __init__(self, func: Callable,
                 folder: Union[str, PathLike, bytes],
                 repository: str,
                 branch: str = None,
                 force: bool = False,
                 interval: int = 0,
        ...
        :param key_file: The SSH key file. By default, the process will use the system default key file.
        ...
        self.__thread = None
        self.__event = Event()
        params = get_git_parameters(branch, key_file, single_branch, depth)
        self.repo = git.Repo(folder) if exists(folder) else git.Repo.clone_from(repository, folder, **params)
