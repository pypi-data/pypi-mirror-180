...
class PaylinkTokenStatusChangeRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, after, merchantid, *args, **kwargs):  # noqa: E501
        """PaylinkTokenStatusChangeRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            max_results (int): the maximum number of results between 5 and 250 to return. Default is 50.. [optional]  # noqa: E501
            next_token (str): the next token value when more results are available.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, after, merchantid, *args, **kwargs):  # noqa: E501
        """PaylinkTokenStatusChangeRequest - a model defined in OpenAPI
