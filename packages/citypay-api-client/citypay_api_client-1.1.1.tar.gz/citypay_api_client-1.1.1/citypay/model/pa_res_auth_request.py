...
class PaResAuthRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, md, pares, *args, **kwargs):  # noqa: E501
        """PaResAuthRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, md, pares, *args, **kwargs):  # noqa: E501
        """PaResAuthRequest - a model defined in OpenAPI
