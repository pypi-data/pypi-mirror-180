...
class OperationalFunctionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.acl_check_request_endpoint = _Endpoint(
            settings={
                'response_type': (AclCheckResponseModel,),
                'auth': [
                    'cp-api-key'
                ],
                'endpoint_path': '/v6/acl/check',
        ...
        self.domain_key_check_request_endpoint = _Endpoint(
            settings={
                'response_type': (DomainKeyResponse,),
                'auth': [
                    'cp-api-key'
                ],
                'endpoint_path': '/dk/check',
                'operation_id': 'domain_key_check_request',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.domain_key_gen_request_endpoint = _Endpoint(
            settings={
                'response_type': (DomainKeyResponse,),
                'auth': [
                    'cp-api-key'
                ],
                'endpoint_path': '/dk/gen',
                'operation_id': 'domain_key_gen_request',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.list_merchants_request_endpoint = _Endpoint(
            settings={
                'response_type': (ListMerchantsResponse,),
                'auth': [
                    'cp-api-key'
                ],
                'endpoint_path': '/v6/merchants/{clientid}',
        ...
        self.ping_request_endpoint = _Endpoint(
            settings={
    ...
    def acl_check_request(
        ...
        **kwargs
        ...
        kwargs['acl_check_request'] = \
            acl_check_request
        return self.acl_check_request_endpoint.call_with_http_info(**kwargs)
    ...
    def domain_key_check_request(
        ...
        **kwargs
        ...
        Checks the contents of a `domain key`. Can be used for operational processes to ensure that the properties of a  domain key meet their expectations.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.domain_key_check_request(domain_key_check_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['domain_key_check_request'] = \
            domain_key_check_request
        return self.domain_key_check_request_endpoint.call_with_http_info(**kwargs)
    ...
    def domain_key_gen_request(
        ...
        **kwargs
        ...
        Generates a domain key based on the permissions of the calling `api-key`. Domain keys can be used in _Direct Post_ and `XHR` calls to the API services.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.domain_key_gen_request(domain_key_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        kwargs['domain_key_request'] = \
            domain_key_request
        return self.domain_key_gen_request_endpoint.call_with_http_info(**kwargs)
    ...
    def list_merchants_request(
        ...
        **kwargs
        ...
        kwargs['clientid'] = \
            clientid
        return self.list_merchants_request_endpoint.call_with_http_info(**kwargs)
    ...
    def ping_request(
        ...
        **kwargs
        ...
        kwargs['ping'] = \
            ping
        return self.ping_request_endpoint.call_with_http_info(**kwargs)
