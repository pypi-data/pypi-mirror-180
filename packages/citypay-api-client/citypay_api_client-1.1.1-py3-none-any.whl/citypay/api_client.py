...
from citypay.exceptions import ApiTypeError, ApiValueError, ApiException
from citypay.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = "CityPayAPI/Python/1.1.1" 
        self.default_headers["cp-sdk"] = "CP_API_PY/1.1.1" 
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AuthorisationAndPaymentApi()
        api_instance.authorisation_request  # this is an instance of the class Endpoint
        api_instance.authorisation_request()  # this invokes api_instance.authorisation_request.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.authorisation_request.callable or self.callable in this class
