...
class CaptureRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, merchantid, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            amount (int): The completion amount provided in the lowest unit of currency for the specific currency of the merchant, with a variable length to a maximum of 12 digits. No decimal points to be included. For example with GBP 75.45 use the value 7545. Please check that you do not supply divisional characters such as 1,024 in the request which may be caused by some number formatters.  If no amount is supplied, the original processing amount is used. . [optional]  # noqa: E501
            event_management (EventDataModel): [optional]  # noqa: E501
            identifier (str): The identifier of the transaction to capture. If an empty value is supplied then a `trans_no` value must be supplied.. [optional]  # noqa: E501
            transno (int): The transaction number of the transaction to look up and capture. If an empty value is supplied then an identifier value must be supplied.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, merchantid, *args, **kwargs):  # noqa: E501
        """CaptureRequest - a model defined in OpenAPI
