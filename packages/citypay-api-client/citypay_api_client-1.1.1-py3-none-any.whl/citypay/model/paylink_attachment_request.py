...
class PaylinkAttachmentRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, filename, mime_type, *args, **kwargs):  # noqa: E501
        """PaylinkAttachmentRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, filename, mime_type, *args, **kwargs):  # noqa: E501
        """PaylinkAttachmentRequest - a model defined in OpenAPI
