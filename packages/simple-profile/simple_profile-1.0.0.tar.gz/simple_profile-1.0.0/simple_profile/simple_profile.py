...
def get_memory_usage(function, *args, **kwargs) -> tuple[int, int]:
    tracemalloc.start()
...
def get_peak_memory_usage(function, *args, **kwargs) -> int:
    memory_usage = get_memory_usage(function, *args, **kwargs)
...
def memory_profile(
    ...
    def decorator(function):
        def wrapper(*args, **kwargs):
            peak_memory_usage = get_peak_memory_usage(function, *args, **kwargs)
