...
if TYPE_CHECKING:
    ...
    from ._response import ContribResponse
...
def contribute(
    ...
    *,
    ...
    offstream.open()
    response = offstream.contribute(fields=fields, contrib_type=contrib_type)
    offstream.close()
    return response
...
async def contribute_async(
    ...
    *,
    ...
    response = await offstream.contribute_async(
        fields=fields, contrib_type=contrib_type
    )
    offstream.close()
    return response
