...
def load_tf_weights_in_bert(model, config, tf_checkpoint_path): # pragma: no cover
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if layer_output_length:
                ...
                restored_hidden_states = restored_hidden_states.scatter(1, remain_indices.unsqueeze(-1).expand( \
                                                                        -1, -1, dim), hidden_states)
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        if attention_mask is None: # pragma: no cover
