...
from validation.rendering import create_res_html
            ...
            if value != 0:
                ...
                if sample.shape[0] != 0:
                    ...
                    if value < q1 or value > q99:
                        ...
                        dist_dict[key] = {'Line':line, 'color':color, 'Hight':counts, 'Bins':bins}
                    else:
                        df_stat.loc[j,'Работа'] = c
            ...
            if df_wind_model.loc[i,c] != 0:
                ...
                if sample.shape[0] > 20:
                    ...
                    if value < q1 or value > q99:
                        ...
                        color = 'red'
                        dict_fig[key] = {'Blue points':blue_points, 'Black points':black_points, 'Star':star, 'Color':color}
                    else:
                        df_stat.loc[j,'Работа'] = c
...
def get_statistic_for_properties_and_all_stat(norm_res, norm_ved, norm_volume, norm_time, norm_seq):
    result_dict = dict()
