...
from validation.aggregator import get_all_seq_statistic, get_res_ved_stat
from validation.dataset_wrapper import get_work_pulls, get_validation_dataset, create_model_dataset
from validation.validator import validate_resources, validate_works_vol, validate_time, get_statistic_for_properties_and_all_stat, get_plan_statistic
import json
import pandas as pd
...
class Validator:
    ...
    def validate(self, plan_path):
        ...
        if not self.valdataset:
            ...
            #validation_dataset.to_csv('val_datasets/'+f+'/validation_dataset.csv')
        else:
        ...
        work_res_common_perc = get_statistic_for_properties_and_all_stat(norm_perc_res, norm_perc_vedom, norm_volume_perc, norm_time_perc,  norm_perc_seq)
