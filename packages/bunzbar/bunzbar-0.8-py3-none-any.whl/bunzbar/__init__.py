#!/usr/bin/python3
import time, json, argparse, os, tsv_calendar
from sh import xprop, acpi
from bunzbar.infos import infos
...
TSVFILE = os.path.join(os.path.expanduser('~'), '.config/bunzbar/config,json')
