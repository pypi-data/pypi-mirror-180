...
class FeatureWeightsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_column_weights_endpoint = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/v0/organizations/{org_id}/dataset/{dataset_id}/weights',
                'operation_id': 'get_column_weights',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.put_column_weights_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/v0/organizations/{org_id}/dataset/{dataset_id}/weights',
                'operation_id': 'put_column_weights',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def get_column_weights(
        ...
        **kwargs
        ...
        """Get column weights for the specified dataset  # noqa: E501

        Get column weights for the specified dataset  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_column_weights(org_id, dataset_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['dataset_id'] = \
            dataset_id
        return self.get_column_weights_endpoint.call_with_http_info(**kwargs)

    def put_column_weights(
        self,
        org_id,
        dataset_id,
        body,
