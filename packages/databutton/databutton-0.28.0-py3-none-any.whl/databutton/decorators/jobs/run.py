...
def run_soon(job_id: str, trigger: str = "code"):
    # TODO: Introduce a DATABUTTON_COMPONENT_ID env var to figure out if we're called from app or job or perhaps locally? # noqa
    ...
    databutton_release = os.environ.get("DATABUTTON_RELEASE", None)
    if databutton_release:
        headers["x-databutton-release"] = databutton_release
