...
def dummy_sent(obj: ProviderBase, recipient: Actor, message: Union[str, Any], result: Any, task: asyncio.AbstractEventLoop, **kwargs): # pylint: disable=W0613
    print('RECEIVED ', obj, 'REC: ', recipient, 'MSG: ', message, 'RESULT: ', result, task, 'OT: ', kwargs)
