...
def dummy_sent(recipient: Actor, message: Union[str, Any], result: Any, task: asyncio.AbstractEventLoop, **kwargs): # pylint: disable=W0613
    print('RECEIVED ', 'REC: ', recipient, 'MSG: ', message, 'RESULT: ', result, 'OT: ', kwargs)
