...
class GenericControllerClass:
    ...
    def handleProcessMember(self, connect_db_output, source, source_by_create_date, source_detail_by_create_date, source_data_no_detail, model_report, model_summary, flag_data, sql_data, data_cluster_representative, data_explore_cluster, generic):
        self.controller_app["member"].processMember(connect_db_output, source, source_by_create_date, source_detail_by_create_date, source_data_no_detail, model_report, model_summary, flag_data, sql_data, data_cluster_representative, data_explore_cluster, generic)

    def handleProcessSummary(self, connect_db_output, source, source_by_create_date, source_detail_by_create_date, model_report, model_summary, flag_data, sql_data, data_cluster_representative, generic):
        self.controller_app["summary"].processSummary(connect_db_output, source, source_by_create_date, source_detail_by_create_date, model_report, model_summary, flag_data, sql_data, data_cluster_representative, generic)

    def handleProcessReport(self, source, model_report, flag_data, sql_data, data_cluster_representative, generic):
        return self.controller_app["report"].processReport(source, model_report, flag_data, sql_data, data_cluster_representative, generic)
