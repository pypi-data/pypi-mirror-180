...
DEPLOY_PATTERN_NONE = 0
DEPLOY_PATTERN_DEV_PROD = 1
DEPLOY_PATTERN_DEV_UAT_PROD = 2

DEPLOY_PATTERN_RIGHTS_RESTRICTIONS = [
...
class BaseUtahInititializer():
    ...
    def __init__(self, src_repo_loc:str, deployment_pattern=DEPLOY_PATTERN_NONE):
        self.src_repo_loc = src_repo_loc
        self.right_env_filter_data = {}

        for deploy_pattern_rights_restriction in DEPLOY_PATTERN_RIGHTS_RESTRICTIONS:
            right_category, right_name_pattern,env_restriction_options = deploy_pattern_rights_restriction
            self.right_env_filter_data[(right_category, right_name_pattern)] = env_restriction_options[deployment_pattern]
