...
use crate::{
    deep_map_fallible_pre_new_children, prelude::*, Add, Concat, Cumulant, Einsum, GeneralFunction,
    Index, Module, ModuleArgSpec, ModuleSpec, Rearrange, Scatter, SetSymbolicShape, Symbol, Tag,
};
...
pub struct ReplaceMapRc {
    replace_map: Arc<HashMap<CircuitRc, CircuitRc>>,
    hash: HashBytes,
}
...
impl Deref for ReplaceMapRc {
    type Target = HashMap<CircuitRc, CircuitRc>;
...
impl ReplaceMapRc {
    pub fn new(replace_map: HashMap<CircuitRc, CircuitRc>) -> Self {
