...
use crate::{
    ...
    circuit_node_private::{
        CircuitNodeComputeInfoImpl, CircuitNodeHashItems, CircuitNodeMaybeAutoName,
    },
    new_rc,
    prelude::*,
...
impl CircuitNodeMaybeAutoName for Array {}
impl CircuitNodeMaybeAutoName for Scalar {}
impl CircuitNodeMaybeAutoName for Symbol {}
