...
def all_free(circuit: Circuit) -> List[Symbol]: ...
...
class ModuleSpec(object):
    ...
    def __init__(
        ...
        check_all_args_present: bool = True,
        check_unique_arg_names: bool = True,
    ) -> None: ...
    def check_all_args_present(self) -> None: ...
    def check_unique_arg_names(self) -> None: ...
    def map_circuit(self, f: Callable[[Circuit], Circuit]) -> ModuleSpec: ...
    @staticmethod
    def new_all_free(circuit: Circuit, check_unique_arg_names: bool = True) -> ModuleSpec: ...
    @staticmethod
    def new_extract(
        circuit: Circuit,
...
class PrintOptions(object):
    ...
    def __init__(
        ...
        arrows: bool = False,
        print_size_threshold: Optional[int] = None,
    ...
    def evolve(
        ...
        print_size_threshold: Union[Optional[int], NotSet] = NOT_SET,
        ...
        commenters: Union[List[Callable[[Circuit], str]], NotSet] = NOT_SET,
...
class PrintHtmlOptions(object):
    ...
    def evolve(
        ...
        use_serial_numbers: Union[bool, NotSet] = NOT_SET,
        number_leaves: Union[bool, NotSet] = NOT_SET,
...
class Parser:
    ...
    def __init__(
        ...
        module_check_all_args_present: bool = True,
...
class SubstitutionBindsSameSymbolToDifferentValueThanNestedModuleError(SubstitutionError): ...
class SubstitutionCircuitHasFreeSymBoundByNestedModuleError(SubstitutionError): ...
class SubstitutionBindsEquivalentSymbolsToDifferentNodesError(SubstitutionError): ...
...
class ExtractSymbolsHasBindingFromOuterModuleError(ExtractSymbolsError): ...
...
class Matcher(object):
    ...
    def chain(
        ...
        *rest: IterativeMatcherIn,
        ...
        A node is considered matched if the chain has a length 1 containing a
...
class IterativeMatcher:
    ...
    @staticmethod
    def new_chain(first: IterativeMatcherIn, *matchers: IterativeMatcherIn) -> IterativeMatcher:
        """
        ...
        """
    @staticmethod
    def new_chain_many(*matchers: Sequence[IterativeMatcherIn]) -> IterativeMatcher:
...
NestedModuleNamer = Callable[[Circuit, Circuit, List[Module]], Optional[str]]
"""
Args: base_circuit, running_circuit, modules
...
def default_nested_module_namer() -> NestedModuleNamer: ...

class ModulePusher:
    @property
    def flatten_modules(self) -> bool: ...
    @property
    def remove_unused_inputs(self) -> bool: ...
    @property
    def elim_no_input_modules(self) -> bool: ...
    @property
    ...
    def __init__(
        ...
        elim_no_input_modules: bool = True,
...
def extract_symbols(
    circuit: Circuit, symbols: Set[Symbol], use_elim_no_input_module: bool = True, conform_batch_if_needed: bool = True
) -> Module: ...
...
def module_remove_unused_inputs(m: Module, use_elim_no_input_module: bool = True) -> Circuit: ...
def deep_module_remove_unused_inputs(circuit: Circuit, use_elim_no_input_module: bool = True) -> Circuit: ...
