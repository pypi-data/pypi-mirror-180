...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AccountCreationApi()
        api_instance.create_order  # this is an instance of the class Endpoint
        api_instance.create_order()  # this invokes api_instance.create_order.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_order.callable or self.callable in this class
