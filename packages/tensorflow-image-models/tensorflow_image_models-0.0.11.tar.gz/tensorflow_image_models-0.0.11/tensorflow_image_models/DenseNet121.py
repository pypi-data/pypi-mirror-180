...
class DenseNet121Class(tf.keras.models.Model):
    def __init__(self, classes=10):
        super(DenseNet121Class, self).__init__()
...
def DenseNet121(classes=10,input_shape=(128, 128, 3)):
    inputs = tf.keras.layers.Input(shape=input_shape)
    x = DenseNet121Class(classes=classes)(inputs)
