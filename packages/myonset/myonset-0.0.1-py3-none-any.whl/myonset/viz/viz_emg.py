...
#        self.w = QtGui.QWidget()
        ...
        self.btn_delete_mrk = QtGui.QPushButton('Delete epoch markers (d)')
        self.btn_delete_mrk.clicked.connect(self.delete_movable)
        self.btn_save_events = QtGui.QPushButton('Save events')
...
#        config_widget = QtGui.QWidget()
        ...
        label_time_range= QtGui.QLabel('Set new time range:', alignment = QtCore.Qt.AlignCenter)
