...
class CacheControl(
    ...
    def max_age(cls, t: aws_cdk.core.Duration) -> "CacheControl":
        ...
        '''
        if __debug__:
            def stub(t: aws_cdk.core.Duration) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class ManualApprovalAction(
    ...
    def grant_manual_approval(self, grantable: aws_cdk.aws_iam.IGrantable) -> None:
        ...
        '''
        if __debug__:
            def stub(grantable: aws_cdk.aws_iam.IGrantable) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class StackSetParameters(
    ...
    def from_artifact_path(
        ...
        '''
        if __debug__:
            def stub(artifact_path: aws_cdk.aws_codepipeline.ArtifactPath) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument artifact_path", value=artifact_path, expected_type=type_hints["artifact_path"])
...
class StateMachineInput(
    ...
    def file_path(
        ...
        '''
        if __debug__:
            def stub(input_file: aws_cdk.aws_codepipeline.ArtifactPath) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
