...
from proxycurl_py_test.asyncio.base import ProxycurlBase
...
class _LinkedinCompany:
    ...
    async def role_lookup(
        ...
        :type role: str
        :return: An object of Awaitable[:class:`proxycurl.models.RoleSearchResult]` or **None** if there is an error.
        :rtype: Awaitable[:class:`proxycurl.models.RoleSearchResult]`
        :raise ProxycurlException: Every error will raise a :class:`proxycurl.asyncio.ProxycurlException`
