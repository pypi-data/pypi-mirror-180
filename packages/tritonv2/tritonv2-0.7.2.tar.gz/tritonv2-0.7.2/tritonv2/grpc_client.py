...
class TritonGRPCClient(TritonClient):
    ...
    def model_meta(self, model_name, model_version="1"):
        """
        get model meta
        :param model_name:
        :param model_version:
    ...
    def model_config(self, model_name, model_version="1"):
        """
       get model config
       :param model_name:
       :param model_version:
    ...
    def model_ready(self, model_name, model_version="1"):
        """
        check model ready
        :param model_name:
        :param model_version:
    ...
    def model_statistics(self, model_name, model_version="1", headers=None):
        """
