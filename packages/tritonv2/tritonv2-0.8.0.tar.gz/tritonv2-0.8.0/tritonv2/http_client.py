...
class TritonHTTPClient(TritonClient):
    ...
    @retry(stop=(stop_after_attempt(NUMBER_RETRIES + 1) | stop_after_delay(MAX_INTERVAL_SECS)),
           wait=wait_fixed(BASE_INTERVAL_SECS), reraise=True)
    def model_ready(self, model_name, model_version="1", headers=None, query_params=None):
        """
    ...
    @retry(stop=(stop_after_attempt(NUMBER_RETRIES + 1) | stop_after_delay(MAX_INTERVAL_SECS)),
           wait=wait_fixed(BASE_INTERVAL_SECS), reraise=True)
    def model_meta(self, model_name, model_version="1", headers=None, query_params=None):
        """
        get model meta
        Parameters
        :param model_name:
    ...
    @retry(stop=(stop_after_attempt(NUMBER_RETRIES + 1) | stop_after_delay(MAX_INTERVAL_SECS)),
           wait=wait_fixed(BASE_INTERVAL_SECS), reraise=True)
    def model_config(self, model_name, model_version="1", headers=None, query_params=None):
        """
        get model config
        Parameters
        :param model_name:
    ...
    @retry(stop=(stop_after_attempt(NUMBER_RETRIES + 1) | stop_after_delay(MAX_INTERVAL_SECS)),
           wait=wait_fixed(BASE_INTERVAL_SECS), reraise=True)
    def model_statistics(self, model_name, model_version="1", headers=None, query_params=None):
        """
