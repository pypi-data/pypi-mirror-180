...
def register_user_as_customer():
    ...
    try:
        if is_not_empty(reference_code):
            ...
            merchant_act_key        = request.headers.get('x-merchant-acct-key')
            merchant_acct           = None
            ...
            with db_client.context():
                ...
                if merchant_acct and outlet:
                    ...
                    if merchant_acct.key_in_str == outlet.merchant_acct_key: 
                        ...
                        created_customer = Customer.get_by_reference_code(reference_code)
                        ...
                        if created_customer is None:
                            ...
                            if is_email_used == False and is_mobile_phone_used == False:
                                ...
                                created_customer = Customer.create_from_user(merchant_acct, outlet, existing_user_acct, merchant_reference_code=merchant_reference_code)
                ...
                if created_customer:
                    ...
                    response_data = {
                                    ...
                                    'company_name'              : merchant_acct.name,
