...
class __RepairConfigSerDer__:
    ...
    def parseInternal(self, value, instance):
        ...
        instance.opIdentifiers = serder.SetSerDer(serder.STRING).parse(opIdentifiersValue)
        dryValue = value['dry']
    ...
    def encodeInternal(self, value, instance):
        ...
        opIdentifiersValue = value.opIdentifiers
        instance["opIdentifiers"] = serder.SetSerDer(serder.STRING).encode(opIdentifiersValue)
        dryValue = value.dry
