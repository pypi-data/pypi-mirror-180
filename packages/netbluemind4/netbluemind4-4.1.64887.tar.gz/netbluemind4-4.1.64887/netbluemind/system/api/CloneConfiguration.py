...
class __CloneConfigurationSerDer__:
    ...
    def parseInternal(self, value, instance):
        ...
        instance.targetInstallationId = serder.STRING.parse(targetInstallationIdValue)
        ...
        instance.skippedContainerTypes = serder.SetSerDer(serder.STRING).parse(skippedContainerTypesValue)
        return instance
    ...
    def encodeInternal(self, value, instance):
        ...
        targetInstallationIdValue = value.targetInstallationId
        instance["targetInstallationId"] = serder.STRING.encode(targetInstallationIdValue)
        uidToIpMappingValue = value.uidToIpMapping
        ...
        skippedContainerTypesValue = value.skippedContainerTypes
        instance["skippedContainerTypes"] = serder.SetSerDer(serder.STRING).encode(skippedContainerTypesValue)
        return instance
