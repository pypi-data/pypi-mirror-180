...
class ImportMailboxConversationSet :
    def __init__( self):
...
class __ImportMailboxConversationSetSerDer__:
    def __init__( self ):
        pass
    ...
    def parse(self, value):
        if(value == None):
            return None
        instance = ImportMailboxConversationSet()
    ...
    def parseInternal(self, value, instance):
        ...
        instance.conversationUids = serder.ListSerDer(serder.STRING).parse(conversationUidsValue)
    ...
    def encodeInternal(self, value, instance):
        ...
        conversationUidsValue = value.conversationUids
        instance["conversationUids"] = serder.ListSerDer(serder.STRING).encode(conversationUidsValue)
        deleteFromSourceValue = value.deleteFromSource
