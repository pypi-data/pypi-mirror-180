...
class VNotesQuery :
    def __init__( self):
        ...
        self.vnoteQuery = None
        pass

class __VNotesQuerySerDer__:
    def __init__( self ):
        pass
    ...
    def parseInternal(self, value, instance):
        ...
        vnoteQueryValue = value['vnoteQuery']
        instance.vnoteQuery = __VNoteQuerySerDer__().parse(vnoteQueryValue)
        return instance
    ...
    def encodeInternal(self, value, instance):
        ...
        from netbluemind.notes.api.VNoteQuery import __VNoteQuerySerDer__
        vnoteQueryValue = value.vnoteQuery
        instance["vnoteQuery"] = __VNoteQuerySerDer__().encode(vnoteQueryValue)
        return instance
