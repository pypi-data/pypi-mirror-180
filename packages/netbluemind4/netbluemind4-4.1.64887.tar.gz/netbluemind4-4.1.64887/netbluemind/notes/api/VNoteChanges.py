...
class __VNoteChangesSerDer__:
    ...
    def parseInternal(self, value, instance):
        ...
        addValue = value['add']
        instance.add = serder.ListSerDer(__VNoteChangesItemAddSerDer__()).parse(addValue)
        ...
        instance.modify = serder.ListSerDer(__VNoteChangesItemModifySerDer__()).parse(modifyValue)
        ...
        instance.delete = serder.ListSerDer(__VNoteChangesItemDeleteSerDer__()).parse(deleteValue)
        return instance
    ...
    def encodeInternal(self, value, instance):
        ...
        from netbluemind.notes.api.VNoteChangesItemAdd import __VNoteChangesItemAddSerDer__
        addValue = value.add
        instance["add"] = serder.ListSerDer(__VNoteChangesItemAddSerDer__()).encode(addValue)
        from netbluemind.notes.api.VNoteChangesItemModify import VNoteChangesItemModify
        from netbluemind.notes.api.VNoteChangesItemModify import __VNoteChangesItemModifySerDer__
        modifyValue = value.modify
        instance["modify"] = serder.ListSerDer(__VNoteChangesItemModifySerDer__()).encode(modifyValue)
        from netbluemind.notes.api.VNoteChangesItemDelete import VNoteChangesItemDelete
        from netbluemind.notes.api.VNoteChangesItemDelete import __VNoteChangesItemDeleteSerDer__
        deleteValue = value.delete
        instance["delete"] = serder.ListSerDer(__VNoteChangesItemDeleteSerDer__()).encode(deleteValue)
        return instance
