...
class CfnResourcePolicy(
    ...
    def __init__(
        ...
        *,
        ...
        bypass_policy_lockout_check: typing.Optional[typing.Union[builtins.bool, aws_cdk.core.IResolvable]] = None,
    ) -> None:
    ...
    def bypass_policy_lockout_check(
        ...
        '''
        return typing.cast(typing.Optional[typing.Union[builtins.bool, aws_cdk.core.IResolvable]], jsii.get(self, "bypassPolicyLockoutCheck"))
