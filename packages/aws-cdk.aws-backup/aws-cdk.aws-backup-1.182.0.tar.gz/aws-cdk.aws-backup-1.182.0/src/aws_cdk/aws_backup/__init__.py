...
class BackupResource(
    ...
    def from_dynamo_db_table(
        ...
        '''
        if __debug__:
            def stub(table: aws_cdk.aws_dynamodb.ITable) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_ec2_instance(cls, instance: aws_cdk.aws_ec2.IInstance) -> "BackupResource":
        ...
        '''
        if __debug__:
            def stub(instance: aws_cdk.aws_ec2.IInstance) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_efs_file_system(
        ...
        '''
        if __debug__:
            def stub(file_system: aws_cdk.aws_efs.IFileSystem) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def from_rds_database_instance(
        ...
        '''
        if __debug__:
            def stub(instance: aws_cdk.aws_rds.IDatabaseInstance) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument instance", value=instance, expected_type=type_hints["instance"])
