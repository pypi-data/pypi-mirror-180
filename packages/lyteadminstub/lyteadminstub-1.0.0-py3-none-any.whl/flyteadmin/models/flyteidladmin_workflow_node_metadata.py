...
class FlyteidladminWorkflowNodeMetadata(object):
    ...
    def __init__(self, execution_id=None):  # noqa: E501
        """FlyteidladminWorkflowNodeMetadata - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FlyteidladminWorkflowNodeMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FlyteidladminWorkflowNodeMetadata):
            return False
