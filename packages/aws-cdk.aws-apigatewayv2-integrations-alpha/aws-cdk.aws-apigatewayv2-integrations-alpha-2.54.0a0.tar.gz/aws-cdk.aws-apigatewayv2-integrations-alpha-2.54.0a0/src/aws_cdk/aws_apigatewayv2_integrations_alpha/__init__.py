...
class HttpAlbIntegration(
    ...
    def _connection_type(
        ...
        if __debug__:
            def stub(value: aws_cdk.aws_apigatewayv2_alpha.HttpConnectionType) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def _http_method(self, value: aws_cdk.aws_apigatewayv2_alpha.HttpMethod) -> None:
        if __debug__:
            def stub(value: aws_cdk.aws_apigatewayv2_alpha.HttpMethod) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _integration_type(
        ...
        if __debug__:
            def stub(value: aws_cdk.aws_apigatewayv2_alpha.HttpIntegrationType) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
