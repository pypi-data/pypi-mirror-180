...
class ValidateDestinationDirectory(Validator):
    def run(self, _):
        ...
        3. Do we specify an asset folder that contains the destination folder? Error if so.
        """
        dest_context = context.destination_context(self._submitter)
