...
class CdkPipeline(
    ...
    def stack_output(self, cfn_output: aws_cdk.core.CfnOutput) -> "StackOutput":
        ...
        '''
        if __debug__:
            def stub(cfn_output: aws_cdk.core.CfnOutput) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class CdkStage(
    ...
    def add_actions(self, *actions: aws_cdk.aws_codepipeline.IAction) -> None:
        ...
        '''
        if __debug__:
            def stub(*actions: aws_cdk.aws_codepipeline.IAction) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class StackOutputReference(
    ...
    def from_cfn_output(cls, output: aws_cdk.core.CfnOutput) -> "StackOutputReference":
        ...
        '''
        if __debug__:
            def stub(output: aws_cdk.core.CfnOutput) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument output", value=output, expected_type=type_hints["output"])
...
class CodePipelineFileSet(
    ...
    def from_artifact(
        ...
        '''
        if __debug__:
            def stub(artifact: aws_cdk.aws_codepipeline.Artifact) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument artifact", value=artifact, expected_type=type_hints["artifact"])
