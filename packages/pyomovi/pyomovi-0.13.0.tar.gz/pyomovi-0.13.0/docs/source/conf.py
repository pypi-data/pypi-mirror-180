...
# -*- coding: utf-8 -*-
#
# pyomovi documentation build configuration file
#
...
project = 'pyomovi'
copyright = '2022, Anders Hafreager'
...
_version_py = os.path.join(repo, 'pyomovi', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'pyomovi.tex', 'pyomovi Documentation',
     'Anders Hafreager', 'manual'),
]
