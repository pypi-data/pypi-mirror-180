    ...
    class DashPackageProperty:
        def __init__(
            ...
            *,
            ...
            :param encryption: Parameters for encrypting content.
            :param include_iframe_only_stream: Only applies to stream sets with a single video track. When true, the stream set includes an additional I-frame trick-play only stream, along with the other tracks. If false, this extra stream is not included.
    ...
    class HlsPackageProperty:
        def __init__(
            ...
            *,
            ...
            include_dvb_subtitles: typing.Optional[typing.Union[builtins.bool, aws_cdk.core.IResolvable]] = None,
            include_iframe_only_stream: typing.Optional[typing.Union[builtins.bool, aws_cdk.core.IResolvable]] = None,
            playlist_type: typing.Optional[builtins.str] = None,
            playlist_window_seconds: typing.Optional[jsii.Number] = None,
            program_date_time_interval_seconds: typing.Optional[jsii.Number] = None,
    ...
    class SpekeKeyProviderProperty:
        def __init__(
            ...
            *,
            ...
            system_ids: typing.Sequence[builtins.str],
            url: builtins.str,
            encryption_contract_configuration: typing.Optional[typing.Union[aws_cdk.core.IResolvable, typing.Union["CfnPackagingConfiguration.EncryptionContractConfigurationProperty", typing.Dict[str, typing.Any]]]] = None,
        ) -> None:
        ...
        def encryption_contract_configuration(
            self,
        ) -> typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPackagingConfiguration.EncryptionContractConfigurationProperty"]]:
            '''Use ``encryptionContractConfiguration`` to configure one or more content encryption keys for your endpoints that use SPEKE Version 2.0. The encryption contract defines which content keys are used to encrypt the audio and video tracks in your stream. To configure the encryption contract, specify which audio and video encryption presets to use.
            ...
            '''
            result = self._values.get("encryption_contract_configuration")
            return typing.cast(typing.Optional[typing.Union[aws_cdk.core.IResolvable, "CfnPackagingConfiguration.EncryptionContractConfigurationProperty"]], result)
