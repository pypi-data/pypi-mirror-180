...
class Aggregation(object):
    ...
    def _to_proto(self, aggregation_interval: duration_pb2.Duration, is_continuous: bool):
        ...
        if self.name:
            ...
            # function is only used to build the aggregation output column name.
            function = proto.function
            if proto.function == "lastn":
                function = f"last_distinct_{proto.function_params['n'].int64_value}"
            elif proto.function == "last_non_distinct_n":
                function = f"last_{proto.function_params['n'].int64_value}"
    ...
    def __init__(
        ...
        **Do not directly use this constructor.** Internal constructor for materialized FeatureViews.
        ...
        if aggregations:
            ...
            args.materialized_feature_view_args.aggregations.extend(
                [
                    agg._to_proto(args.materialized_feature_view_args.aggregation_interval, is_continuous)
