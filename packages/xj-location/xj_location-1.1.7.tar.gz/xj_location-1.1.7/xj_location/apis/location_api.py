...
class LocationAPI(APIView):
    def list(self, **kwargs):
        ...
        need_pagination = eval(params.pop("need_pagination", "True"))
        filter_fields = params.pop("filter_fields", "")
        filter_fields = [i for i in filter_fields.split(",") if i]
        print(filter_fields)
        ...
        data, err = LocationService.location_list(params, need_pagination=need_pagination, fields=filter_fields)
        if err:
