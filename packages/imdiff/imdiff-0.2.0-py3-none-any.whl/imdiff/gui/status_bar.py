...
class StatusBar(ttk.Frame):
    def __init__(self, parent):
        ...
        self.label_left_file = ttk.Entry(self, textvariable=self.left_file, justify=tk.LEFT, state='readonly')

        self.right_file = tk.StringVar()
        self.label_right_file = ttk.Entry(self, textvariable=self.right_file, justify=tk.LEFT, state='readonly')

        self.frame_diff_status = ttk.Frame(self, relief=tk.RIDGE, borderwidth=2, style='White.TFrame')
        self.label_diff_status = tk.Text(
            self.frame_diff_status, width=20, height=2, borderwidth=0, highlightthickness=0, relief=tk.SOLID)
