...
class OracleBookkeepingDB:
    ...
    def __init__(self):
        ...
        dbConfDir = gConfig.getValue(self.cs_path + "/LHCbDIRACBookkeepingConfDir", "")

        dbMode = gConfig.getValue(self.cs_path + "/LHCbDIRACBookkeepingMode", "")

        self.dbW_ = OracleDB(self.dbServer, self.dbPass, self.dbHost, dbConfDir, dbMode)
        self.dbR_ = OracleDB(self.dbUser, self.dbPass, self.dbHost, dbConfDir, dbMode)
