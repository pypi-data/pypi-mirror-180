...
class MultiplyEgo(BaseMultiplyEgo):
    ...
    -----------
        ...
        >>> me = multilplyEgo([svr, gpr], searchspace, X, y, 500, n_jobs=8)
    ...
    def __init__(self, regclf, searchspace, X, y, number=1000, feature_slice=None, n_jobs=2, up=True, strategy="mean"):
        """
