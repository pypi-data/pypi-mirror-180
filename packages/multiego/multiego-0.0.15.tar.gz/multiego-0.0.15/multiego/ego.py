...
class Ego(BaseEgo):
    ...
    def __init__(self, regclf=None, searchspace=None, X=None, y=None, number=500, n_jobs=2, sign=1):
        """
        ...
        n_jobs: int
            Parallelize number.
        sign: int
            max problem is 1, and min problem is 0.
        """
        super(Ego, self).__init__(sign=sign)
