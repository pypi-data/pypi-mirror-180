    ...
    def to_json(self):
        ...
        for section in self.get_sections():
            ...
            for key in self.config[section]:
                result[section][key] = self.decrypt(self.config[section][key])
...
class LinuxConfigParser(ConfigurationUtils):
    def __init__(self, password, configuration_file = 'study_breaks.ini', configuration_folder = '/usr/code/config/'):
