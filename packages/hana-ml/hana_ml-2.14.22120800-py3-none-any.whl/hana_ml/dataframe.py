...
class ConnectionContext(object):
    ...
    def copy_to_data_lake(self, data, virtual_table, data_lake_table, schema=None, append=False, data_lake_container='SYSRDL#CG'):
        """
        Copy HANA data to a data lake table.
    ...
    def hana_version(self):
        """
        Returns the version of SAP HANA database instance.
    ...
    def cancel_session_process(self, connection_id=None):
        """
        This function will cancel the current process in the given session. If the connection_id is not provided, it will use the current connection.
    ...
    def restart_session(self, connection_id=None):
        """
        This function will terminate the current session, drop all the temporary tables and start a new one.
    ...
    def clean_up_temporary_tables(self):
        """
        Drop all the temporary table under the current schema.
        """
        connection_id = self.get_connection_id()
...
class DataFrame(object):#pylint: disable=too-many-public-methods
    ...
    def replace(self, to_replace=None, value=None, regex=False):
        ...
        to_replace : numeric, str or dict, optional
            ...
            - dict:
                ...
                - `value` is numeric or str: the value equal to the value of `to_replace` will be replaced by `value`.
                  The to-be-replaced columns will be restricted by the keys of `to_replace`.
                - `value` is dict: the value equal to the value of `to_replace` will be replaced by the value of `value` under the same key.
                  The to-be-replaced columns and the replaced value will be restricted by the keys of `to_replace` and `value`.
            - None:
                `regex` will be used.
    ...
    def min(self):
        """
        Get the minimum value of the columns. It simplifies the use of agg function.
    ...
    def max(self):
        """
        Get the maximum value of the columns. It simplifies the use of agg function.
    ...
    def sum(self):
        """
        Get the summation of the columns. It simplifies the use of agg function.
    ...
    def median(self):
        """
        Get the median value of the columns. It simplifies the use of agg function.
    ...
    def mean(self):
        """
        Get the mean value of the columns. It simplifies the use of agg function.
    ...
    def stddev(self):
        """
        Get the stddev value of the columns. It simplifies the use of agg function.
    ...
    def value_counts(self, subset=None):
        """
        Get the value counts of the columns. It simplifies the use of agg function.
    ...
    def generate_feature(self,
        ...
        agg_func : str, optional
            HANA aggregration operations. SUM, COUNT, MIN, MAX, ...
