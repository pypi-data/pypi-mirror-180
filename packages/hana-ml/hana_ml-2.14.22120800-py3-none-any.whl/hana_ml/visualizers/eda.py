...
def plot_time_series_outlier(data,
    ...
    .. image:: time_series_outlier_plot.png
       :align: center
...
def plot_seasonal_decompose(data,
    ...
    .. image:: seasonal_decompose_plot.png
       :align: center
