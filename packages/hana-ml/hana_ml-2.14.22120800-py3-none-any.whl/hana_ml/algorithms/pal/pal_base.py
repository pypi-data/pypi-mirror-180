...
class PALBase(hana_ml.ml_base.MLBase, ModelSavingServices):
    ...
    def create_model_state(self, model=None, function=None, pal_funcname=None, state_description=None, force=False):
        r"""
    ...
    def _call_pal_auto(self, conn_context, funcname, *args):
        ...
        if "INFERENCE" in funcname.upper() or "PREDICT" in funcname.upper() or "FORECAST" in funcname.upper() or "SCORE" in funcname.upper():
            if self.state:
                for _arg in _args:
