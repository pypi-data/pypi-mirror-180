...
#pylint: disable=unused-import, super-with-arguments, c-extension-no-member, broad-except
"""
...
from hana_ml.algorithms.pal.tsa.arima import _convert_index_from_timestamp_to_int, _is_index_int, _col_index_check
from hana_ml.algorithms.pal.tsa.arima import _get_forecast_starttime_and_timedelta, _delete_none_key_in_dict
...
class CrostonTSB(PALBase):
    r"""
    The Croston TSB method (for Teunter, Syntetos & Babai) is a forecast strategy for products
    ...
    massive : bool, optional
        ...
        >>> res = mcr.fit_predict(df, key='ID', endog='y', group_key="GROUP_ID")
