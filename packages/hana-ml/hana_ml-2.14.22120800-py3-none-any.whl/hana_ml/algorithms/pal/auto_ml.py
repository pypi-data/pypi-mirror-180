...
class AutomaticClassification(_AutoMLBase):
    ...
    For AutomaticClassification parameter mappings of hana_ml and HANA PAL , please refer to the doc page: :ref:`param_mapping-label`
...
class AutomaticRegression(_AutoMLBase):
    ...
    For AutomaticRegression parameter mappings of hana_ml and HANA PAL, please refer to the doc page: :ref:`param_mapping-label`
    ...
    .. image:: best_pipeline_regression.png
...
class AutomaticTimeSeries(_AutoMLBase):
    ...
    For AutomaticTimeSeries parameter mappings of hana_ml and HANA PAL, please refer to the doc page: :ref:`param_mapping-label`
    ...
    def predict(self, data,#pylint:disable=arguments-differ, arguments-renamed
        ...
        """
        return super(AutomaticTimeSeries, self).predict(data, key, exog, model)
