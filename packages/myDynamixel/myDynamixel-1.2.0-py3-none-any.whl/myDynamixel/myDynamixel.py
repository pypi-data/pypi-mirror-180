...
class Dxlfunc:
    ...
    def __init__(self):
        ...
        self.two_byte_values = [self.Adrress.ModelNumber, self.Adrress.MaxVoltageLimit, self.Adrress.MinVoltageLimit,
