...
class ContainerMap:
    ...
    def __init__(self, conn_string_name: str, container_name: str, map_file_name: str = "map.json"):
    ...
    def _map_level(self, level: dict, levels: list, blob_size: int, path: str) -> dict:
    ...
    def _map_root(self, level: dict) -> dict:
    ...
    def write_map_remote(self, map: dict):
    ...
    def write_map_local(self, map: dict):
...
class FileShareMap:
    ...
    def __init__(self, conn_string_name: str, file_share_name: str, prefix: str):
        conn_string = os.environ[conn_string_name]
    ...
    def _map_directory(self, directory: dict, absolute_paths: list, ) -> dict:
...
class MapComparator:
    ...
    def __init__(self, map1: dict, map2: dict, depth=sys.maxsize):
        self.MAP1 = map1
        self.MAP2 = map2
        self.logger = logging.getLogger(__name__)
        logging.basicConfig(level=logging.INFO)
    ...
    def _compare_map_full(self, depth: int, map1: dict, map2: dict) -> dict:
        diff_level = None
        next_depth = depth - 1
        try:
    ...
    def _compare_map_volume_subcontent(self, keys: list, storage_map: dict, diff_map: dict, next_depth: int, map1_primary: bool) -> dict:
...
class MapReporter:
    ...
    def __init__(self, storage_map: dict, depth=sys.maxsize, prefix=""):
        self.logger = logging.getLogger(__name__)
        logging.basicConfig(level=logging.INFO)
    ...
    def _map_branches(self, map_level: dict, depth=0):
        header_string = ""
        info_string = ""
