...
class LogicOfflineJobFakeBroker(LogicJobBroker, PriceInterface):
    ...
    def unlockQuoteMoney(self, order: FakeOrder):
        ...
        if order.side == OrderSide.BUY:
            ...
            portfolio.unlockQuoteMoney(order.symbol.quote, order.symbol.base, order.quantity)
    ...
    def lockQuoteMoney(self, order: FakeOrder):
        ...
        if order.side == OrderSide.BUY:
            ...
            portfolio.lockQuoteMoney(order.symbol.quote, order.symbol.base, order.quantity)
