    ...
    def generar_cfdi(self, configuracion, timbrado_prueba=None, pac=None):
        ...
        if not self.pagos:
            ...
            if self.NumOperacion:
                recepcion_pago["NumOperacion"] = self.NumOperacion[0:100]
        ...
        if iva_p_16:
            ...
            cp.TotalTrasladosImpuestoIVA16 = "%.2f" % (impuesto_iva_16)

        if iva_p_8:
            cp.TotalTrasladosBaseIVA8 = "%.2f" % (base_iva_total_8 * tc)
            cp.TotalTrasladosImpuestoIVA8 = "%.2f" % (impuesto_iva_8)
        
        if iva_p_0:
            cp.TotalTrasladosBaseIVA0 = "%.2f" % (base_iva_total_0 * tc)
            cp.TotalTrasladosImpuestoIVA0 = "%.2f" % (impuesto_iva_0)
