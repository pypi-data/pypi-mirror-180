...
class Delay(_Link):
    ...
    multiplier: Optional[Union[float, str]] = Field(
...
class ReservoirLongitudinalStation(_Model):
    ...
    p: Union[float,str] = Field(..., description="Reservoir equation multiplier")
    m: Union[float,str] = Field(..., description="Reservoir equation exponent")
