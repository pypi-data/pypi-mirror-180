...
class MsgType(LinkerMsgType, enum.IntEnum):
    ...
    REQ_FUND_TRANS_FROM_BANK_TO_FUTURE = message_pb.MsgType.MSG_TYPE_REQ_FUND_TRANS_FROM_BANK_TO_FUTURE
    REQ_CREDIT_CASH_REPAY = message_pb.MsgType.MSG_TYPE_REQ_CREDIT_CASH_REPAY
    REQ_CREDIT_EXTEND_DEBT_DATE = message_pb.MsgType.MSG_TYPE_REQ_CREDIT_EXTEND_DEBT_DATE
    REQ_CREDIT_ACTIVE_CONTRACTS = message_pb.MsgType.MSG_TYPE_REQ_CREDIT_ACTIVE_CONTRACTS
    REQ_CREDIT_TICKER_ASSIGN_INFO = message_pb.MsgType.MSG_TYPE_REQ_CREDIT_TICKER_ASSIGN_INFO
    ...
    RSP_FUND_TRANS_FROM_BANK_TO_FUTURE = message_pb.MsgType.MSG_TYPE_RSP_FUND_TRANS_FROM_BANK_TO_FUTURE
    RSP_CREDIT_CASH_REPAY = message_pb.MsgType.MSG_TYPE_RSP_CREDIT_CASH_REPAY
    RSP_CREDIT_EXTEND_DEBT_DATE = message_pb.MsgType.MSG_TYPE_RSP_CREDIT_EXTEND_DEBT_DATE
    RSP_CREDIT_ACTIVE_CONTRACTS = message_pb.MsgType.MSG_TYPE_RSP_CREDIT_ACTIVE_CONTRACTS
    RSP_CREDIT_TICKER_ASSIGN_INFO = message_pb.MsgType.MSG_TYPE_RSP_CREDIT_TICKER_ASSIGN_INFO
    ...
    RTN_CREDIT_EXTEND_DEBT_DATE = message_pb.MsgType.MSG_TYPE_RTN_CREDIT_EXTEND_DEBT_DATE
