...
class ActualResult(
    ...
    def from_aws_api_call(
        ...
        '''
        if __debug__:
            def stub(query: IApiCall, attribute: builtins.str) -> None:
                ...
...
class AssertionsProvider(
    ...
    def add_to_role_policy(self, statement: typing.Any) -> None:
        ...
        **Please note**: this is a direct IAM JSON policy blob, *not* a ``iam.PolicyStatement``
        ...
        '''
        if __debug__:
            def stub(statement: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def grant_invoke(self, principal_arn: builtins.str) -> None:
        ...
        '''
        if __debug__:
            def stub(principal_arn: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class AwsApiCallResult:
    def __init__(self, *, api_call_response: typing.Any) -> None:
        ...
        '''
        if __debug__:
            def stub(*, api_call_response: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class ExpectedResult(
    ...
    def array_with(cls, expected: typing.Sequence[typing.Any]) -> "ExpectedResult":
        ...
        '''
        if __debug__:
            def stub(expected: typing.Sequence[typing.Any]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument expected", value=expected, expected_type=type_hints["expected"])
    ...
    def exact(cls, expected: typing.Any) -> "ExpectedResult":
        ...
        '''
        if __debug__:
            def stub(expected: typing.Any) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument expected", value=expected, expected_type=type_hints["expected"])
    ...
    def object_like(
        ...
        '''
        if __debug__:
            def stub(expected: typing.Mapping[builtins.str, typing.Any]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument expected", value=expected, expected_type=type_hints["expected"])
    ...
    def string_like_regexp(cls, expected: builtins.str) -> "ExpectedResult":
        ...
        '''
        if __debug__:
            def stub(expected: builtins.str) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument expected", value=expected, expected_type=type_hints["expected"])
...
class IApiCall(constructs.IConstruct, typing_extensions.Protocol):
    ...
    def wait_for_assertions(
        ...
        *,
        ...
        total_timeout: typing.Optional[aws_cdk.Duration] = None,
    ) -> "IApiCall":
...
class _IApiCallProxy(
    ...
    def assert_at_path(self, path: builtins.str, expected: ExpectedResult) -> IApiCall:
        ...
        '''
        if __debug__:
            def stub(path: builtins.str, expected: ExpectedResult) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def expect(self, expected: ExpectedResult) -> IApiCall:
        ...
        '''
        if __debug__:
            def stub(expected: ExpectedResult) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument expected", value=expected, expected_type=type_hints["expected"])
...
class IntegTest(
    ...
    def __init__(
        ...
        *,
        ...
        assertion_stack: typing.Optional[aws_cdk.Stack] = None,
...
class IntegTestCaseProps(aws_cdk.cloud_assembly_schema.TestOptions):
    ...
    @builtins.property
    def assertion_stack(self) -> typing.Optional[aws_cdk.Stack]:
...
class LambdaFunctionProviderProps:
    def __init__(self, *, handler: typing.Optional[builtins.str] = None) -> None:
        ...
        '''
        if __debug__:
            def stub(*, handler: typing.Optional[builtins.str] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class Match(
    ...
    def array_with(
        ...
        '''
        if __debug__:
            def stub(pattern: typing.Sequence[typing.Any]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def object_like(
        ...
        '''
        if __debug__:
            def stub(pattern: typing.Mapping[builtins.str, typing.Any]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument pattern", value=pattern, expected_type=type_hints["pattern"])
...
class WaiterStateMachineOptions:
    ...
    @builtins.property
    def total_timeout(self) -> typing.Optional[aws_cdk.Duration]:
...
class AwsApiCall(
    ...
    def waiter_provider(self, value: typing.Optional[AssertionsProvider]) -> None:
        if __debug__:
            def stub(value: typing.Optional[AssertionsProvider]) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
