...
class HttpAlbIntegration(
    ...
    def _connection_type(
        ...
        if __debug__:
            def stub(value: aws_cdk.aws_apigatewayv2.HttpConnectionType) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
    ...
    def _http_method(self, value: aws_cdk.aws_apigatewayv2.HttpMethod) -> None:
        if __debug__:
            def stub(value: aws_cdk.aws_apigatewayv2.HttpMethod) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _integration_type(
        ...
        if __debug__:
            def stub(value: aws_cdk.aws_apigatewayv2.HttpIntegrationType) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def _payload_format_version(
        ...
        if __debug__:
            def stub(value: aws_cdk.aws_apigatewayv2.PayloadFormatVersion) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class WebSocketLambdaIntegration(
    ...
    def __init__(self, id: builtins.str, handler: aws_cdk.aws_lambda.IFunction) -> None:
        ...
        '''
        if __debug__:
            def stub(id: builtins.str, handler: aws_cdk.aws_lambda.IFunction) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
            check_type(argname="argument handler", value=handler, expected_type=type_hints["handler"])
