...
from pix import system as _system
import json
...
def get_settings_filepath(
        dirpath: str = None, filename: str = 'SETTINGS.JSON'
):
    '''
    :param dirpath: 配置文件的文件夹地址，如果没有本项目会使用pix的路径作为dirpath
