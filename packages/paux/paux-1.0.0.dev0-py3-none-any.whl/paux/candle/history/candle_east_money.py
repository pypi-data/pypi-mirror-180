...
from pix.candle.history import load as _load
from pix.candle.history import save as _save
from pix import param as _param
from typing import Literal, Union

settings_data = settings.read_settings()

__CANDLE_BASE_DIR = settings_data['CANDLE_EAST_MONEY_BAST_DIR']
__CANDLE_TIMEZONE = settings_data['CANDLE_EAST_MONEY_TIMEZONE']
