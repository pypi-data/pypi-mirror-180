Thai Language Toolkit Project  version 1.6.1
============================================
...
* DesEduLd xxx ## standard deviation of edu length (word)
* DesWrdL  ## mean of word length (syllable)
* DesWrdLd xxx ## standard deviation of word length (syllable)
* DesPL  ## mean of paragraph length (word)
* DesPLd xxx ## standard deviation of paragraph length (word)
...
* WrdC wrdC ## mean of relative frequency of content words in TTC 
* WrdF wrdF ## mean of relative frequency of function words in TTC 
* WrdCF wrdCF  ## mean of relative frequency of content/function words in TTC 
