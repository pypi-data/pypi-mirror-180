...
setup(
    ...
    data_files=[(configs['icon_path'], ['extra/icon/sun.png']),
                (configs['desktop_path'], ['extra/desktop/sun.desktop']),
                (configs['xdg_autostart'], ['extra/xdg/sun_daemon.desktop.sample']),
                (configs['xdg_autostart'], ['extra/xdg/sun.desktop'])],
