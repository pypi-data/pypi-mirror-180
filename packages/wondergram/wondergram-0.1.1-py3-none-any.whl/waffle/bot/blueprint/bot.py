...
from waffle.bot.blueprint.abc import ABCBlueprint
from waffle.bot.dispatch.labelers.default import BotLabeler
from waffle.bot.dispatch.router.bot import BotRouter
from waffle.modules import logger

if TYPE_CHECKING:
    from waffle.api import ABCAPI
    from waffle.bot.bot import Bot
    from waffle.bot.polling.abc import ABCPolling
    from waffle.bot.states import ABCStateDispenser
