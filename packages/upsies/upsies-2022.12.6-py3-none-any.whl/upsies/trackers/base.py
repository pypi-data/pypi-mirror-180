...
from ..utils import (cached_property, configfiles, fs, imghosts, release,
...
class TrackerJobsBase(abc.ABC):
    ...
    async def _update_release_name_from(self, webdb, webdb_id):
    ...
    def _handle_imdb_id(self, imdb_id):
        ...
        self.release_name_job.add_task(self._propagate_webdb_info(self.imdb, imdb_id))
    ...
    def _handle_tmdb_id(self, tmdb_id):
        ...
        self.release_name_job.add_task(self._propagate_webdb_info(self.tmdb, tmdb_id))
    ...
    def _handle_tvmaze_id(self, tvmaze_id):
        ...
        self.release_name_job.add_task(self._propagate_webdb_info(self.tvmaze, tvmaze_id))
    ...
    async def _propagate_webdb_info(self, webdb, webdb_id):
        target_webdb_jobs = [
            j for j in (getattr(self, f'{name}_job') for name in webdbs.webdb_names())
            if (
        ...
        query = webdbs.Query(
            ...
            title=await webdb.title_english(webdb_id),
        ...
        await self._update_release_name_from(webdb, webdb_id)
    ...
    def screenshots(self):
        return self._autobump((
            ...
            (
                ...
                f'       Supported services: ' + ', '.join(imghosts.imghost_names()) + '\n'
                '\n'
