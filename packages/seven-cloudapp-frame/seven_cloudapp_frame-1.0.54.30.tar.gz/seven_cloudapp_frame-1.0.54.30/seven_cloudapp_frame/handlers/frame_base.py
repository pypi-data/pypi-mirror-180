...
@LastEditTime: 2022-12-12 13:31:38
...
class FrameBaseHandler(BaseApiHandler):
    ...
    def get_http_log_extra_dict(self):
        ...
        """
        dict_param = {}
        if config.get_value("plat_type", 1) != 4: #如果是web站点，从cookie取
    ...
    def _request_source_type(self):
        ...
        :last_editors: HuangJianYi
        """
        plat_type = config.get_value("plat_type", 1) # 平台类型 1淘宝2微信3抖音4web
        if plat_type == 4:
            return 1
    ...
    def get_cooke_user_id(self):
        ...
        if user_id <= 0:
            ...
            check_user_id_md5 = CryptoHelper.md5_encrypt(str(cookie_user_id), config.get_value("cookie_encrypt_key", "r8C1JpyAXxrFV26V"))
    ...
    def set_cooke_user_id(self, user_id, expires_days=30):
        ...
        :last_editors: HuangJianYi
        """
        user_id_md5 = CryptoHelper.md5_encrypt(str(user_id), config.get_value("cookie_encrypt_key", "r8C1JpyAXxrFV26V"))
