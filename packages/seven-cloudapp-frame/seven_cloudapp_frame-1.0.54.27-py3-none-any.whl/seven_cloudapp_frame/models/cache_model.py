...
@LastEditTime: 2022-08-12 18:25:35
...
class CacheModel(BaseModel):
    ...
    def get_cache_page_list(self, field="*", page_index=0, page_size=20, where='', group_by='', order_by='', params=None, dependency_key='', cache_expire=1800):
        """
        :Description: 分页获取数据
        :param field: 查询字段 
    ...
    def get_cache_dict_page_list(self, field="*", page_index=0 ,page_size=20, where='', group_by='' ,order_by='' ,params=None, dependency_key='', cache_expire=1800):
        """
