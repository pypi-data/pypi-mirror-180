...
class Cross_section:
    def __init__(self,model='CT10nlo',pdg=14,n_tt=2212):
        ...
        self.fcc=interp1d(np.array(self.crosscc['E']),self.crosscc['mean']*10**(-38),kind='cubic')
        self.fnc=interp1d(np.array(self.crossnc['E']),self.crossnc['mean']*10**(-38),kind='cubic')
        self.a=self.fcc
