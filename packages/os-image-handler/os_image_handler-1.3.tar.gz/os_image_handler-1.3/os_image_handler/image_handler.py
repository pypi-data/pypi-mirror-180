...
def draw_text_on_img(img, text, x, y, hex_color, path_to_font, font_size, anchor='lm'):
    ...
    :param anchor: the place from which to start the writing. For RTL you'll probably want to use "rm". Read more about it here:
...
def get_text_size_box(text, path_to_font, font_size):
