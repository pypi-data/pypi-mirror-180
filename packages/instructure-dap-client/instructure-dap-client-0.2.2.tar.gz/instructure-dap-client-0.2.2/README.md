...
```sh
export DAP_API_URL=https://dap.example.com
...
```sh
dap --base-url https://dap.example.com --api-key aCBd3V...U1aaaa incremental --namespace canvas --table accounts --since 2022-07-13T09:30:00+02:00
```
