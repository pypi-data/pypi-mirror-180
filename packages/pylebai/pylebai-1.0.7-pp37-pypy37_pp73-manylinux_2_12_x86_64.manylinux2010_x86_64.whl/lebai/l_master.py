...
class JointMap(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")

    def iterator(self) -> "swig::SwigPyIterator *":
        return _l_master.JointMap_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self) -> "bool":
        return _l_master.JointMap___nonzero__(self)

    def __bool__(self) -> "bool":
        return _l_master.JointMap___bool__(self)

    def __len__(self) -> "std::map< std::string,double >::size_type":
        return _l_master.JointMap___len__(self)
    def __iter__(self):
    ...
    def __getitem__(self, key: "std::map< std::string,double >::key_type const &") -> "std::map< std::string,double >::mapped_type const &":
        return _l_master.JointMap___getitem__(self, key)

    def __delitem__(self, key: "std::map< std::string,double >::key_type const &") -> "void":
        return _l_master.JointMap___delitem__(self, key)

    def has_key(self, key: "std::map< std::string,double >::key_type const &") -> "bool":
        return _l_master.JointMap_has_key(self, key)

    def keys(self) -> "PyObject *":
        return _l_master.JointMap_keys(self)

    def values(self) -> "PyObject *":
        return _l_master.JointMap_values(self)

    def items(self) -> "PyObject *":
        return _l_master.JointMap_items(self)

    def __contains__(self, key: "std::map< std::string,double >::key_type const &") -> "bool":
        return _l_master.JointMap___contains__(self, key)

    def key_iterator(self) -> "swig::SwigPyIterator *":
        return _l_master.JointMap_key_iterator(self)

    def value_iterator(self) -> "swig::SwigPyIterator *":
        return _l_master.JointMap_value_iterator(self)

    def __setitem__(self, *args) -> "void":
        return _l_master.JointMap___setitem__(self, *args)

    def asdict(self) -> "PyObject *":
        return _l_master.JointMap_asdict(self)

    def __init__(self, *args):
        _l_master.JointMap_swiginit(self, _l_master.new_JointMap(*args))

    def empty(self) -> "bool":
        return _l_master.JointMap_empty(self)

    def size(self) -> "std::map< std::string,double >::size_type":
        return _l_master.JointMap_size(self)

    def swap(self, v: "JointMap") -> "void":
        return _l_master.JointMap_swap(self, v)

    def begin(self) -> "std::map< std::string,double >::iterator":
        return _l_master.JointMap_begin(self)

    def end(self) -> "std::map< std::string,double >::iterator":
        return _l_master.JointMap_end(self)

    def rbegin(self) -> "std::map< std::string,double >::reverse_iterator":
        return _l_master.JointMap_rbegin(self)

    def rend(self) -> "std::map< std::string,double >::reverse_iterator":
        return _l_master.JointMap_rend(self)

    def clear(self) -> "void":
        return _l_master.JointMap_clear(self)

    def get_allocator(self) -> "std::map< std::string,double >::allocator_type":
        return _l_master.JointMap_get_allocator(self)

    def count(self, x: "std::map< std::string,double >::key_type const &") -> "std::map< std::string,double >::size_type":
        return _l_master.JointMap_count(self, x)

    def erase(self, *args) -> "void":
        return _l_master.JointMap_erase(self, *args)

    def find(self, x: "std::map< std::string,double >::key_type const &") -> "std::map< std::string,double >::iterator":
        return _l_master.JointMap_find(self, x)

    def lower_bound(self, x: "std::map< std::string,double >::key_type const &") -> "std::map< std::string,double >::iterator":
        return _l_master.JointMap_lower_bound(self, x)

    def upper_bound(self, x: "std::map< std::string,double >::key_type const &") -> "std::map< std::string,double >::iterator":
        return _l_master.JointMap_upper_bound(self, x)

    def __repr__(self) -> "std::string":
        return _l_master.JointMap___repr__(self)
    __swig_destroy__ = _l_master.delete_JointMap

# Register JointMap in _l_master:
_l_master.JointMap_swigregister(JointMap)
...
class Robot(object):
    ...
    def movej(self, *args) -> "int":
        ...
        *Overload 1:*
        ...
        :type joint_positions: std::map< std::string,double,std::less< std::string >,std::allocator< std::pair< std::string const,double > > >, in
        ...
        *Overload 2:*
        ...
        通过坐标位置发送机械臂关节移动
        Notes: 该接口为异步接口，仅向控制器内部的运动缓冲区写入一个关节移动即返回，不会等待运动结束.
        :type cart_pose: :py:class:`CartesianPose`, in
    ...
    def movel(self, *args) -> "int":
        ...
        *Overload 2:*
        ...
        通过坐标位置发送机械臂直线移动
        Notes: 该接口为异步接口，仅向控制器内部的运动缓冲区写入一个关节移动即返回，不会等待运动结束.
        :type cart_pose: :py:class:`CartesianPose`
        :param cart_pose:: 目标位置在机器人基座标系下的坐标数据(目前不支持在其它坐标系下的坐标数据)，CartesianPose = std::array<double,6>，数组大小为6，前三个数据为空间中的[x,y,z]点位，后三个数据是以欧拉ZYX形式的姿态数据[rz,ry,rx].
        :type a: float
        :param a:: 加速度
        :type v: float
    ...
    def get_actual_joint_positions(self) -> "std::map< std::string,double,std::less< std::string >,std::allocator< std::pair< std::string const,double > > >":
        r"""
        获取机械臂关节当前反馈位置
    ...
    def get_target_joint_positions(self) -> "std::map< std::string,double,std::less< std::string >,std::allocator< std::pair< std::string const,double > > >":
        r"""
        获取机械臂关节当前控制位置
    ...
    def get_actual_tcp_pose(self) -> "lebai::l_master::Robot::CartesianPose":
        r"""
        获取机械臂末端在机械臂基坐标系下的实际位姿
    ...
    def get_target_tcp_pose(self) -> "lebai::l_master::Robot::CartesianPose":
        r"""
        获取机械臂末端在机械臂基坐标系下的控制位姿
    ...
    def get_di(self, pin: "unsigned int") -> "bool":
        r"""
        获取控制箱数字输入
        ...
        :return: 返回输入数值
        """
        return _l_master.Robot_get_di(self, pin)

    def set_do(self, *args) -> "void":
        r"""
        *Overload 1:*
        ...
        *Overload 2:*
        ...
        :param value: 待设置的值
        """
        return _l_master.Robot_set_do(self, *args)

    def get_ai(self, pin: "unsigned int") -> "double":
        r"""
        获取控制箱模拟输入
        ...
        :return: 返回输入数值
        """
        return _l_master.Robot_get_ai(self, pin)

    def set_ao(self, pin: "unsigned int", value: "double") -> "void":
        r"""
        设置控制箱模拟输出
        ...
        :param value:: 待设置的值
        """
        return _l_master.Robot_set_ao(self, pin, value)

    def get_flange_di(self, pin: "unsigned int") -> "bool":
        r"""
        获取法兰数字输入
        ...
        :return: 返回输入数值
        """
        return _l_master.Robot_get_flange_di(self, pin)

    def set_flange_do(self, *args) -> "void":
        r"""
        *Overload 1:*
        ...
        *Overload 2:*
        ...
        :param value:: 待设置的值
        """
        return _l_master.Robot_set_flange_do(self, *args)

    def get_extra_di(self, pin: "unsigned int") -> "bool":
        r"""
        获取扩展数字输入
        ...
        :return: 返回输入数值
        """
        return _l_master.Robot_get_extra_di(self, pin)

    def set_extra_do(self, *args) -> "void":
        r"""
        *Overload 1:*
        ...
        *Overload 2:*
        ...
        :param value:: 待设置的值
        """
        return _l_master.Robot_set_extra_do(self, *args)

    def get_extra_ai(self, pin: "unsigned int") -> "double":
        r"""
        获取扩展模拟输入
        ...
        :return: 返回输入数值
        """
        return _l_master.Robot_get_extra_ai(self, pin)

    def set_extra_ao(self, pin: "unsigned int", value: "double") -> "void":
        r"""
        设置扩展模拟输出
        ...
        :param value: 待设置的值
        """
        return _l_master.Robot_set_extra_ao(self, pin, value)
    ...
    def kinematics_forward(self, joint_positions: "JointMap") -> "lebai::l_master::KinematicsForwardResp":
        r"""
        根据机械臂关节位置计算机器人末端位姿（位置的运动学正解）.
        :type joint_positions: std::map< std::string,double,std::less< std::string >,std::allocator< std::pair< std::string const,double > > >
    ...
    def kinematics_inverse(self, *args) -> "lebai::l_master::KinematicsInverseResp":
        ...
        :type pose: std::array< double,6 >
        :param pose:: 机械臂末端位姿，依次为 x, y, z, rz, ry, rx.
        :type joint_init_positions: std::map< std::string,double,std::less< std::string >,std::allocator< std::pair< std::string const,double > > >, optional
    ...
    def pose_times(self, a: "CartArray", b: "CartArray") -> "std::array< double,6 >":
        r"""
        位姿变换乘法（等价于对应的齐次坐标矩阵乘法）

        :type a: std::array< double,6 >
        :param a:: 位姿，依次为 x, y, z, rz, ry, rx.
        :type b: std::array< double,6 >
    ...
    def pose_inverse(self, _in: "CartArray") -> "std::array< double,6 >":
        r"""
        位姿变换的逆（等价于对应的齐次坐标矩的逆）

        :type in: std::array< double,6 >
    ...
    def set_payload(self, mass: "double", cog: "JointMap") -> "void":
        r"""
        设置机器人末端负载
    ...
    def set_gravity(self, gravity: "JointMap") -> "void":
        r"""
        设置机器人重力加速度方向
