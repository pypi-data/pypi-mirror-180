...
use crate::classic::chinillaclvm::__type_compatibility__::{t, Stream};
use crate::classic::chinillaclvm_tools::cmds::{
    launch_tool, OpcConversion, OpdConversion, TConversion,
};
...
fn pool_member_innerpuz() {
    ...
    let program = indoc! {"
        (mod (POOL_PUZZLE_HASH
          ...
          ; POOL_REWARD_PREFIX is network-specific data (vanillanet vs testnet) that helps determine if a coin is a pool reward
          ...
          (include condition_codes.chinillaclvm)
