...
use crate::classic::chinillaclvm_tools::binutils::assemble;
...
to a compiled chinillaclvm program.
...
fn default_macros_src() -> Vec<&'static str> {
    vec![
        ...
        */
        ...
        "},
        /*
         / operator at the chinillaclvm layer is becoming deprecated and
