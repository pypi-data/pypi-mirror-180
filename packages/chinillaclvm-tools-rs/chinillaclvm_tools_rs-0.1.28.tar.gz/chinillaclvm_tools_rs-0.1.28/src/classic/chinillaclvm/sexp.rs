...
// export class SExp implements CHINILLACLVMType {
//   atom: Optional<Bytes> = None;
//   // this is always a 2-tuple of an object implementing the CHINILLACLVM object protocol.
//   pair: Optional<Tuple<any, any>> = None;

//   static readonly TRUE: SExp = new SExp(new CHINILLACLVMObject(Bytes.from("0x01", "hex")));
//   static readonly FALSE: SExp = new SExp(new CHINILLACLVMObject(Bytes.NULL));
//   static readonly __NULL__: SExp = new SExp(new CHINILLACLVMObject(Bytes.NULL));
