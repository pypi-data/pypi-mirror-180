...
from routeviews import exceptions, parse, types
...
class Router:
    ...
    ip4addr: Optional[types.IPAddr] = None
    ip6addr: Optional[types.IPAddr] = None
    ...
    @staticmethod
    def _parse_ipaddr(ipaddr: str) -> Optional[types.IPAddr]:
        try:
