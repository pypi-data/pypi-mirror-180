...
@trace
def ix_peer_requests(asn: int, ipaddrs: Optional[List[types.IPAddr]] = None) -> List[peeringdb.PeerRequest]:
...
def multihop_peer_requests(my_addr: types.IPAddr,
                           asn: int,
                           ipaddrs: types.IPAddrList
