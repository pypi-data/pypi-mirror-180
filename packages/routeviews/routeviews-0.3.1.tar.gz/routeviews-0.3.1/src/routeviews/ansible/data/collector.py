...
class CollectorConfig:
    ...
    @property
    def first_peering_addr(self) -> routeviews.types.IPAddr:
    ...
    def peerable_ipaddrs(self) -> routeviews.types.IPAddrList:
        try:
            ...
            raise routeviews.exceptions.ParseError(f'No Peering Interfaces found in {self.filepath} (interface_config.peering.interfaces)')
    ...
    def add_neighbor(self, asn: int, address: routeviews.types.IPAddr, 
