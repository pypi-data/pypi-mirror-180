...
inline void add_draw_functions(pybind11::class_<T, O...>& cls)
{
    ...
    }, "end"_a, "Draw a line from the end of the last line to the given position.");
    ...
    cls.def("draw", [](T& self, gl_wrap::TexRef const& tr,
            ...
            "size"_a = Vec2f{-1, -1}, "rot"_a = 0, "Render an image. The image can either be aligned to its top left corner, or centered, in which case it can also be rotated.");
    ...
    }, "Set the line with in frational pixels.");
