...
class TagsApi(object):
    ...
    def add_tag(self, **kwargs):  # noqa: E501
        ...
        _in snippets: platform.api.tags.addTag_  # noqa: E501
    ...
    def delete_tag(self, tag_id, **kwargs):  # noqa: E501
        ...
        _in snippets: platform.api.tags.deleteTag_  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_customer_tags1(self, tag_id, **kwargs):  # noqa: E501
        """Gets the customers for a specific tag  # noqa: E501

        _in snippets: platform.api.tags.getCustomerTags_  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customer_tags1(tag_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_customer_tags1_with_http_info(tag_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_customer_tags1_with_http_info(tag_id, **kwargs)  # noqa: E501
            return data

    def get_customer_tags1_with_http_info(self, tag_id, **kwargs):  # noqa: E501
        """Gets the customers for a specific tag  # noqa: E501

        _in snippets: platform.api.tags.getCustomerTags_  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_customer_tags1_with_http_info(tag_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['tag_id', 'first', 'max']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_customer_tags1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'tag_id' is set
        if ('tag_id' not in params or
                params['tag_id'] is None):
            raise ValueError("Missing the required parameter `tag_id` when calling `get_customer_tags1`")  # noqa: E501
    ...
    def get_tags(self, **kwargs):  # noqa: E501
        ...
        _in snippets: platform.api.tags.getTags_  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
