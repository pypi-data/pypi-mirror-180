...
class ClickFunnelRegistration(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, contact, event, *args, **kwargs):  # noqa: E501
        """ClickFunnelRegistration - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, contact, event, *args, **kwargs):  # noqa: E501
        """ClickFunnelRegistration - a model defined in OpenAPI
