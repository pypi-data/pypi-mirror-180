...
class PickWTStaticVoucherCreateParamsExcludeKeyofWTStaticVoucherCreateParamsCampaignID(ModelNormal):
    ...
    def _from_openapi_data(cls, offer_amount_cents, cell_phone, *args, **kwargs):  # noqa: E501
        """PickWTStaticVoucherCreateParamsExcludeKeyofWTStaticVoucherCreateParamsCampaignID - a model defined in OpenAPI
