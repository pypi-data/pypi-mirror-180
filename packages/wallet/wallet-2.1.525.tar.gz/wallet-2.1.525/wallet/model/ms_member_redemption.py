...
class MSMemberRedemption(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, transaction_id, transaction_type, points, terminal_type, id, member_id, merchant_id, created_at, is_active, *args, **kwargs):  # noqa: E501
        """MSMemberRedemption - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, transaction_id, transaction_type, points, terminal_type, id, member_id, merchant_id, created_at, is_active, *args, **kwargs):  # noqa: E501
        """MSMemberRedemption - a model defined in OpenAPI
