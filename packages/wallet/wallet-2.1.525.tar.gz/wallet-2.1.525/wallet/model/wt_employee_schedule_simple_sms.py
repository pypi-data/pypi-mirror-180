...
class WTEmployeeScheduleSimpleSMS(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, phone_number_id, message_template, broadcast_scheduled_at, list_type, list_id, *args, **kwargs):  # noqa: E501
        """WTEmployeeScheduleSimpleSMS - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, phone_number_id, message_template, broadcast_scheduled_at, list_type, list_id, *args, **kwargs):  # noqa: E501
        """WTEmployeeScheduleSimpleSMS - a model defined in OpenAPI
