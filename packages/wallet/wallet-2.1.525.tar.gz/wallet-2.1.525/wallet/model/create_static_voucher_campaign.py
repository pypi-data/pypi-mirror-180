...
class CreateStaticVoucherCampaign(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, start_date_time, expiration_date_time, title, notes, value_type, payment_design_id, is_active, source_id, *args, **kwargs):  # noqa: E501
        """CreateStaticVoucherCampaign - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, start_date_time, expiration_date_time, title, notes, value_type, payment_design_id, is_active, source_id, *args, **kwargs):  # noqa: E501
        """CreateStaticVoucherCampaign - a model defined in OpenAPI
