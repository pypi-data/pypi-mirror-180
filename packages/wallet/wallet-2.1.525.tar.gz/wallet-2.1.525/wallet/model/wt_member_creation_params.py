...
class WTMemberCreationParams(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, membership_tier_id, mobile_number, points_accrued, member_id, *args, **kwargs):  # noqa: E501
        """WTMemberCreationParams - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, membership_tier_id, mobile_number, points_accrued, member_id, *args, **kwargs):  # noqa: E501
        """WTMemberCreationParams - a model defined in OpenAPI
