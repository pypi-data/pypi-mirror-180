...
class Performance(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, title, body, start_date_time, price, url, order_number, is_sold_out, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, title, body, start_date_time, price, url, order_number, is_sold_out, id, created_at, updated_at, is_active, merchant_id, *args, **kwargs):  # noqa: E501
        """Performance - a model defined in OpenAPI
