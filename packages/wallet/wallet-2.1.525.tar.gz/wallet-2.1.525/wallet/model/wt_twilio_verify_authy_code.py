...
class WTTwilioVerifyAuthyCode(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, merchant_id, phone_number, otp, *args, **kwargs):  # noqa: E501
        """WTTwilioVerifyAuthyCode - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, merchant_id, phone_number, otp, *args, **kwargs):  # noqa: E501
        """WTTwilioVerifyAuthyCode - a model defined in OpenAPI
