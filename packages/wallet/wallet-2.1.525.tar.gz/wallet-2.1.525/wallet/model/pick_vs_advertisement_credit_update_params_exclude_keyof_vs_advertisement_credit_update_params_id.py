...
class PickVSAdvertisementCreditUpdateParamsExcludeKeyofVSAdvertisementCreditUpdateParamsId(ModelNormal):
    ...
    def _from_openapi_data(cls, title, value_type, payment_design_id, max_uses, discount_value, *args, **kwargs):  # noqa: E501
        """PickVSAdvertisementCreditUpdateParamsExcludeKeyofVSAdvertisementCreditUpdateParamsId - a model defined in OpenAPI
