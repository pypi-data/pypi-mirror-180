...
class PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmail(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, employee_id, first_name, last_name, phone_number, is_public_representative, wallet_sequence_number, job_title, department, *args, **kwargs):  # noqa: E501
        """PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmail - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, employee_id, first_name, last_name, phone_number, is_public_representative, wallet_sequence_number, job_title, department, *args, **kwargs):  # noqa: E501
        """PickWTEmployeeCreateExcludeKeyofWTEmployeeCreateEmail - a model defined in OpenAPI
