...
class Tcpa(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, cell_phone, phone_number_id, id, merchant_id, created_at, updated_at, is_active, *args, **kwargs):  # noqa: E501
        """Tcpa - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, cell_phone, phone_number_id, id, merchant_id, created_at, updated_at, is_active, *args, **kwargs):  # noqa: E501
        """Tcpa - a model defined in OpenAPI
