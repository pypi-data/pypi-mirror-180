...
class WTPaymentDesign(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, border_color, border_style_type, border_size, border_radius, font_color, font_type, abbreviation, acronym, icon, design_name, display_name, employee_id, id, merchant_id, created_at, updated_at, is_active, *args, **kwargs):  # noqa: E501
        """WTPaymentDesign - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, border_color, border_style_type, border_size, border_radius, font_color, font_type, abbreviation, acronym, icon, design_name, display_name, employee_id, id, merchant_id, created_at, updated_at, is_active, *args, **kwargs):  # noqa: E501
        """WTPaymentDesign - a model defined in OpenAPI
