...
class MSAnalyticsMemberCountPartitionedByDate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date, count, *args, **kwargs):  # noqa: E501
        """MSAnalyticsMemberCountPartitionedByDate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, date, count, *args, **kwargs):  # noqa: E501
        """MSAnalyticsMemberCountPartitionedByDate - a model defined in OpenAPI
