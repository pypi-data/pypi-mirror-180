...
class ConfigurationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.save_wallet_record_endpoint = _Endpoint(
            settings={
                'response_type': (WalletConfiguration,),
                'auth': [],
                'endpoint_path': '/v2/wallet',
                'operation_id': 'save_wallet_record',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    'wt_wallet_configuration_save_wallet_record': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def create_public_chat_room(
        ...
        **kwargs
        ...
        """create_public_chat_room  # noqa: E501

        Save wallet record  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_public_chat_room(async_req=True)
        >>> result = thread.get()
        ...
        return self.create_public_chat_room_endpoint.call_with_http_info(**kwargs)
    ...
    def save_wallet_record(
        ...
        **kwargs
        ...
        >>> thread = api.save_wallet_record(wt_wallet_configuration_save_wallet_record, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['wt_wallet_configuration_save_wallet_record'] = \
            wt_wallet_configuration_save_wallet_record
        return self.save_wallet_record_endpoint.call_with_http_info(**kwargs)
