...
class IndustriesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.fetch_all_industries_endpoint = _Endpoint(
            settings={
                'response_type': ([InlineResponse200],),
                'auth': [],
                'endpoint_path': '/system/industries/all',
                'operation_id': 'fetch_all_industries',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def fetch_all_industries(
        ...
        **kwargs
        ...
        >>> thread = api.fetch_all_industries(async_req=True)
        >>> result = thread.get()
        ...
        return self.fetch_all_industries_endpoint.call_with_http_info(**kwargs)
