...
class PickSSMobileNumberUpdateParamsExcludeKeyofSSMobileNumberUpdateParamsId(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, message_footer, help_response, stop_response, company_name, privacy_policy_url, terms_of_service_url, help_desk_keyword, help_desk_queue_response, is_connected_to_watson, watson_conversation_workplace_id, watson_username, watson_password, *args, **kwargs):  # noqa: E501
        """PickSSMobileNumberUpdateParamsExcludeKeyofSSMobileNumberUpdateParamsId - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, message_footer, help_response, stop_response, company_name, privacy_policy_url, terms_of_service_url, help_desk_keyword, help_desk_queue_response, is_connected_to_watson, watson_conversation_workplace_id, watson_username, watson_password, *args, **kwargs):  # noqa: E501
        """PickSSMobileNumberUpdateParamsExcludeKeyofSSMobileNumberUpdateParamsId - a model defined in OpenAPI
