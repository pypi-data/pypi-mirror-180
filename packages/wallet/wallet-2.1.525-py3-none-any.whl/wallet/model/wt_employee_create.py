...
class WTEmployeeCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, first_name, last_name, email, phone_number, is_public_representative, wallet_sequence_number, employee_id, job_title, department, *args, **kwargs):  # noqa: E501
        """WTEmployeeCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, first_name, last_name, email, phone_number, is_public_representative, wallet_sequence_number, employee_id, job_title, department, *args, **kwargs):  # noqa: E501
        """WTEmployeeCreate - a model defined in OpenAPI
