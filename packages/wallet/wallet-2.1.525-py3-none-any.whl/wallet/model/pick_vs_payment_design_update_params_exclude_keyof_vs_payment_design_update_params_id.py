...
class PickVSPaymentDesignUpdateParamsExcludeKeyofVSPaymentDesignUpdateParamsId(ModelNormal):
    ...
    def _from_openapi_data(cls, border_color, border_style_type, border_size, border_radius, font_color, font_type, abbreviation, acronym, icon, design_name, display_name, *args, **kwargs):  # noqa: E501
        """PickVSPaymentDesignUpdateParamsExcludeKeyofVSPaymentDesignUpdateParamsId - a model defined in OpenAPI
