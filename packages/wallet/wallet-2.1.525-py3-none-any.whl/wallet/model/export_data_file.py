...
class ExportDataFile(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, merchant_id, created_at, updated_at, is_active, is_read, employee_id, s3_bucket, s3_key, file_size_bytes, *args, **kwargs):  # noqa: E501
        """ExportDataFile - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, merchant_id, created_at, updated_at, is_active, is_read, employee_id, s3_bucket, s3_key, file_size_bytes, *args, **kwargs):  # noqa: E501
        """ExportDataFile - a model defined in OpenAPI
