...
class WTEmployeeSendHelpDeskResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, help_desk_request_id, message, *args, **kwargs):  # noqa: E501
        """WTEmployeeSendHelpDeskResponse - a model defined in OpenAPI

        Args:
            help_desk_request_id (NanoID):
            message (str):
        ...
        self.help_desk_request_id = help_desk_request_id
    ...
    @convert_js_args_to_python_args
    def __init__(self, help_desk_request_id, message, *args, **kwargs):  # noqa: E501
        """WTEmployeeSendHelpDeskResponse - a model defined in OpenAPI
