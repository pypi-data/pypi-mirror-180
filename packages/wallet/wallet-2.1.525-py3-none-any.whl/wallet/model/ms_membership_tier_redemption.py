...
class MSMembershipTierRedemption(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, member_id, transaction_id, transaction_type, amount, terminal_type, id, tier_id, merchant_id, created_at, is_active, *args, **kwargs):  # noqa: E501
        """MSMembershipTierRedemption - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            register_id (bool, date, datetime, dict, float, int, list, str, none_type): The ID of the register where the transaction occurred. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, member_id, transaction_id, transaction_type, amount, terminal_type, id, tier_id, merchant_id, created_at, is_active, *args, **kwargs):  # noqa: E501
        """MSMembershipTierRedemption - a model defined in OpenAPI
