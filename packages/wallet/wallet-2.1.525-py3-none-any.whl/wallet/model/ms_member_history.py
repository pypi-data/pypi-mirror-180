...
class MSMemberHistory(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, member_identifier, membership_tier_id, mobile_number, points_accrued, id, member_id, merchant_id, created_at, is_active, *args, **kwargs):  # noqa: E501
        """MSMemberHistory - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, member_identifier, membership_tier_id, mobile_number, points_accrued, id, member_id, merchant_id, created_at, is_active, *args, **kwargs):  # noqa: E501
        """MSMemberHistory - a model defined in OpenAPI
