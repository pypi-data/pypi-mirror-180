...
class Response(ModelNormal):
    ...
    attribute_map = {
        ...
        'xml_output': 'xmlOutput',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created_at, updated_at, routing_id, xml_output, has_error, destination_property_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, created_at, updated_at, routing_id, xml_output, has_error, destination_property_id, *args, **kwargs):  # noqa: E501
        """Response - a model defined in OpenAPI
