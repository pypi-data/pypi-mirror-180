...
class PaginatedWTMembers(ModelNormal):
    ...
    def _from_openapi_data(cls, results, length, total, *args, **kwargs):  # noqa: E501
        """PaginatedWTMembers - a model defined in OpenAPI

        Args:
            results ([WTMember]): Stores the results as an array
