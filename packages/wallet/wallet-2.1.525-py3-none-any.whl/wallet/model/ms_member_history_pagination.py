...
class MSMemberHistoryPagination(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'results': ([MSMemberHistory],),  # noqa: E501
    ...
    def _from_openapi_data(cls, results, length, total, *args, **kwargs):  # noqa: E501
        """MSMemberHistoryPagination - a model defined in OpenAPI

        Args:
            results ([MSMemberHistory]): Stores the results as an array
