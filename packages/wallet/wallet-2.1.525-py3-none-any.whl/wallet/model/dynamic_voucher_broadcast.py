...
class DynamicVoucherBroadcast(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, phone_number_id, payment_object_prefix, payment_object_id, message_template, media_urls, employee_id, broadcast_scheduled_at, id, merchant_id, created_at, updated_at, is_active, broadcast_status, broadcast_queued_at, broadcast_started_at, broadcast_completed_at, list_type, list_id, dynamic_voucher, *args, **kwargs):  # noqa: E501
        """DynamicVoucherBroadcast - a model defined in OpenAPI
