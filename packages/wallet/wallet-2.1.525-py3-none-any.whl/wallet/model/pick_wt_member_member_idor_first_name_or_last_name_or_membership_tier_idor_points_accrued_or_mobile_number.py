...
class PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumber(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, member_id, membership_tier_id, mobile_number, points_accrued, *args, **kwargs):  # noqa: E501
        """PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumber - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, member_id, membership_tier_id, mobile_number, points_accrued, *args, **kwargs):  # noqa: E501
        """PickWTMemberMemberIDOrFirstNameOrLastNameOrMembershipTierIDOrPointsAccruedOrMobileNumber - a model defined in OpenAPI
