...
class PickMSMemberExcludeKeyofMSMemberMemberIdentifier(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, is_active, merchant_id, created_at, updated_at, membership_tier_id, mobile_number, points_accrued, *args, **kwargs):  # noqa: E501
        """PickMSMemberExcludeKeyofMSMemberMemberIdentifier - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, is_active, merchant_id, created_at, updated_at, membership_tier_id, mobile_number, points_accrued, *args, **kwargs):  # noqa: E501
        """PickMSMemberExcludeKeyofMSMemberMemberIdentifier - a model defined in OpenAPI
