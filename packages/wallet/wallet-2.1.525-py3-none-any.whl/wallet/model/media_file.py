...
class MediaFile(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, created_at, updated_at, merchant_id, file_url, file_type, file_name, file_size, folder, employee_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, created_at, updated_at, merchant_id, file_url, file_type, file_name, file_size, folder, employee_id, *args, **kwargs):  # noqa: E501
        """MediaFile - a model defined in OpenAPI
