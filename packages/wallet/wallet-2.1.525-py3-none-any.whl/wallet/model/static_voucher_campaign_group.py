...
class StaticVoucherCampaignGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, voucher_type, created_by_source_id, employee_id, id, merchant_id, created_at, updated_at, is_active, is_loaded, *args, **kwargs):  # noqa: E501
        """StaticVoucherCampaignGroup - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, voucher_type, created_by_source_id, employee_id, id, merchant_id, created_at, updated_at, is_active, is_loaded, *args, **kwargs):  # noqa: E501
        """StaticVoucherCampaignGroup - a model defined in OpenAPI
