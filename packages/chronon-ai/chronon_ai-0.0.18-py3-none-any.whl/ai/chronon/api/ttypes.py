...
class MetaData(object):
    ...
    def __init__(self, name=None, online=None, production=None, customJson=None, dependencies=None, tableProperties=None, outputNamespace=None, team=None, modeToEnvMap=None, consistencyCheck=None, samplePercent=None, offlineSchedule=None,):
        self.name = name
        self.online = online
...
class Join(object):
    ...
    def __init__(self, metaData=None, left=None, joinParts=None, skewKeys=None, onlineExternalParts=None, labelJoin=None,):
        self.metaData = metaData
        self.left = left
...
class LabelJoin(object):
    ...
    def __init__(self, labelParts=None, leftStartOffset=None, leftEndOffset=None,):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i183 in range(_size179):
                        _elem184 = JoinPart()
                        _elem184.read(iprot)
                        self.labelParts.append(_elem184)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('LabelJoin')
        if self.labelParts is not None:
            oprot.writeFieldBegin('labelParts', TType.LIST, 1)
            oprot.writeListBegin(TType.STRUCT, len(self.labelParts))
            for iter185 in self.labelParts:
                iter185.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
Join.thrift_spec = (
    ...
    (6, TType.STRUCT, 'labelJoin', [LabelJoin, None], None, ),  # 6
)
all_structs.append(LabelJoin)
LabelJoin.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'labelParts', (TType.STRUCT, [JoinPart, None], False), None, ),  # 1
