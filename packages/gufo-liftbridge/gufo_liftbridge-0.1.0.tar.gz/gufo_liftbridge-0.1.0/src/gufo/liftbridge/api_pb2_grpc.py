...
import gufo.liftbridge.api_pb2 as api__pb2
...
class API(object):
    ...
    @staticmethod
    def FetchConsumerGroupAssignments(
        request,
        target,
        options=(),
        channel_credentials=None,
    ...
    @staticmethod
    def ReportConsumerGroupCoordinator(
        request,
        target,
        options=(),
        channel_credentials=None,
