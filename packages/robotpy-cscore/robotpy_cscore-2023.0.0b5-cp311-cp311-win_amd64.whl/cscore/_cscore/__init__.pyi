...
class VideoSource():
    ...
    def __ne__(self, arg0: VideoSource) -> bool: ...
...
class VideoSink():
    ...
    def __init__(self) -> None: ...
    def __ne__(self, arg0: VideoSink) -> bool: ...
    def enumerateProperties(self) -> typing.List[VideoProperty]: 
        """
...
class VideoMode():
    ...
    class PixelFormat():
        ...
        def value(self) -> int:
            ...
            :type: int
            """
        __members__: dict # value = {'kUnknown': <PixelFormat.kUnknown: 0>, 'kMJPEG': <PixelFormat.kMJPEG: 1>, 'kYUYV': <PixelFormat.kYUYV: 2>, 'kRGB565': <PixelFormat.kRGB565: 3>, 'kBGR': <PixelFormat.kBGR: 4>, 'kGray': <PixelFormat.kGray: 5>}
    ...
    def __ne__(self, arg0: VideoMode) -> bool: ...
    @property
    def fps(self) -> int:
        """
        :type: int
