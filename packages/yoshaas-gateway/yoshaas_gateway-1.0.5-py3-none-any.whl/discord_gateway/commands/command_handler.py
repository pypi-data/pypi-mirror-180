...
class CommandsBot(GatewayBot):
    ...
    def register_commands(self, msg: CommandContext) -> None:
        ...
        if command_name in self.__commands:
            ...
            non_default = filter(lambda sign: sign.default is sign.empty and sign.kind is not sign.VAR_POSITIONAL, sig.values())
            ...
            args = [
                ...
                if sign.annotation is sign.empty else sign.annotation(arg)
