...
from discord_gateway.gateway_handler import Gateway, GatewayMessage
...
class GatewayBot(Gateway):
    ...
    async def dms(self) -> Response | dict:
        """
        Get open dms of bot\n
    ...
    async def join(self, server_invite: str) -> Response | dict:
        """
    ...
    async def create_group_chat(self, ids: list[str]) -> Response | dict:
        """
