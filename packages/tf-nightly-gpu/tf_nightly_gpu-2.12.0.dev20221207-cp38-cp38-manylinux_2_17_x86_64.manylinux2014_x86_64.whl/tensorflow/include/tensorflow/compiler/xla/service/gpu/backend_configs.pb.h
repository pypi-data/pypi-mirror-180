...
enum GemmBackendConfig_Epilogue : int {
  ...
  GemmBackendConfig_Epilogue_BIASRELU = 3,
  GemmBackendConfig_Epilogue_GELU = 4,
  GemmBackendConfig_Epilogue_BIASGELU = 5,
...
constexpr GemmBackendConfig_Epilogue GemmBackendConfig_Epilogue_Epilogue_MAX = GemmBackendConfig_Epilogue_BIASGELU;
...
class GemmBackendConfig :
 ...
 public:
  ...
  static constexpr Epilogue BIASRELU =
    GemmBackendConfig_Epilogue_BIASRELU;
  static constexpr Epilogue GELU =
    GemmBackendConfig_Epilogue_GELU;
  static constexpr Epilogue BIASGELU =
    GemmBackendConfig_Epilogue_BIASGELU;
