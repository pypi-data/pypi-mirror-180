...
filter_by_entropy_gap.sh 0.8 0.1 ${out_dir} ${query_seq} ${accessory_dir}
filter_by_entropy_gap.sh 1 0.2 ${out_dir} ${query_seq} ${accessory_dir}
filter_by_entropy_gap.sh 1.2 0.2 ${out_dir} ${query_seq} ${accessory_dir}
filter_by_entropy_gap.sh 1.2 0.3 ${out_dir} ${query_seq} ${accessory_dir}
mkdir ${out_dir}/all
cat ${query_seq} ${accessory_dir}/seqs.fa  > ${out_dir}/all/seqs.fa
