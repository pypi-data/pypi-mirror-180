...
setup(
	name='cluster_depp_test',    # This is the name of your PyPI-package.
        version='0.0.18',    # Update the version number for new releases
        scripts=['train_depp.py',
		 ...
		 'train_depp_recon.py',
                 ...
                 'depp/grep_jplace.py'], # The name of your scipt, and also the command you'll be using for calling it
