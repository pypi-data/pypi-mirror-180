...
class AddHeader(
    ...
    def bind(
        ...
        '''
        if __debug__:
            def stub(_rule: aws_cdk.aws_ses.IReceiptRule) -> None:
                ...
...
class Lambda(metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-ses-actions.Lambda"):
    ...
    def bind(
        ...
        '''
        if __debug__:
            def stub(rule: aws_cdk.aws_ses.IReceiptRule) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
...
class StopProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            def stub(*, topic: typing.Optional[aws_cdk.aws_sns.ITopic] = None) -> None:
                ...
            type_hints = typing.get_type_hints(stub)
            check_type(argname="argument topic", value=topic, expected_type=type_hints["topic"])
        self._values: typing.Dict[str, typing.Any] = {}
