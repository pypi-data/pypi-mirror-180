...
def _download_notebook(run_params: dict,
                    ...
                    wml_client: 'APIClient',
                    pipeline_name: str,
                    filename: str = None) -> Tuple[Union[None, Dict[str, 'Pipeline']], bool]:
    """
    Helper function to download and load computed AutoAI pipelines (sklearn pipelines).
    ...
    filename: str, optional
        Name of pipeline notebook file. If not specified, the file name will be created based on pipeline name.
