...
class ServiceInstanceNewPlan:
    ...
    def _get_cpd_token_from_request(self):
        ...
        **Output**
            ...
            **return type**: str\n
        """
        if (self._client.ICP_40 or self._client.ICP_45 or self._client.ICP_46) and 'bedrock_url' in self._client.wml_credentials and 'password' in self._client.wml_credentials:
            try:
