...
class Repository(WMLResource):
    ...
    @docstring_parameter({'str_type': STR_TYPE_NAME})
    def store_model(self, model, meta_props=None, training_data=None, training_target=None, pipeline=None, feature_names=None, label_column_names=None,subtrainingId=None, round_number=None, experiment_metadata=None):
        """
                Create a model.
                ...
                **Parameters**
                ...
                .. important::
                    ...
                    #. **round_number**: round number of a Federated Learning experiment that has been configured to save intermediate models.  This applies when model is a training id.  
                       **type**: int

                    #. **experiment_metadata**: metadata retrieved from the experiment that created the model
                        **type**: dict
        ...
        return self._client._models.store(model, meta_props=meta_props, training_data=training_data, training_target=training_target, pipeline=pipeline, feature_names=feature_names, label_column_names=label_column_names,subtrainingId=subtrainingId,round_number=round_number,experiment_metadata=experiment_metadata)
    ...
    def download(self, artifact_uid, filename='downloaded_artifact.tar.gz', rev_uid=None, format=None):
        ...
        if res['model'] is True:
            ...
            return self._client._functions.download(artifact_uid, filename, rev_uid)
                ...
                and not self._client.ICP_45 and not self._client.ICP_46 and res['library'] is True:
            return self._client.runtimes.download_library(artifact_uid, filename)
        elif not self._client.CLOUD_PLATFORM_SPACES and not self._client.ICP_35 and not self._client.ICP_40 \
                and not self._client.ICP_45 and not self._client.ICP_46 and res['runtime'] is True:
    ...
    def promote_model(self, model_id: str, source_project_id: str, target_space_id: str):
        """
