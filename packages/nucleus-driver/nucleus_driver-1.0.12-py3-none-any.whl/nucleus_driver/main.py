...
class App(cmd2.Cmd):
    ...
    download_dvl_parser.add_argument('-p', '--path', help='path for file to be downloaded')
    ...
    download_nucleus_parser.add_argument('-p', '--path', help='path for file to be downloaded')
