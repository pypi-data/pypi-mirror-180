...
class Microservice(Construct):
    ...
    def create_network_load_balancer(self, scope, id, app_name, environment, network_load_balancer_ip_1, network_load_balancer_ip_2, network_load_balancer_subnet_1, network_load_balancer_subnet_2, dns_record=None, create_dns="True"):
            ...
            if is_https:
                ...
                if has_oidc:
                    ...
                    oidc_listener_action = _alb.ListenerAction.authenticate_oidc(
                        ...
                        issuer=issuer,
                        client_id=client_id,
                        client_secret= cdk.SecretValue(protected_value=client_secret),
