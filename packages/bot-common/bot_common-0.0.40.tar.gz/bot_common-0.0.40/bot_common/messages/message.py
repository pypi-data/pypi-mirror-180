...
from bot_common.lib_conf import void_message, table_name_messages
...
class NewMessages:
    ...
    def check_single_user_messages(self):
        ...
        timeout_obj = TimeoutMessageManager(self.db, self.cursor, to)
    ...
    def set(self, new_message: NewMessageDbObj):
        ...
        data['user_message'] = void_message if void_message_content else data.get('user_message')
