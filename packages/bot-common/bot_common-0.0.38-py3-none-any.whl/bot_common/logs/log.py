...
import json
import time
from bot_common.lib_conf import logs_table_prefix, logs_end_conversation_table_prefix
...
class Log(LogObject):
    ...
    def write(self, db_config: DbConfig, end_conversation=False):
        prefix = logs_end_conversation_table_prefix if end_conversation else logs_table_prefix
