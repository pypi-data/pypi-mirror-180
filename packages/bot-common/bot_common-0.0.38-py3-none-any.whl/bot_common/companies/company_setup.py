...
from bot_common.lib_conf import company_configurations_table_name, flow_csv_subflow_identifier, \
    ...
    conversational_flow_table_prefix, responses_table_prefix
...
class ConfigurationSetup:
    def __init__(self, company: str, db_config: DbConfig, paths: ConfigPaths):
        self.conversational_flow_table_name = conversational_flow_table_prefix + company
        self.responses_table_name = responses_table_prefix + company
