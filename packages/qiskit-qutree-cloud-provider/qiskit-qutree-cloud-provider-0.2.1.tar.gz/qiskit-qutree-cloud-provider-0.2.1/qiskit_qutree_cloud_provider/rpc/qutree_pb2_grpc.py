...
class QuTreeRunnerServicer(object):
    ...
    def RunCircuit(self, request, context):
        """Execute Qiskit circuits on the QuTree simulator and return the results
        """
    ...
    def ComputeExpectation(self, request, context):
        """Compute <circuit|observable|circuit> on the QuTree simulator and return the results
        """
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
