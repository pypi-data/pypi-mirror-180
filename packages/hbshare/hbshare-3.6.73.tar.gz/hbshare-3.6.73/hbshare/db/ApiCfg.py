...
################################ A股市场/科创板 ################################
    ...
    '''科创板复权行情数据'''
    # 非标数据日净值 - 日净值分页查询
    FB_RJZ = UrlCfg('http://%s/admin/dailyNetValue/queryList', 'post', 'ams-admin',
                    lambda x: {
                        'belongDate': {
    ...
    '''非标数据日净值 - 日净值分页查询'''
    # fof估值子基金 - 查询子基金列表
    FOF_ZJJLIST = UrlCfg('http://%s/admin/fof/gz/sf/list', 'post', 'ams-admin',
                         lambda x: {
                             'jzrq': {
                                 'startDate': x.get('startDate'),
                                 'endDate': x.get('endDate')
    ...
    '''fof估值子基金 - 查询子基金列表'''
        # fof历史净值 - 查询历史净值
    FOF_LSJZ = UrlCfg('http://%s/admin/sm/fof/sy/lsjz', 'get', 'ams-admin',
                         lambda x: {},
