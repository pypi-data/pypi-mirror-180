...
if __name__ == '__main__':
    tmp = HoldingAnalysor("星阔山海6号", "20220930", "000905").get_construct_result(isPlot=False)
    # print(tmp['style_df'])
    ...
    #              '顽岩中证500指数增强1号', '白鹭精选量化鲲鹏十号', '伯兄熙宁', '赫富500指数增强一号']
    # HoldingCompare('20220930', '000905', name_list).run()