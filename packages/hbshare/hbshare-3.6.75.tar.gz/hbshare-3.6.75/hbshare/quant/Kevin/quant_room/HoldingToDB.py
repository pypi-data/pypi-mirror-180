        ...
        for name in filenames:
            ...
            # 招商
                ...
                header = 6 if self.fund_name in ['星阔上林1号', '水木博雅500指增', '乾象中证500指数增强1号',
                                                 ...
                                                 '本利达利磐八号', '锋滔指数增强2号', '知行通达500指增'] else 7
                data = pd.read_excel(
...
if __name__ == '__main__':
    HoldingExtractor(data_path='D:\\估值表基地\\知行通达500指增', table_name="private_fund_holding",
                     fund_name="知行通达500指增").writeToDB()
